...
@Component({
    selector: 'app-collaborator-student-settings',
        ...
        this.panels = [
            {
                ...
                title: 'Profile',
                description: 'Manage students profile and private information',
            },
            {
                id: 'security',
                icon: 'heroicons_outline:lock-closed',
                title: 'Security',
                description: 'Manage students password and security preferences',
            },
            // {
            //     id: 'plan-billing',
            //     icon: 'heroicons_outline:credit-card',
            //     title: 'Subscriptions',
            //     description: 'Manage students subscription plan.',
            // },
            {
                id: 'notifications',
                icon: 'heroicons_outline:bell',
                title: 'Notifications',
                description: 'Manage when student will be notified on which channels',
            },
            {
                id: 'team',
                icon: 'heroicons_outline:adjustments-vertical',
                title: 'Statistics',
                description: 'discover students statistics, group information and classes.',
            },
        ];
