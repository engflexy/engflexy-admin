...
export class QuizEtudiantCreateAdminComponent extends AbstractCreateController<QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantAdminService>  implements OnInit {
