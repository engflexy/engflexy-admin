...
export class ReponseEtudiantEditAdminComponent extends AbstractEditController<ReponseEtudiantDto, ReponseEtudiantCriteria, ReponseEtudiantAdminService>   implements OnInit {
