...
export class FreeTrialformuleEditAdminComponent extends AbstractEditController<FreeTrialformuleDto, FreeTrialformuleCriteria, FreeTrialformuleAdminService>   implements OnInit {
