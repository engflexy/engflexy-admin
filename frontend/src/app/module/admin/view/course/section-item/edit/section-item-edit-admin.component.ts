...
export class SectionItemEditAdminComponent extends AbstractEditController<SectionItemDto, SectionItemCriteria, SectionItemAdminService>   implements OnInit {
