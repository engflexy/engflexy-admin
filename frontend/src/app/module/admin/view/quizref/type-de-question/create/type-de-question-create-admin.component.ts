...
export class TypeDeQuestionCreateAdminComponent extends AbstractCreateController<TypeDeQuestionDto, TypeDeQuestionCriteria, TypeDeQuestionAdminService>  implements OnInit {
