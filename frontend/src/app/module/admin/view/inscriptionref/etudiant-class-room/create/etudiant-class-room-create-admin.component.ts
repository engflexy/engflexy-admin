...
export class EtudiantClassRoomCreateAdminComponent extends AbstractCreateController<EtudiantClassRoomDto, EtudiantClassRoomCriteria, EtudiantClassRoomAdminService>  implements OnInit {
