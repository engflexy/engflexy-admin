...
export class InteretEtudiantEditAdminComponent extends AbstractEditController<InteretEtudiantDto, InteretEtudiantCriteria, InteretEtudiantAdminService>   implements OnInit {
