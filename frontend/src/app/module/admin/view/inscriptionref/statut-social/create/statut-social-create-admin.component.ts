...
export class StatutSocialCreateAdminComponent extends AbstractCreateController<StatutSocialDto, StatutSocialCriteria, StatutSocialAdminService>  implements OnInit {
