...
export class InviteStudentCreateAdminComponent extends AbstractCreateController<InviteStudentDto, InviteStudentCriteria, InviteStudentAdminService>  implements OnInit {
