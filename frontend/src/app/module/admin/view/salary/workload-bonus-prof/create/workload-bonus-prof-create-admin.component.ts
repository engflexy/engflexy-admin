...
export class WorkloadBonusProfCreateAdminComponent extends AbstractCreateController<WorkloadBonusProfDto, WorkloadBonusProfCriteria, WorkloadBonusProfAdminService>  implements OnInit {
