...
export class ReponseEtudiantHomeWorkCreateAdminComponent extends AbstractCreateController<ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkAdminService>  implements OnInit {
