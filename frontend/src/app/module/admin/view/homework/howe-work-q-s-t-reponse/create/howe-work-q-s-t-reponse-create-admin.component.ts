...
export class HoweWorkQSTReponseCreateAdminComponent extends AbstractCreateController<HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseAdminService>  implements OnInit {
