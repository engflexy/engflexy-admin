...
export class ProfReviewCreateAdminComponent extends AbstractCreateController<ProfReviewDto, ProfReviewCriteria, ProfReviewAdminService>  implements OnInit {
