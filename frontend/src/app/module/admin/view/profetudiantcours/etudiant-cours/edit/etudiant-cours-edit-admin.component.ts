...
export class EtudiantCoursEditAdminComponent extends AbstractEditController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursAdminService>   implements OnInit {
