...
export class CategorieSectionEditAdminComponent extends AbstractEditController<CategorieSectionDto, CategorieSectionCriteria, CategorieSectionAdminService>   implements OnInit {
