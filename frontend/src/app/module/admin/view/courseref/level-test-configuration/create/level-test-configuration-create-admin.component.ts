...
export class LevelTestConfigurationCreateAdminComponent extends AbstractCreateController<LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationAdminService>  implements OnInit {
