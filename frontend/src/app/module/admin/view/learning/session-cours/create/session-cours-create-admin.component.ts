...
export class SessionCoursCreateAdminComponent extends AbstractCreateController<SessionCoursDto, SessionCoursCriteria, SessionCoursAdminService>  implements OnInit {
