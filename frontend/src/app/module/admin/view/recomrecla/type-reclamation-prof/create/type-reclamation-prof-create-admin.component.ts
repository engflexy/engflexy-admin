...
export class TypeReclamationProfCreateAdminComponent extends AbstractCreateController<TypeReclamationProfDto, TypeReclamationProfCriteria, TypeReclamationProfAdminService>  implements OnInit {
