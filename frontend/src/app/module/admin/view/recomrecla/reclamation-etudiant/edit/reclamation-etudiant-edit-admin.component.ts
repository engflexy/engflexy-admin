...
export class ReclamationEtudiantEditAdminComponent extends AbstractEditController<ReclamationEtudiantDto, ReclamationEtudiantCriteria, ReclamationEtudiantAdminService>   implements OnInit {
