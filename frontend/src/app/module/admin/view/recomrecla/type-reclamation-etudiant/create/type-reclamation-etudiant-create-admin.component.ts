...
export class TypeReclamationEtudiantCreateAdminComponent extends AbstractCreateController<TypeReclamationEtudiantDto, TypeReclamationEtudiantCriteria, TypeReclamationEtudiantAdminService>  implements OnInit {
