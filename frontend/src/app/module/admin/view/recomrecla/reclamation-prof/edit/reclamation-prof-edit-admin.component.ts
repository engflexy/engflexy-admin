...
export class ReclamationProfEditAdminComponent extends AbstractEditController<ReclamationProfDto, ReclamationProfCriteria, ReclamationProfAdminService>   implements OnInit {
