...
export class PaiementCollaboratorService extends AbstractService<PaiementDto, PaiementCriteria> {
    ...
    get API() {
        return environment.apiUrlAlcservice + 'collaborator/paiement/';
    }
