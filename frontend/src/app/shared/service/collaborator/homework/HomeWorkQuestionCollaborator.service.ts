...
export class HomeWorkQuestionCollaboratorService extends AbstractService<HomeWorkQuestionDto, HomeWorkQuestionCriteria> {
    ...
    get API() {
        return environment.apiUrlAlcservice + 'collaborator/homeWorkQuestion/';
    }
