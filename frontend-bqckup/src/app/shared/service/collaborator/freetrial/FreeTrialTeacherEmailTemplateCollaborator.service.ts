...
export class FreeTrialTeacherEmailTemplateCollaboratorService extends AbstractService<FreeTrialTeacherEmailTemplateDto, FreeTrialTeacherEmailTemplateCriteria> {
