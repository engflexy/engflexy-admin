...
export class HoweWorkQSTReponseCollaboratorService extends AbstractService<HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria> {
    ...
    get API() {
        return environment.apiUrlAlcservice + 'collaborator/howeWorkQSTReponse/';
    }
