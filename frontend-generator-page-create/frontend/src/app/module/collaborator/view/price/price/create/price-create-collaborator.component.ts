...
@Component({
  selector: 'app-price-create-collaborator',
  templateUrl: './price-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class PriceCreateCollaboratorComponent  implements OnInit {
  ...
  _collaboratorsFilter:  CollaboratorDto[];
   ...
   private _validPriceLib = true;
	...
	constructor(private alert: FuseAlertService, private service: PriceCollaboratorService , private collaboratorService: CollaboratorCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
