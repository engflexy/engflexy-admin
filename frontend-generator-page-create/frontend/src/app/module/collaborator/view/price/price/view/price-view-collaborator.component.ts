...
@Component({
  selector: 'app-price-view-collaborator',
  templateUrl: './price-view-collaborator.component.html'
})
export class PriceViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: PriceCollaboratorService, private collaboratorService: CollaboratorCollaboratorService){
