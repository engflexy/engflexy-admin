...
import {PriceCollaboratorService} from '../../../../shared/service/collaborator/price/PriceCollaborator.service';

@Component({
  selector: 'app-pack-student-create-collaborator',
  templateUrl: './pack-student-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class PackStudentCreateCollaboratorComponent  implements OnInit {
  ...
  _pricesFilter:  PriceDto[];
   ...
   private _validPackStudentLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: PackStudentCollaboratorService , private parcoursService: ParcoursCollaboratorService, private priceService: PriceCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
