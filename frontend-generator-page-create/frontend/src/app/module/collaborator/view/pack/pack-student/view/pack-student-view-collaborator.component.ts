...
@Component({
  selector: 'app-pack-student-view-collaborator',
  templateUrl: './pack-student-view-collaborator.component.html'
})
export class PackStudentViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: PackStudentCollaboratorService, private parcoursService: ParcoursCollaboratorService, private priceService: PriceCollaboratorService){
