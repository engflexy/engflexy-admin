...
@Component({
  selector: 'app-class-average-bonus-edit-collaborator',
  templateUrl: './class-average-bonus-edit-collaborator.component.html'
})
export class ClassAverageBonusEditCollaboratorComponent implements OnInit {
