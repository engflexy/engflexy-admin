...
@Component({
  selector: 'app-news-view-collaborator',
  templateUrl: './news-view-collaborator.component.html'
})
export class NewsViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: NewsCollaboratorService, private collaboratorService: CollaboratorCollaboratorService){
