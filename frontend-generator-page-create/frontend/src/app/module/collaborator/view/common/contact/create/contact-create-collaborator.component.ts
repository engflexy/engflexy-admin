...
import {ContactCollaboratorService} from '../../../../shared/service/collaborator/common/ContactCollaborator.service';
...
@Component({
  selector: 'app-contact-create-collaborator',
  templateUrl: './contact-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class ContactCreateCollaboratorComponent  implements OnInit {
  ...
  _collaboratorsFilter:  CollaboratorDto[];
	...
	constructor(private alert: FuseAlertService, private service: ContactCollaboratorService , private collaboratorService: CollaboratorCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
