...
@Component({
  selector: 'app-contact-view-collaborator',
  templateUrl: './contact-view-collaborator.component.html'
})
export class ContactViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ContactCollaboratorService, private collaboratorService: CollaboratorCollaboratorService){
