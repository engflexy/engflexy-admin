...
@Component({
  selector: 'app-class-average-bonus-list-collaborator',
  templateUrl: './class-average-bonus-list-collaborator.component.html'
})
export class ClassAverageBonusListCollaboratorComponent implements OnInit {

    protected fileName = 'ClassAverageBonus';
    ...
    constructor( private service: ClassAverageBonusCollaboratorService  , private collaboratorService: CollaboratorCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ClassAverageBonusDto>();
    ...
    public async edit(dto: ClassAverageBonusDto) {
    ...
    public async view(dto: ClassAverageBonusDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ClassAverageBonusDto) {
    ...
    public async duplicate(dto: ClassAverageBonusDto) {
    ...
    public exportPdf(dto: ClassAverageBonusDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ClassAverageBonusDto> {
        return this.service.selections;
    }

    set selections(value: Array<ClassAverageBonusDto>) {
