...
@Component({
  selector: 'app-contact-list-collaborator',
  templateUrl: './contact-list-collaborator.component.html'
})
export class ContactListCollaboratorComponent implements OnInit {
