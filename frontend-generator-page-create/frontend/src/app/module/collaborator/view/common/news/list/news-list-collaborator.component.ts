...
import {NewsCollaboratorService} from 'src/app/shared/service/collaborator/common/NewsCollaborator.service';
...
@Component({
  selector: 'app-news-list-collaborator',
  templateUrl: './news-list-collaborator.component.html'
})
export class NewsListCollaboratorComponent implements OnInit {

    protected fileName = 'News';
    ...
    constructor( private service: NewsCollaboratorService  , private collaboratorService: CollaboratorCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<NewsDto>();
    ...
    public async delete(dto: NewsDto) {
    ...
    public async duplicate(dto: NewsDto) {
    ...
    public exportPdf(dto: NewsDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<NewsDto> {
        return this.service.selections;
    }

    set selections(value: Array<NewsDto>) {
