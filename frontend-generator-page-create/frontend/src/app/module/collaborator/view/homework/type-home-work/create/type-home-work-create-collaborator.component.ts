...
@Component({
  selector: 'app-type-home-work-create-collaborator',
  templateUrl: './type-home-work-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class TypeHomeWorkCreateCollaboratorComponent  implements OnInit {
   ...
   private _validTypeHomeWorkLib = true;
	...
	constructor(private alert: FuseAlertService, private service: TypeHomeWorkCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
