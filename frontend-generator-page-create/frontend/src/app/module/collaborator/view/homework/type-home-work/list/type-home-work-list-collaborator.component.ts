...
@Component({
  selector: 'app-type-home-work-list-collaborator',
  templateUrl: './type-home-work-list-collaborator.component.html'
})
export class TypeHomeWorkListCollaboratorComponent implements OnInit {

    protected fileName = 'TypeHomeWork';
    ...
    constructor( private service: TypeHomeWorkCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypeHomeWorkDto>();
    ...
    public async edit(dto: TypeHomeWorkDto) {
    ...
    public async view(dto: TypeHomeWorkDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypeHomeWorkDto) {
    ...
    public async duplicate(dto: TypeHomeWorkDto) {
    ...
    public exportPdf(dto: TypeHomeWorkDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TypeHomeWorkDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypeHomeWorkDto>) {
