...
@Component({
  selector: 'app-type-home-work-edit-collaborator',
  templateUrl: './type-home-work-edit-collaborator.component.html'
})
export class TypeHomeWorkEditCollaboratorComponent implements OnInit {
