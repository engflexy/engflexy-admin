...
@Component({
  selector: 'app-home-work-question-list-collaborator',
  templateUrl: './home-work-question-list-collaborator.component.html'
})
export class HomeWorkQuestionListCollaboratorComponent implements OnInit {

    protected fileName = 'HomeWorkQuestion';
    ...
    constructor( private service: HomeWorkQuestionCollaboratorService  , private howeWorkQSTReponseService: HoweWorkQSTReponseCollaboratorService, private typeDeQuestionService: TypeDeQuestionCollaboratorService, private homeWorkService: HomeWorkCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<HomeWorkQuestionDto>();
    ...
    public async edit(dto: HomeWorkQuestionDto) {
    ...
    public async view(dto: HomeWorkQuestionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: HomeWorkQuestionDto) {
    ...
    public async duplicate(dto: HomeWorkQuestionDto) {
    ...
    public exportPdf(dto: HomeWorkQuestionDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<HomeWorkQuestionDto> {
        return this.service.selections;
    }

    set selections(value: Array<HomeWorkQuestionDto>) {
