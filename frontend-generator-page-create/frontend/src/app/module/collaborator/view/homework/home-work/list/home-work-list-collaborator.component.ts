...
@Component({
  selector: 'app-home-work-list-collaborator',
  templateUrl: './home-work-list-collaborator.component.html'
})
export class HomeWorkListCollaboratorComponent implements OnInit {

    protected fileName = 'HomeWork';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<HomeWorkDto>();
    ...
    public async edit(dto: HomeWorkDto) {
    ...
    public async view(dto: HomeWorkDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: HomeWorkDto) {
    ...
    public async duplicate(dto: HomeWorkDto) {
    ...
    public exportPdf(dto: HomeWorkDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<HomeWorkDto> {
        return this.service.selections;
    }

    set selections(value: Array<HomeWorkDto>) {
