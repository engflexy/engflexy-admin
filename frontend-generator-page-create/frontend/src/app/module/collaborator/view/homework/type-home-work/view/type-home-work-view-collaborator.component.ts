...
@Component({
  selector: 'app-type-home-work-view-collaborator',
  templateUrl: './type-home-work-view-collaborator.component.html'
})
export class TypeHomeWorkViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: TypeHomeWorkCollaboratorService){
