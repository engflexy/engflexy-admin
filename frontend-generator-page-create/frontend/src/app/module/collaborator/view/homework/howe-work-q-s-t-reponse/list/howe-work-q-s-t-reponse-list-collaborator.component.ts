...
@Component({
  selector: 'app-howe-work-q-s-t-reponse-list-collaborator',
  templateUrl: './howe-work-q-s-t-reponse-list-collaborator.component.html'
})
export class HoweWorkQSTReponseListCollaboratorComponent implements OnInit {

    protected fileName = 'HoweWorkQSTReponse';
    ...
    constructor( private service: HoweWorkQSTReponseCollaboratorService  , private homeWorkQuestionService: HomeWorkQuestionCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<HoweWorkQSTReponseDto>();
    ...
    public async edit(dto: HoweWorkQSTReponseDto) {
    ...
    public async view(dto: HoweWorkQSTReponseDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: HoweWorkQSTReponseDto) {
    ...
    public async duplicate(dto: HoweWorkQSTReponseDto) {
    ...
    public exportPdf(dto: HoweWorkQSTReponseDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<HoweWorkQSTReponseDto> {
        return this.service.selections;
    }

    set selections(value: Array<HoweWorkQSTReponseDto>) {
