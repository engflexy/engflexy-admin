...
@Component({
  selector: 'app-home-work-edit-collaborator',
  templateUrl: './home-work-edit-collaborator.component.html'
})
export class HomeWorkEditCollaboratorComponent implements OnInit {
