...
@Component({
  selector: 'app-reponse-etudiant-home-work-create-collaborator',
  templateUrl: './reponse-etudiant-home-work-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class ReponseEtudiantHomeWorkCreateCollaboratorComponent  implements OnInit {
