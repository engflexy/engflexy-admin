...
@Component({
  selector: 'app-home-work-etudiant-edit-collaborator',
  templateUrl: './home-work-etudiant-edit-collaborator.component.html'
})
export class HomeWorkEtudiantEditCollaboratorComponent implements OnInit {
