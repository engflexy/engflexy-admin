...
@Component({
  selector: 'app-howe-work-q-s-t-reponse-view-collaborator',
  templateUrl: './howe-work-q-s-t-reponse-view-collaborator.component.html'
})
export class HoweWorkQSTReponseViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: HoweWorkQSTReponseCollaboratorService, private homeWorkQuestionService: HomeWorkQuestionCollaboratorService){
