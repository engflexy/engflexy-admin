...
@Component({
  selector: 'app-level-test-configuration-view-collaborator',
  templateUrl: './level-test-configuration-view-collaborator.component.html'
})
export class LevelTestConfigurationViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: LevelTestConfigurationCollaboratorService, private parcoursService: ParcoursCollaboratorService){
