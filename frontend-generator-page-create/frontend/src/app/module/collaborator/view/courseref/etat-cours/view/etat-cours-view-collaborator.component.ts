...
@Component({
  selector: 'app-etat-cours-view-collaborator',
  templateUrl: './etat-cours-view-collaborator.component.html'
})
export class EtatCoursViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: EtatCoursCollaboratorService){
