...
@Component({
  selector: 'app-content-type-create-collaborator',
  templateUrl: './content-type-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class ContentTypeCreateCollaboratorComponent  implements OnInit {
   ...
   private _validContentTypeLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: ContentTypeCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
