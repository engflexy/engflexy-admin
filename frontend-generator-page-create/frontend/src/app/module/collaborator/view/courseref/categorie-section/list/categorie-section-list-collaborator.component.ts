...
@Component({
  selector: 'app-categorie-section-list-collaborator',
  templateUrl: './categorie-section-list-collaborator.component.html'
})
export class CategorieSectionListCollaboratorComponent implements OnInit {

    protected fileName = 'CategorieSection';
    ...
    constructor( private service: CategorieSectionCollaboratorService  , private sectionService: SectionCollaboratorService, private superCategorieSectionService: SuperCategorieSectionCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CategorieSectionDto>();
    ...
    public async edit(dto: CategorieSectionDto) {
    ...
    public async view(dto: CategorieSectionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CategorieSectionDto) {
    ...
    public async duplicate(dto: CategorieSectionDto) {
    ...
    public exportPdf(dto: CategorieSectionDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CategorieSectionDto> {
        return this.service.selections;
    }

    set selections(value: Array<CategorieSectionDto>) {
