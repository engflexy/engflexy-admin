...
@Component({
  selector: 'app-content-type-edit-collaborator',
  templateUrl: './content-type-edit-collaborator.component.html'
})
export class ContentTypeEditCollaboratorComponent implements OnInit {
