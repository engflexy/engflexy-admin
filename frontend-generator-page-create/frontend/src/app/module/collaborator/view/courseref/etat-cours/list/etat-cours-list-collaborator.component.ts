...
@Component({
  selector: 'app-etat-cours-list-collaborator',
  templateUrl: './etat-cours-list-collaborator.component.html'
})
export class EtatCoursListCollaboratorComponent implements OnInit {

    protected fileName = 'EtatCours';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EtatCoursDto>();
    ...
    public async edit(dto: EtatCoursDto) {
    ...
    public async view(dto: EtatCoursDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EtatCoursDto) {
    ...
    public async duplicate(dto: EtatCoursDto) {
    ...
    public exportPdf(dto: EtatCoursDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<EtatCoursDto> {
        return this.service.selections;
    }

    set selections(value: Array<EtatCoursDto>) {
