...
@Component({
  selector: 'app-level-test-configuration-list-collaborator',
  templateUrl: './level-test-configuration-list-collaborator.component.html'
})
export class LevelTestConfigurationListCollaboratorComponent implements OnInit {

    protected fileName = 'LevelTestConfiguration';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<LevelTestConfigurationDto>();
    ...
    public async edit(dto: LevelTestConfigurationDto) {
    ...
    public async view(dto: LevelTestConfigurationDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: LevelTestConfigurationDto) {
    ...
    public async duplicate(dto: LevelTestConfigurationDto) {
    ...
    public exportPdf(dto: LevelTestConfigurationDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<LevelTestConfigurationDto> {
        return this.service.selections;
    }

    set selections(value: Array<LevelTestConfigurationDto>) {
