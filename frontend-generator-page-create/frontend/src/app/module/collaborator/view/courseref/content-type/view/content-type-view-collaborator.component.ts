...
@Component({
  selector: 'app-content-type-view-collaborator',
  templateUrl: './content-type-view-collaborator.component.html'
})
export class ContentTypeViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ContentTypeCollaboratorService){
