...
@Component({
  selector: 'app-super-categorie-section-edit-collaborator',
  templateUrl: './super-categorie-section-edit-collaborator.component.html'
})
export class SuperCategorieSectionEditCollaboratorComponent implements OnInit {
