...
import {LevelTestConfigurationCollaboratorService} from '../../../../shared/service/collaborator/courseref/LevelTestConfigurationCollaborator.service';
...
@Component({
  selector: 'app-level-test-configuration-create-collaborator',
  templateUrl: './level-test-configuration-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class LevelTestConfigurationCreateCollaboratorComponent  implements OnInit {
  ...
  _parcourssFilter:  ParcoursDto[];
	...
	constructor(private alert: FuseAlertService, private service: LevelTestConfigurationCollaboratorService , private parcoursService: ParcoursCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
