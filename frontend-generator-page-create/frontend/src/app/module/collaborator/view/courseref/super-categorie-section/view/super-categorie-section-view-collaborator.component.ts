...
@Component({
  selector: 'app-super-categorie-section-view-collaborator',
  templateUrl: './super-categorie-section-view-collaborator.component.html'
})
export class SuperCategorieSectionViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: SuperCategorieSectionCollaboratorService, private categorieSectionService: CategorieSectionCollaboratorService){
