...
@Component({
  selector: 'app-super-categorie-section-list-collaborator',
  templateUrl: './super-categorie-section-list-collaborator.component.html'
})
export class SuperCategorieSectionListCollaboratorComponent implements OnInit {

    protected fileName = 'SuperCategorieSection';
    ...
    constructor( private service: SuperCategorieSectionCollaboratorService  , private categorieSectionService: CategorieSectionCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SuperCategorieSectionDto>();
    ...
    public async edit(dto: SuperCategorieSectionDto) {
    ...
    public async view(dto: SuperCategorieSectionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SuperCategorieSectionDto) {
    ...
    public async duplicate(dto: SuperCategorieSectionDto) {
    ...
    public exportPdf(dto: SuperCategorieSectionDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<SuperCategorieSectionDto> {
        return this.service.selections;
    }

    set selections(value: Array<SuperCategorieSectionDto>) {
