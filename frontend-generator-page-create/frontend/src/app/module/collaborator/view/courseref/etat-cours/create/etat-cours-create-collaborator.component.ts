...
@Component({
  selector: 'app-etat-cours-create-collaborator',
  templateUrl: './etat-cours-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class EtatCoursCreateCollaboratorComponent  implements OnInit {
   ...
   private _validEtatCoursLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: EtatCoursCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
