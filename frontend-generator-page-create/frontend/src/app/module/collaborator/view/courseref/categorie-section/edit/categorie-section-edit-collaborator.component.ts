...
@Component({
  selector: 'app-categorie-section-edit-collaborator',
  templateUrl: './categorie-section-edit-collaborator.component.html'
})
export class CategorieSectionEditCollaboratorComponent implements OnInit {
