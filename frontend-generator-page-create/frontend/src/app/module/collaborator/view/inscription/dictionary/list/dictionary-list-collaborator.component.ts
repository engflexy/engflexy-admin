...
import {DictionaryCollaboratorService} from 'src/app/shared/service/collaborator/inscription/DictionaryCollaborator.service';
...
@Component({
  selector: 'app-dictionary-list-collaborator',
  templateUrl: './dictionary-list-collaborator.component.html'
})
export class DictionaryListCollaboratorComponent implements OnInit {

    protected fileName = 'Dictionary';
    ...
    constructor( private service: DictionaryCollaboratorService  , private etudiantService: EtudiantCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DictionaryDto>();
    ...
    public async edit(dto: DictionaryDto) {
    ...
    public async view(dto: DictionaryDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DictionaryDto) {
    ...
    public async duplicate(dto: DictionaryDto) {
    ...
    public exportPdf(dto: DictionaryDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get items(): Array<DictionaryDto> {
        return this.service.items;
    }

    set items(value: Array<DictionaryDto>) {
        this.service.items = value;
    }

    get selections(): Array<DictionaryDto> {
        return this.service.selections;
    }

    set selections(value: Array<DictionaryDto>) {
        this.service.selections = value;
    }

    get item(): DictionaryDto {
        return this.service.item;
    }

    set item(value: DictionaryDto) {
    ...
    get criteria(): DictionaryCriteria {
        return this.service.criteria;
    }

    set criteria(value: DictionaryCriteria) {
