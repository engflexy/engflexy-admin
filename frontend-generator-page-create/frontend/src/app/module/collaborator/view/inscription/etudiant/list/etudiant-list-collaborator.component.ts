...
@Component({
  selector: 'app-etudiant-list-collaborator',
  templateUrl: './etudiant-list-collaborator.component.html'
})
export class EtudiantListCollaboratorComponent implements OnInit {
