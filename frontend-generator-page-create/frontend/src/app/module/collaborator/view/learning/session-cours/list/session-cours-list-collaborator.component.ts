...
@Component({
  selector: 'app-session-cours-list-collaborator',
  templateUrl: './session-cours-list-collaborator.component.html'
})
export class SessionCoursListCollaboratorComponent implements OnInit {
