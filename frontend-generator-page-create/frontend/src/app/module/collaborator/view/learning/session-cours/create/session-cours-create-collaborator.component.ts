...
import {SessionCoursCollaboratorService} from '../../../../shared/service/collaborator/learning/SessionCoursCollaborator.service';
...
import {SessionCoursSectionCollaboratorService} from '../../../../shared/service/collaborator/learning/SessionCoursSectionCollaborator.service';
...
@Component({
  selector: 'app-session-cours-create-collaborator',
  templateUrl: './session-cours-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class SessionCoursCreateCollaboratorComponent  implements OnInit {
