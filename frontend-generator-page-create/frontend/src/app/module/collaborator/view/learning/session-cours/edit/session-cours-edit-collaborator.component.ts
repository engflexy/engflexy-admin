...
@Component({
  selector: 'app-session-cours-edit-collaborator',
  templateUrl: './session-cours-edit-collaborator.component.html'
})
export class SessionCoursEditCollaboratorComponent implements OnInit {
