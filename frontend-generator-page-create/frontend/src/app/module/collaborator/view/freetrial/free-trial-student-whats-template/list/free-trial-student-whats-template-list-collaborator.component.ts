...
@Component({
  selector: 'app-free-trial-student-whats-template-list-collaborator',
  templateUrl: './free-trial-student-whats-template-list-collaborator.component.html'
})
export class FreeTrialStudentWhatsTemplateListCollaboratorComponent implements OnInit {

    protected fileName = 'FreeTrialStudentWhatsTemplate';
    ...
    constructor( private service: FreeTrialStudentWhatsTemplateCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<FreeTrialStudentWhatsTemplateDto>();
    ...
    public async edit(dto: FreeTrialStudentWhatsTemplateDto) {
    ...
    public async view(dto: FreeTrialStudentWhatsTemplateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async openCreate() {
        this.item = new FreeTrialStudentWhatsTemplateDto();
    ...
    public async delete(dto: FreeTrialStudentWhatsTemplateDto) {
    ...
    public async duplicate(dto: FreeTrialStudentWhatsTemplateDto) {
    ...
    public exportPdf(dto: FreeTrialStudentWhatsTemplateDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<FreeTrialStudentWhatsTemplateDto> {
        return this.service.selections;
    }

    set selections(value: Array<FreeTrialStudentWhatsTemplateDto>) {
