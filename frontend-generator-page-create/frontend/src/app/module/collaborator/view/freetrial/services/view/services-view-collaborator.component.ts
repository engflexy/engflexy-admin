...
@Component({
  selector: 'app-services-view-collaborator',
  templateUrl: './services-view-collaborator.component.html'
})
export class ServicesViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ServicesCollaboratorService){
