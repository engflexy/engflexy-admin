...
@Component({
  selector: 'app-free-trial-detail-edit-collaborator',
  templateUrl: './free-trial-detail-edit-collaborator.component.html'
})
export class FreeTrialDetailEditCollaboratorComponent implements OnInit {
