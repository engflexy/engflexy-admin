...
@Component({
  selector: 'app-free-trial-configuration-list-collaborator',
  templateUrl: './free-trial-configuration-list-collaborator.component.html'
})
export class FreeTrialConfigurationListCollaboratorComponent implements OnInit {

    protected fileName = 'FreeTrialConfiguration';
    ...
    constructor( private service: FreeTrialConfigurationCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<FreeTrialConfigurationDto>();
    ...
    public async edit(dto: FreeTrialConfigurationDto) {
    ...
    public async view(dto: FreeTrialConfigurationDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async openCreate() {
        this.item = new FreeTrialConfigurationDto();
    ...
    public async delete(dto: FreeTrialConfigurationDto) {
    ...
    public async duplicate(dto: FreeTrialConfigurationDto) {
    ...
    public exportPdf(dto: FreeTrialConfigurationDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get items(): Array<FreeTrialConfigurationDto> {
        return this.service.items;
    }

    set items(value: Array<FreeTrialConfigurationDto>) {
        this.service.items = value;
    }

    get selections(): Array<FreeTrialConfigurationDto> {
        return this.service.selections;
    }

    set selections(value: Array<FreeTrialConfigurationDto>) {
        this.service.selections = value;
    }

    get item(): FreeTrialConfigurationDto {
        return this.service.item;
    }

    set item(value: FreeTrialConfigurationDto) {
    ...
    get criteria(): FreeTrialConfigurationCriteria {
        return this.service.criteria;
    }

    set criteria(value: FreeTrialConfigurationCriteria) {
