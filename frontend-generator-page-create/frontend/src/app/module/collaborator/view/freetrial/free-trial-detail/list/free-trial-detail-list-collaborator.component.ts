...
@Component({
  selector: 'app-free-trial-detail-list-collaborator',
  templateUrl: './free-trial-detail-list-collaborator.component.html'
})
export class FreeTrialDetailListCollaboratorComponent implements OnInit {
    ...
    constructor( private service: FreeTrialDetailCollaboratorService  , private etudiantService: EtudiantCollaboratorService, private freeTrialService: FreeTrialCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
