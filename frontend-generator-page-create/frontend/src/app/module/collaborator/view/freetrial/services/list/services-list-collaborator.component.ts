...
@Component({
  selector: 'app-services-list-collaborator',
  templateUrl: './services-list-collaborator.component.html'
})
export class ServicesListCollaboratorComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ServicesDto>();
    ...
    public async edit(dto: ServicesDto) {
    ...
    public async view(dto: ServicesDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ServicesDto) {
    ...
    public async duplicate(dto: ServicesDto) {
    ...
    public exportPdf(dto: ServicesDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ServicesDto> {
        return this.service.selections;
    }

    set selections(value: Array<ServicesDto>) {
