...
@Component({
  selector: 'app-free-trial-list-collaborator',
  templateUrl: './free-trial-list-collaborator.component.html'
})
export class FreeTrialListCollaboratorComponent implements OnInit {
