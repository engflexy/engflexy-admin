...
@Component({
  selector: 'app-statut-free-trial-list-collaborator',
  templateUrl: './statut-free-trial-list-collaborator.component.html'
})
export class StatutFreeTrialListCollaboratorComponent implements OnInit {

    protected fileName = 'StatutFreeTrial';
    ...
    constructor( private service: StatutFreeTrialCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<StatutFreeTrialDto>();
    ...
    public async edit(dto: StatutFreeTrialDto) {
    ...
    public async view(dto: StatutFreeTrialDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: StatutFreeTrialDto) {
    ...
    public async duplicate(dto: StatutFreeTrialDto) {
    ...
    public exportPdf(dto: StatutFreeTrialDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<StatutFreeTrialDto> {
        return this.service.selections;
    }

    set selections(value: Array<StatutFreeTrialDto>) {
