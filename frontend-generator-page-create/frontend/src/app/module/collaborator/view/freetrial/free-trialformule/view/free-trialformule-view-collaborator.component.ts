...
@Component({
  selector: 'app-free-trialformule-view-collaborator',
  templateUrl: './free-trialformule-view-collaborator.component.html'
})
export class FreeTrialformuleViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: FreeTrialformuleCollaboratorService, private inscriptionService: InscriptionCollaboratorService){
