...
@Component({
  selector: 'app-statut-free-trial-edit-collaborator',
  templateUrl: './statut-free-trial-edit-collaborator.component.html'
})
export class StatutFreeTrialEditCollaboratorComponent implements OnInit {
