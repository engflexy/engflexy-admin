...
import {FreeTrialformuleCollaboratorService} from '../../../../shared/service/collaborator/freetrial/FreeTrialformuleCollaborator.service';
...
@Component({
  selector: 'app-free-trialformule-create-collaborator',
  templateUrl: './free-trialformule-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class FreeTrialformuleCreateCollaboratorComponent  implements OnInit {
  ...
  _inscriptionsFilter:  InscriptionDto[];
   ...
   private _validFreeTrialformuleCode = true;
	...
	constructor(private alert: FuseAlertService, private service: FreeTrialformuleCollaboratorService , private inscriptionService: InscriptionCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
