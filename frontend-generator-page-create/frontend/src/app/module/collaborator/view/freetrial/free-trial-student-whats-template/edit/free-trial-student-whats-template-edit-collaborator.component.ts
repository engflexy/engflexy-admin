...
@Component({
  selector: 'app-free-trial-student-whats-template-edit-collaborator',
  templateUrl: './free-trial-student-whats-template-edit-collaborator.component.html'
})
export class FreeTrialStudentWhatsTemplateEditCollaboratorComponent implements OnInit {
