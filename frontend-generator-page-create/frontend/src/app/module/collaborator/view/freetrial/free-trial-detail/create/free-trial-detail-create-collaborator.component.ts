...
@Component({
  selector: 'app-free-trial-detail-create-collaborator',
  templateUrl: './free-trial-detail-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class FreeTrialDetailCreateCollaboratorComponent  implements OnInit {
  ...
  _etudiantsFilter:  EtudiantDto[];
	...
	constructor(private alert: FuseAlertService, private service: FreeTrialDetailCollaboratorService , private etudiantService: EtudiantCollaboratorService, private freeTrialService: FreeTrialCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
