...
@Component({
  selector: 'app-free-trial-student-whats-template-view-collaborator',
  templateUrl: './free-trial-student-whats-template-view-collaborator.component.html'
})
export class FreeTrialStudentWhatsTemplateViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: FreeTrialStudentWhatsTemplateCollaboratorService){
