...
@Component({
  selector: 'app-free-trial-edit-collaborator',
  templateUrl: './free-trial-edit-collaborator.component.html'
})
export class FreeTrialEditCollaboratorComponent implements OnInit {
