...
@Component({
  selector: 'app-statut-free-trial-create-collaborator',
  templateUrl: './statut-free-trial-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class StatutFreeTrialCreateCollaboratorComponent  implements OnInit {
   ...
   private _validStatutFreeTrialCode = true;
	...
	constructor(private alert: FuseAlertService, private service: StatutFreeTrialCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
