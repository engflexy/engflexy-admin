...
@Component({
  selector: 'app-free-trial-detail-view-collaborator',
  templateUrl: './free-trial-detail-view-collaborator.component.html'
})
export class FreeTrialDetailViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: FreeTrialDetailCollaboratorService, private etudiantService: EtudiantCollaboratorService, private freeTrialService: FreeTrialCollaboratorService){
