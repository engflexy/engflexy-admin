...
@Component({
  selector: 'app-question-list-collaborator',
  templateUrl: './question-list-collaborator.component.html'
})
export class QuestionListCollaboratorComponent implements OnInit {
