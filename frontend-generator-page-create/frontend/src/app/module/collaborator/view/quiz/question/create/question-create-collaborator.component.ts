...
@Component({
  selector: 'app-question-create-collaborator',
  templateUrl: './question-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class QuestionCreateCollaboratorComponent  implements OnInit {
  ...
  _quizsFilter:  QuizDto[];
   ...
   private _validQuestionRef = true;
	...
	constructor(private alert: FuseAlertService, private service: QuestionCollaboratorService , private quizService: QuizCollaboratorService, private typeDeQuestionService: TypeDeQuestionCollaboratorService, private reponseService: ReponseCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
