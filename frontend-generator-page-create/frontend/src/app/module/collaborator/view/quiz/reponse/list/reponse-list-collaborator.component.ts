...
@Component({
  selector: 'app-reponse-list-collaborator',
  templateUrl: './reponse-list-collaborator.component.html'
})
export class ReponseListCollaboratorComponent implements OnInit {
