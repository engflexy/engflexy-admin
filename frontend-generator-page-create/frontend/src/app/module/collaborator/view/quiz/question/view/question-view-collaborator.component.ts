...
@Component({
  selector: 'app-question-view-collaborator',
  templateUrl: './question-view-collaborator.component.html'
})
export class QuestionViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: QuestionCollaboratorService, private quizService: QuizCollaboratorService, private typeDeQuestionService: TypeDeQuestionCollaboratorService, private reponseService: ReponseCollaboratorService){
