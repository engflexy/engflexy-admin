...
@Component({
  selector: 'app-reponse-view-collaborator',
  templateUrl: './reponse-view-collaborator.component.html'
})
export class ReponseViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ReponseCollaboratorService, private questionService: QuestionCollaboratorService){
