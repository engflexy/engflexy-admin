...
@Component({
  selector: 'app-quiz-create-collaborator',
  templateUrl: './quiz-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class QuizCreateCollaboratorComponent  implements OnInit {
  ...
  _sectionsFilter:  SectionDto[];
   ...
   private _validQuizLib = true;
	...
	constructor(private alert: FuseAlertService, private service: QuizCollaboratorService , private quizEtudiantService: QuizEtudiantCollaboratorService, private typeDeQuestionService: TypeDeQuestionCollaboratorService, private etudiantService: EtudiantCollaboratorService, private questionService: QuestionCollaboratorService, private sectionService: SectionCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
