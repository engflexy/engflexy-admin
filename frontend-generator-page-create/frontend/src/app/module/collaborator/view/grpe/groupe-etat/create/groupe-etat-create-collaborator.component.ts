...
@Component({
  selector: 'app-groupe-etat-create-collaborator',
  templateUrl: './groupe-etat-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class GroupeEtatCreateCollaboratorComponent  implements OnInit {
   ...
   private _validGroupeEtatLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: GroupeEtatCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
