...
@Component({
  selector: 'app-groupe-type-view-collaborator',
  templateUrl: './groupe-type-view-collaborator.component.html'
})
export class GroupeTypeViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: GroupeTypeCollaboratorService){
