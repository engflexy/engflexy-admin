...
@Component({
  selector: 'app-groupe-etude-list-collaborator',
  templateUrl: './groupe-etude-list-collaborator.component.html'
})
export class GroupeEtudeListCollaboratorComponent implements OnInit {

    protected fileName = 'GroupeEtude';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<GroupeEtudeDto>();
    ...
    public async edit(dto: GroupeEtudeDto) {
    ...
    public async view(dto: GroupeEtudeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: GroupeEtudeDto) {
    ...
    public async duplicate(dto: GroupeEtudeDto) {
    ...
    public exportPdf(dto: GroupeEtudeDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<GroupeEtudeDto> {
        return this.service.selections;
    }

    set selections(value: Array<GroupeEtudeDto>) {
