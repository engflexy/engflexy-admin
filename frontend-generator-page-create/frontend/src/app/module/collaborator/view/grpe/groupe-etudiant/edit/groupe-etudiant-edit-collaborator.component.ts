...
@Component({
  selector: 'app-groupe-etudiant-edit-collaborator',
  templateUrl: './groupe-etudiant-edit-collaborator.component.html'
})
export class GroupeEtudiantEditCollaboratorComponent implements OnInit {
