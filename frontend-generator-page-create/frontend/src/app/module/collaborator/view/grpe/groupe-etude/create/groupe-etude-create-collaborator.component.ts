...
@Component({
  selector: 'app-groupe-etude-create-collaborator',
  templateUrl: './groupe-etude-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class GroupeEtudeCreateCollaboratorComponent  implements OnInit {
   ...
   private _validGroupeEtudeLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: GroupeEtudeCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
