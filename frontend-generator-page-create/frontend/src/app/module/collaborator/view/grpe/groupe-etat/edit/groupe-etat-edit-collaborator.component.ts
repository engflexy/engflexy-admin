...
@Component({
  selector: 'app-groupe-etat-edit-collaborator',
  templateUrl: './groupe-etat-edit-collaborator.component.html'
})
export class GroupeEtatEditCollaboratorComponent implements OnInit {
