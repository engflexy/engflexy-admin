...
@Component({
  selector: 'app-groupe-etat-view-collaborator',
  templateUrl: './groupe-etat-view-collaborator.component.html'
})
export class GroupeEtatViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: GroupeEtatCollaboratorService){
