...
@Component({
  selector: 'app-groupe-etude-view-collaborator',
  templateUrl: './groupe-etude-view-collaborator.component.html'
})
export class GroupeEtudeViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: GroupeEtudeCollaboratorService){
