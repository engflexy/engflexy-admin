...
@Component({
  selector: 'app-groupe-type-edit-collaborator',
  templateUrl: './groupe-type-edit-collaborator.component.html'
})
export class GroupeTypeEditCollaboratorComponent implements OnInit {
