...
import {TrancheHoraireProfCriteria} from '../../../../shared/criteria/prof/TrancheHoraireProfCriteria.model';
...
@Component({
  selector: 'app-tranche-horaire-prof-create-collaborator',
  templateUrl: './tranche-horaire-prof-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class TrancheHoraireProfCreateCollaboratorComponent  implements OnInit {
  ...
  _profsFilter:  ProfDto[];
	...
	constructor(private alert: FuseAlertService, private service: TrancheHoraireProfCollaboratorService , private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
