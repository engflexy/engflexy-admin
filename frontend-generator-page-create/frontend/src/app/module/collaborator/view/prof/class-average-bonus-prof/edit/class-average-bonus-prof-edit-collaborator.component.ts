...
@Component({
  selector: 'app-class-average-bonus-prof-edit-collaborator',
  templateUrl: './class-average-bonus-prof-edit-collaborator.component.html'
})
export class ClassAverageBonusProfEditCollaboratorComponent implements OnInit {
