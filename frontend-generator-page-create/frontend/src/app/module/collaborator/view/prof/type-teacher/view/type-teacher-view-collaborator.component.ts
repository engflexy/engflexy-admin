...
@Component({
  selector: 'app-type-teacher-view-collaborator',
  templateUrl: './type-teacher-view-collaborator.component.html'
})
export class TypeTeacherViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: TypeTeacherCollaboratorService){
