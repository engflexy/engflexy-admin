...
@Component({
  selector: 'app-class-average-bonus-prof-list-collaborator',
  templateUrl: './class-average-bonus-prof-list-collaborator.component.html'
})
export class ClassAverageBonusProfListCollaboratorComponent implements OnInit {

    protected fileName = 'ClassAverageBonusProf';
    ...
    constructor( private service: ClassAverageBonusProfCollaboratorService  , private salaryService: SalaryCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ClassAverageBonusProfDto>();
    ...
    public async edit(dto: ClassAverageBonusProfDto) {
    ...
    public async view(dto: ClassAverageBonusProfDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ClassAverageBonusProfDto) {
    ...
    public async duplicate(dto: ClassAverageBonusProfDto) {
    ...
    public exportPdf(dto: ClassAverageBonusProfDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ClassAverageBonusProfDto> {
        return this.service.selections;
    }

    set selections(value: Array<ClassAverageBonusProfDto>) {
