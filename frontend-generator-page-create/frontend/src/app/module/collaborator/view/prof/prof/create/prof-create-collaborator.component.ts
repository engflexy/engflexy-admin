...
@Component({
  selector: 'app-prof-create-collaborator',
  templateUrl: './prof-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class ProfCreateCollaboratorComponent  implements OnInit {
