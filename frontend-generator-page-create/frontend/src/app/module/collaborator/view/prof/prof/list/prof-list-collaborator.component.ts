...
@Component({
  selector: 'app-prof-list-collaborator',
  templateUrl: './prof-list-collaborator.component.html'
})
export class ProfListCollaboratorComponent implements OnInit {

    protected fileName = 'Prof';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ProfDto>();
    ...
    public async delete(dto: ProfDto) {
    ...
    public async duplicate(dto: ProfDto) {
    ...
    public exportPdf(dto: ProfDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ProfDto> {
        return this.service.selections;
    }

    set selections(value: Array<ProfDto>) {
