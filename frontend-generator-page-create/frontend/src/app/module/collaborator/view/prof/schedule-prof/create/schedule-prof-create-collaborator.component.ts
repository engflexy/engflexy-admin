...
export class ScheduleProfCreateCollaboratorComponent  implements OnInit {
  ...
  _courssFilter:  CoursDto[];
	...
	constructor(private alert: FuseAlertService, private service: ScheduleProfCollaboratorService , private groupeEtudiantService: GroupeEtudiantCollaboratorService, private coursService: CoursCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
