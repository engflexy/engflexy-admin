...
@Component({
  selector: 'app-categorie-prof-list-collaborator',
  templateUrl: './categorie-prof-list-collaborator.component.html'
})
export class CategorieProfListCollaboratorComponent implements OnInit {
