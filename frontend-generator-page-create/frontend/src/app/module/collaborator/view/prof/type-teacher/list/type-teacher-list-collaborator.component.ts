...
@Component({
  selector: 'app-type-teacher-list-collaborator',
  templateUrl: './type-teacher-list-collaborator.component.html'
})
export class TypeTeacherListCollaboratorComponent implements OnInit {

    protected fileName = 'TypeTeacher';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypeTeacherDto>();
    ...
    public async edit(dto: TypeTeacherDto) {
    ...
    public async view(dto: TypeTeacherDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypeTeacherDto) {
    ...
    public async duplicate(dto: TypeTeacherDto) {
    ...
    public exportPdf(dto: TypeTeacherDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TypeTeacherDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypeTeacherDto>) {
