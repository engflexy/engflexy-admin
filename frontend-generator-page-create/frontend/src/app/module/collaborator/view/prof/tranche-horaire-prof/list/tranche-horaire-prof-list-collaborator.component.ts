...
@Component({
  selector: 'app-tranche-horaire-prof-list-collaborator',
  templateUrl: './tranche-horaire-prof-list-collaborator.component.html'
})
export class TrancheHoraireProfListCollaboratorComponent implements OnInit {
