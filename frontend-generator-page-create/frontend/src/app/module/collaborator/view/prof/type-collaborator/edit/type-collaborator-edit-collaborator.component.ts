...
@Component({
  selector: 'app-type-collaborator-edit-collaborator',
  templateUrl: './type-collaborator-edit-collaborator.component.html'
})
export class TypeCollaboratorEditCollaboratorComponent implements OnInit {
