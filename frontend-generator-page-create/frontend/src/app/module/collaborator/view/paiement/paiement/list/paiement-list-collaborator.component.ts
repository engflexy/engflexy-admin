...
@Component({
  selector: 'app-paiement-list-collaborator',
  templateUrl: './paiement-list-collaborator.component.html'
})
export class PaiementListCollaboratorComponent implements OnInit {
    ...
    constructor( private service: PaiementCollaboratorService  , private groupeEtudiantService: GroupeEtudiantCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
