...
import {PaiementCollaboratorService} from '../../../../shared/service/collaborator/paiement/PaiementCollaborator.service';
...
@Component({
  selector: 'app-paiement-create-collaborator',
  templateUrl: './paiement-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class PaiementCreateCollaboratorComponent  implements OnInit {
  ...
  _groupeEtudiantsFilter:  GroupeEtudiantDto[];
	...
	constructor(private alert: FuseAlertService, private service: PaiementCollaboratorService , private groupeEtudiantService: GroupeEtudiantCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
