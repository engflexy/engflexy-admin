...
import {PaiementCollaboratorService} from 'src/app/shared/service/collaborator/paiement/PaiementCollaborator.service';
...
@Component({
  selector: 'app-paiement-view-collaborator',
  templateUrl: './paiement-view-collaborator.component.html'
})
export class PaiementViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: PaiementCollaboratorService, private groupeEtudiantService: GroupeEtudiantCollaboratorService, private profService: ProfCollaboratorService){
