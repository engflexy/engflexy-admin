...
@Component({
  selector: 'app-paiement-edit-collaborator',
  templateUrl: './paiement-edit-collaborator.component.html'
})
export class PaiementEditCollaboratorComponent implements OnInit {
