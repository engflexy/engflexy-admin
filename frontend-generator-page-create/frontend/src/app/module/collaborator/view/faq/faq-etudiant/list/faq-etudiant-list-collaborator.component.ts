...
import {FaqEtudiantCollaboratorService} from 'src/app/shared/service/collaborator/faq/FaqEtudiantCollaborator.service';
...
@Component({
  selector: 'app-faq-etudiant-list-collaborator',
  templateUrl: './faq-etudiant-list-collaborator.component.html'
})
export class FaqEtudiantListCollaboratorComponent implements OnInit {

    protected fileName = 'FaqEtudiant';
    ...
    constructor( private service: FaqEtudiantCollaboratorService  , private faqTypeService: FaqTypeCollaboratorService, private etudiantService: EtudiantCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<FaqEtudiantDto>();
    ...
    public async edit(dto: FaqEtudiantDto) {
    ...
    public async view(dto: FaqEtudiantDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: FaqEtudiantDto) {
    ...
    public async duplicate(dto: FaqEtudiantDto) {
    ...
    public exportPdf(dto: FaqEtudiantDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<FaqEtudiantDto> {
        return this.service.selections;
    }

    set selections(value: Array<FaqEtudiantDto>) {
