...
@Component({
  selector: 'app-faq-type-edit-collaborator',
  templateUrl: './faq-type-edit-collaborator.component.html'
})
export class FaqTypeEditCollaboratorComponent implements OnInit {
