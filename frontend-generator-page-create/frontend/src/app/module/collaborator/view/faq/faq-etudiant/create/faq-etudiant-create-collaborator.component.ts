...
import {FaqEtudiantCollaboratorService} from '../../../../shared/service/collaborator/faq/FaqEtudiantCollaborator.service';
import {FaqEtudiantDto} from '../../../../shared/model/faq/FaqEtudiant.model';
import {FaqEtudiantCriteria} from '../../../../shared/criteria/faq/FaqEtudiantCriteria.model';
...
@Component({
  selector: 'app-faq-etudiant-create-collaborator',
  templateUrl: './faq-etudiant-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class FaqEtudiantCreateCollaboratorComponent  implements OnInit {
  ...
  _faqTypesFilter:  FaqTypeDto[];
   ...
   private _validFaqEtudiantLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: FaqEtudiantCollaboratorService , private faqTypeService: FaqTypeCollaboratorService, private etudiantService: EtudiantCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
