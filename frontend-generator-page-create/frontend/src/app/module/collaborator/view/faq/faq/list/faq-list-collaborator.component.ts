...
@Component({
  selector: 'app-faq-list-collaborator',
  templateUrl: './faq-list-collaborator.component.html'
})
export class FaqListCollaboratorComponent implements OnInit {

    protected fileName = 'Faq';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<FaqDto>();
    ...
    public async delete(dto: FaqDto) {
    ...
    public async duplicate(dto: FaqDto) {
    ...
    public exportPdf(dto: FaqDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<FaqDto> {
        return this.service.selections;
    }

    set selections(value: Array<FaqDto>) {
