...
@Component({
  selector: 'app-faq-prof-list-collaborator',
  templateUrl: './faq-prof-list-collaborator.component.html'
})
export class FaqProfListCollaboratorComponent implements OnInit {

    protected fileName = 'FaqProf';
    ...
    constructor( private service: FaqProfCollaboratorService  , private faqTypeService: FaqTypeCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<FaqProfDto>();
    ...
    public async edit(dto: FaqProfDto) {
    ...
    public async view(dto: FaqProfDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: FaqProfDto) {
    ...
    public async duplicate(dto: FaqProfDto) {
    ...
    public exportPdf(dto: FaqProfDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<FaqProfDto> {
        return this.service.selections;
    }

    set selections(value: Array<FaqProfDto>) {
