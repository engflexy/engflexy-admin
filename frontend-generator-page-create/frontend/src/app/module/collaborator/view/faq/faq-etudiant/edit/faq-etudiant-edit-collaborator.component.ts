...
@Component({
  selector: 'app-faq-etudiant-edit-collaborator',
  templateUrl: './faq-etudiant-edit-collaborator.component.html'
})
export class FaqEtudiantEditCollaboratorComponent implements OnInit {
