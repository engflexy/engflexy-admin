...
import {FaqProfCollaboratorService} from '../../../../shared/service/collaborator/faq/FaqProfCollaborator.service';
...
@Component({
  selector: 'app-faq-prof-create-collaborator',
  templateUrl: './faq-prof-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class FaqProfCreateCollaboratorComponent  implements OnInit {
  ...
  _faqTypesFilter:  FaqTypeDto[];
   ...
   private _validFaqProfLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: FaqProfCollaboratorService , private faqTypeService: FaqTypeCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
