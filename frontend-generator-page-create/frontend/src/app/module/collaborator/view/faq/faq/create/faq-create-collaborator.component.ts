...
@Component({
  selector: 'app-faq-create-collaborator',
  templateUrl: './faq-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class FaqCreateCollaboratorComponent  implements OnInit {
  ...
  _faqTypesFilter:  FaqTypeDto[];
   ...
   private _validFaqLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: FaqCollaboratorService , private faqTypeService: FaqTypeCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
