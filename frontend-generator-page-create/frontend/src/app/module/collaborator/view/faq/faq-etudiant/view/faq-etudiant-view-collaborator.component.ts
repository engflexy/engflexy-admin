...
@Component({
  selector: 'app-faq-etudiant-view-collaborator',
  templateUrl: './faq-etudiant-view-collaborator.component.html'
})
export class FaqEtudiantViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: FaqEtudiantCollaboratorService, private faqTypeService: FaqTypeCollaboratorService, private etudiantService: EtudiantCollaboratorService){
