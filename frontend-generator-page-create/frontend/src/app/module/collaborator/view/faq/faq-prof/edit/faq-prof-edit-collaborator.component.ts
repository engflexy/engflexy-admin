...
@Component({
  selector: 'app-faq-prof-edit-collaborator',
  templateUrl: './faq-prof-edit-collaborator.component.html'
})
export class FaqProfEditCollaboratorComponent implements OnInit {
