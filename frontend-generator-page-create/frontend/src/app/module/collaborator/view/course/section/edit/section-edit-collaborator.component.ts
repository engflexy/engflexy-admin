...
@Component({
  selector: 'app-section-edit-collaborator',
  templateUrl: './section-edit-collaborator.component.html'
})
export class SectionEditCollaboratorComponent implements OnInit {
