...
@Component({
  selector: 'app-section-item-view-collaborator',
  templateUrl: './section-item-view-collaborator.component.html'
})
export class SectionItemViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: SectionItemCollaboratorService, private sectionService: SectionCollaboratorService){
