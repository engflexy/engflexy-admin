...
@Component({
  selector: 'app-exercice-list-collaborator',
  templateUrl: './exercice-list-collaborator.component.html'
})
export class ExerciceListCollaboratorComponent implements OnInit {
