...
import {SectionItemCollaboratorService} from 'src/app/shared/service/collaborator/course/SectionItemCollaborator.service';
...
@Component({
  selector: 'app-section-item-list-collaborator',
  templateUrl: './section-item-list-collaborator.component.html'
})
export class SectionItemListCollaboratorComponent implements OnInit {

    protected fileName = 'SectionItem';
    ...
    constructor( private service: SectionItemCollaboratorService  , private sectionService: SectionCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SectionItemDto>();
    ...
    public async edit(dto: SectionItemDto) {
    ...
    public async view(dto: SectionItemDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SectionItemDto) {
    ...
    public async duplicate(dto: SectionItemDto) {
    ...
    public exportPdf(dto: SectionItemDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<SectionItemDto> {
        return this.service.selections;
    }

    set selections(value: Array<SectionItemDto>) {
