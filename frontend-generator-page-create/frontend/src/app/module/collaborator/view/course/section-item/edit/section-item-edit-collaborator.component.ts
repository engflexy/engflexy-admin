...
@Component({
  selector: 'app-section-item-edit-collaborator',
  templateUrl: './section-item-edit-collaborator.component.html'
})
export class SectionItemEditCollaboratorComponent implements OnInit {
