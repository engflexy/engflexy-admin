...
@Component({
  selector: 'app-section-list-collaborator',
  templateUrl: './section-list-collaborator.component.html'
})
export class SectionListCollaboratorComponent implements OnInit {

    protected fileName = 'Section';
    ...
    constructor( private service: SectionCollaboratorService  , private quizService: QuizCollaboratorService, private contentTypeService: ContentTypeCollaboratorService, private exerciceService: ExerciceCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public async edit(dto: SectionDto) {
    ...
    public async view(dto: SectionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SectionDto) {
    ...
    public async duplicate(dto: SectionDto) {
    ...
    public exportPdf(dto: SectionDto): void {
...
// add
	...
	public initDuplicate(res: SectionDto) {
        if (res.quizs != null) {
             res.quizs.forEach(d => { d.section = null; d.id = null; });
        }
        if (res.exercices != null) {
             res.exercices.forEach(d => { d.section = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<SectionDto> {
        return this.service.selections;
    }

    set selections(value: Array<SectionDto>) {
