...
@Component({
  selector: 'app-parcours-create-collaborator',
  templateUrl: './parcours-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class ParcoursCreateCollaboratorComponent  implements OnInit {
  ...
  _collaboratorsFilter:  CollaboratorDto[];
   ...
   private _validParcoursLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: ParcoursCollaboratorService , private collaboratorService: CollaboratorCollaboratorService, private etatCoursService: EtatCoursCollaboratorService, private coursService: CoursCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
