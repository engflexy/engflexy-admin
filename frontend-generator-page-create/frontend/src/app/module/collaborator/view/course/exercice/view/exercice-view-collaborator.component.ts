...
@Component({
  selector: 'app-exercice-view-collaborator',
  templateUrl: './exercice-view-collaborator.component.html'
})
export class ExerciceViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ExerciceCollaboratorService, private contentTypeService: ContentTypeCollaboratorService, private sectionService: SectionCollaboratorService){
