...
import {SectionItemCollaboratorService} from '../../../../shared/service/collaborator/course/SectionItemCollaborator.service';
...
@Component({
  selector: 'app-section-item-create-collaborator',
  templateUrl: './section-item-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class SectionItemCreateCollaboratorComponent  implements OnInit {
  ...
  _sectionsFilter:  SectionDto[];
	...
	constructor(private alert: FuseAlertService, private service: SectionItemCollaboratorService , private sectionService: SectionCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
