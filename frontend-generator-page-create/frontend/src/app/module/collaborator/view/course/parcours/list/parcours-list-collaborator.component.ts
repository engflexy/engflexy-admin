...
@Component({
  selector: 'app-parcours-list-collaborator',
  templateUrl: './parcours-list-collaborator.component.html'
})
export class ParcoursListCollaboratorComponent implements OnInit {
