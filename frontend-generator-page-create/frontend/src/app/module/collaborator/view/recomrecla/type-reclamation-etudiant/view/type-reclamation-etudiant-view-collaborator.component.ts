...
@Component({
  selector: 'app-type-reclamation-etudiant-view-collaborator',
  templateUrl: './type-reclamation-etudiant-view-collaborator.component.html'
})
export class TypeReclamationEtudiantViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: TypeReclamationEtudiantCollaboratorService){
