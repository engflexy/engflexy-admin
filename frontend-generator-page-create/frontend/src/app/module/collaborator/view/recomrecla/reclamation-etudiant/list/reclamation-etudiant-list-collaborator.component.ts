...
@Component({
  selector: 'app-reclamation-etudiant-list-collaborator',
  templateUrl: './reclamation-etudiant-list-collaborator.component.html'
})
export class ReclamationEtudiantListCollaboratorComponent implements OnInit {
