...
@Component({
  selector: 'app-type-reclamation-etudiant-list-collaborator',
  templateUrl: './type-reclamation-etudiant-list-collaborator.component.html'
})
export class TypeReclamationEtudiantListCollaboratorComponent implements OnInit {

    protected fileName = 'TypeReclamationEtudiant';
    ...
    constructor( private service: TypeReclamationEtudiantCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypeReclamationEtudiantDto>();
    ...
    public async edit(dto: TypeReclamationEtudiantDto) {
    ...
    public async view(dto: TypeReclamationEtudiantDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypeReclamationEtudiantDto) {
    ...
    public async duplicate(dto: TypeReclamationEtudiantDto) {
    ...
    public exportPdf(dto: TypeReclamationEtudiantDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TypeReclamationEtudiantDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypeReclamationEtudiantDto>) {
