...
@Component({
  selector: 'app-type-reclamation-prof-create-collaborator',
  templateUrl: './type-reclamation-prof-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class TypeReclamationProfCreateCollaboratorComponent  implements OnInit {
   ...
   private _validTypeReclamationProfLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: TypeReclamationProfCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
