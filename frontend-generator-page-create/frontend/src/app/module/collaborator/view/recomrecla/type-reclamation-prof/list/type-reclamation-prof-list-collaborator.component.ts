...
@Component({
  selector: 'app-type-reclamation-prof-list-collaborator',
  templateUrl: './type-reclamation-prof-list-collaborator.component.html'
})
export class TypeReclamationProfListCollaboratorComponent implements OnInit {

    protected fileName = 'TypeReclamationProf';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypeReclamationProfDto>();
    ...
    public async edit(dto: TypeReclamationProfDto) {
    ...
    public async view(dto: TypeReclamationProfDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypeReclamationProfDto) {
    ...
    public async duplicate(dto: TypeReclamationProfDto) {
    ...
    public exportPdf(dto: TypeReclamationProfDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TypeReclamationProfDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypeReclamationProfDto>) {
