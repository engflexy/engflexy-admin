...
@Component({
  selector: 'app-reclamation-prof-edit-collaborator',
  templateUrl: './reclamation-prof-edit-collaborator.component.html'
})
export class ReclamationProfEditCollaboratorComponent implements OnInit {
