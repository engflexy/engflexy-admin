...
import {ReclamationProfCollaboratorService} from '../../../../shared/service/collaborator/recomrecla/ReclamationProfCollaborator.service';
...
import {TypeReclamationProfCollaboratorService} from '../../../../shared/service/collaborator/recomrecla/TypeReclamationProfCollaborator.service';
...
@Component({
  selector: 'app-reclamation-prof-create-collaborator',
  templateUrl: './reclamation-prof-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class ReclamationProfCreateCollaboratorComponent  implements OnInit {
  ...
  _typeReclamationProfsFilter:  TypeReclamationProfDto[];
   ...
   private _validReclamationProfReference = true;
	...
	constructor(private alert: FuseAlertService, private service: ReclamationProfCollaboratorService , private typeReclamationProfService: TypeReclamationProfCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
