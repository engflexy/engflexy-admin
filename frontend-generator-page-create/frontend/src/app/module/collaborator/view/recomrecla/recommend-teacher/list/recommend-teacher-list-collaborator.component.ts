...
@Component({
  selector: 'app-recommend-teacher-list-collaborator',
  templateUrl: './recommend-teacher-list-collaborator.component.html'
})
export class RecommendTeacherListCollaboratorComponent implements OnInit {

    protected fileName = 'RecommendTeacher';
    ...
    constructor( private service: RecommendTeacherCollaboratorService  , private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<RecommendTeacherDto>();
    ...
    public async edit(dto: RecommendTeacherDto) {
    ...
    public async view(dto: RecommendTeacherDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: RecommendTeacherDto) {
    ...
    public async duplicate(dto: RecommendTeacherDto) {
    ...
    public exportPdf(dto: RecommendTeacherDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<RecommendTeacherDto> {
        return this.service.selections;
    }

    set selections(value: Array<RecommendTeacherDto>) {
