...
@Component({
  selector: 'app-reclamation-etudiant-view-collaborator',
  templateUrl: './reclamation-etudiant-view-collaborator.component.html'
})
export class ReclamationEtudiantViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ReclamationEtudiantCollaboratorService, private typeReclamationEtudiantService: TypeReclamationEtudiantCollaboratorService){
