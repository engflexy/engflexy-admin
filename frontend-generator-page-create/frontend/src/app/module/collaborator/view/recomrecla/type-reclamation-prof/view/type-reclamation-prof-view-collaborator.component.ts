...
@Component({
  selector: 'app-type-reclamation-prof-view-collaborator',
  templateUrl: './type-reclamation-prof-view-collaborator.component.html'
})
export class TypeReclamationProfViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: TypeReclamationProfCollaboratorService){
