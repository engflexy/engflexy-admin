...
@Component({
  selector: 'app-type-reclamation-etudiant-edit-collaborator',
  templateUrl: './type-reclamation-etudiant-edit-collaborator.component.html'
})
export class TypeReclamationEtudiantEditCollaboratorComponent implements OnInit {
