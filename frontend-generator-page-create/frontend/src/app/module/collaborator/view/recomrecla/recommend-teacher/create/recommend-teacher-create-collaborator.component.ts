...
@Component({
  selector: 'app-recommend-teacher-create-collaborator',
  templateUrl: './recommend-teacher-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class RecommendTeacherCreateCollaboratorComponent  implements OnInit {
  ...
  _profsFilter:  ProfDto[];
   ...
   private _validRecommendTeacherRef = true;
	...
	constructor(private alert: FuseAlertService, private service: RecommendTeacherCollaboratorService , private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
