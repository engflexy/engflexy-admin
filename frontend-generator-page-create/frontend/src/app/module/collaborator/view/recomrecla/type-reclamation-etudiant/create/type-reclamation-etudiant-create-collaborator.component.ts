...
@Component({
  selector: 'app-type-reclamation-etudiant-create-collaborator',
  templateUrl: './type-reclamation-etudiant-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class TypeReclamationEtudiantCreateCollaboratorComponent  implements OnInit {
   ...
   private _validTypeReclamationEtudiantLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: TypeReclamationEtudiantCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
