...
@Component({
  selector: 'app-prof-review-edit-collaborator',
  templateUrl: './prof-review-edit-collaborator.component.html'
})
export class ProfReviewEditCollaboratorComponent implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateReview = this.service.format(this.item.dateReview);
    }
