...
import {ProfReviewCollaboratorService} from 'src/app/shared/service/collaborator/review/ProfReviewCollaborator.service';
...
@Component({
  selector: 'app-prof-review-list-collaborator',
  templateUrl: './prof-review-list-collaborator.component.html'
})
export class ProfReviewListCollaboratorComponent implements OnInit {

    protected fileName = 'ProfReview';
    ...
    constructor( private service: ProfReviewCollaboratorService  , private etudiantService: EtudiantCollaboratorService, private coursService: CoursCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ProfReviewDto>();
    ...
    public async edit(dto: ProfReviewDto) {
    ...
    public async view(dto: ProfReviewDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ProfReviewDto) {
    ...
    public async duplicate(dto: ProfReviewDto) {
    ...
    public exportPdf(dto: ProfReviewDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get items(): Array<ProfReviewDto> {
        return this.service.items;
    }

    set items(value: Array<ProfReviewDto>) {
        this.service.items = value;
    }

    get selections(): Array<ProfReviewDto> {
        return this.service.selections;
    }

    set selections(value: Array<ProfReviewDto>) {
        this.service.selections = value;
    }

    get item(): ProfReviewDto {
        return this.service.item;
    }

    set item(value: ProfReviewDto) {
    ...
    get criteria(): ProfReviewCriteria {
        return this.service.criteria;
    }

    set criteria(value: ProfReviewCriteria) {
