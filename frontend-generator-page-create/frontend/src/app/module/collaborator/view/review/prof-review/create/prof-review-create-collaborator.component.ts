...
import {ProfReviewCollaboratorService} from '../../../../shared/service/collaborator/review/ProfReviewCollaborator.service';
import {ProfReviewDto} from '../../../../shared/model/review/ProfReview.model';
import {ProfReviewCriteria} from '../../../../shared/criteria/review/ProfReviewCriteria.model';
...
@Component({
  selector: 'app-prof-review-create-collaborator',
  templateUrl: './prof-review-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class ProfReviewCreateCollaboratorComponent  implements OnInit {
  ...
  _courssFilter:  CoursDto[];
	...
	constructor(private alert: FuseAlertService, private service: ProfReviewCollaboratorService , private etudiantService: EtudiantCollaboratorService, private coursService: CoursCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
