...
@Component({
  selector: 'app-etat-inscription-edit-collaborator',
  templateUrl: './etat-inscription-edit-collaborator.component.html'
})
export class EtatInscriptionEditCollaboratorComponent implements OnInit {
    ...
    constructor(private service: EtatInscriptionCollaboratorService , @Inject(PLATFORM_ID) private platformId?) {
