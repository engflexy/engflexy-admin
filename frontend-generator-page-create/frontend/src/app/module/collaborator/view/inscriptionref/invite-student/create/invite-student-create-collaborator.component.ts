...
import {InviteStudentCollaboratorService} from '../../../../shared/service/collaborator/inscriptionref/InviteStudentCollaborator.service';
...
@Component({
  selector: 'app-invite-student-create-collaborator',
  templateUrl: './invite-student-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class InviteStudentCreateCollaboratorComponent  implements OnInit {
  ...
  _etudiantsFilter:  EtudiantDto[];
   ...
   private _validInviteStudentCode = true;
	...
	constructor(private alert: FuseAlertService, private service: InviteStudentCollaboratorService , private etudiantService: EtudiantCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
