...
@Component({
  selector: 'app-teacher-locality-create-collaborator',
  templateUrl: './teacher-locality-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class TeacherLocalityCreateCollaboratorComponent  implements OnInit {
   ...
   private _validTeacherLocalityLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: TeacherLocalityCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
