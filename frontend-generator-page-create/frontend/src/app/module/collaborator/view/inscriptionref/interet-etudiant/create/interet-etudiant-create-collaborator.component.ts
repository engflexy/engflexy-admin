...
@Component({
  selector: 'app-interet-etudiant-create-collaborator',
  templateUrl: './interet-etudiant-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class InteretEtudiantCreateCollaboratorComponent  implements OnInit {
   ...
   private _validInteretEtudiantLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: InteretEtudiantCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
