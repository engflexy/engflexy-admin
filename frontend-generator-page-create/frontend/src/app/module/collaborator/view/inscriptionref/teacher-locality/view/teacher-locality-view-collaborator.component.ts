...
@Component({
  selector: 'app-teacher-locality-view-collaborator',
  templateUrl: './teacher-locality-view-collaborator.component.html'
})
export class TeacherLocalityViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: TeacherLocalityCollaboratorService){
