...
@Component({
  selector: 'app-statut-social-edit-collaborator',
  templateUrl: './statut-social-edit-collaborator.component.html'
})
export class StatutSocialEditCollaboratorComponent implements OnInit {
