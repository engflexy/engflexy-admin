...
@Component({
  selector: 'app-skill-view-collaborator',
  templateUrl: './skill-view-collaborator.component.html'
})
export class SkillViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: SkillCollaboratorService){
