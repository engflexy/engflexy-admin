...
@Component({
  selector: 'app-etudiant-review-edit-collaborator',
  templateUrl: './etudiant-review-edit-collaborator.component.html'
})
export class EtudiantReviewEditCollaboratorComponent implements OnInit {
