...
@Component({
  selector: 'app-teacher-locality-list-collaborator',
  templateUrl: './teacher-locality-list-collaborator.component.html'
})
export class TeacherLocalityListCollaboratorComponent implements OnInit {

    protected fileName = 'TeacherLocality';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TeacherLocalityDto>();
    ...
    public async edit(dto: TeacherLocalityDto) {
    ...
    public async view(dto: TeacherLocalityDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TeacherLocalityDto) {
    ...
    public async duplicate(dto: TeacherLocalityDto) {
    ...
    public exportPdf(dto: TeacherLocalityDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TeacherLocalityDto> {
        return this.service.selections;
    }

    set selections(value: Array<TeacherLocalityDto>) {
