...
import {EtatInscriptionCollaboratorService} from '../../../../shared/service/collaborator/inscriptionref/EtatInscriptionCollaborator.service';
import {EtatInscriptionDto} from '../../../../shared/model/inscriptionref/EtatInscription.model';
import {EtatInscriptionCriteria} from '../../../../shared/criteria/inscriptionref/EtatInscriptionCriteria.model';

@Component({
  selector: 'app-etat-inscription-create-collaborator',
  templateUrl: './etat-inscription-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class EtatInscriptionCreateCollaboratorComponent  implements OnInit {
   ...
   private _validEtatInscriptionRef = true;
	...
	constructor(private alert: FuseAlertService, private service: EtatInscriptionCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
