...
@Component({
  selector: 'app-fonction-list-collaborator',
  templateUrl: './fonction-list-collaborator.component.html'
})
export class FonctionListCollaboratorComponent implements OnInit {
