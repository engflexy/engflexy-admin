...
@Component({
  selector: 'app-interet-etudiant-edit-collaborator',
  templateUrl: './interet-etudiant-edit-collaborator.component.html'
})
export class InteretEtudiantEditCollaboratorComponent implements OnInit {
