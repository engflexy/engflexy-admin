...
@Component({
  selector: 'app-etat-inscription-view-collaborator',
  templateUrl: './etat-inscription-view-collaborator.component.html'
})
export class EtatInscriptionViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: EtatInscriptionCollaboratorService){
