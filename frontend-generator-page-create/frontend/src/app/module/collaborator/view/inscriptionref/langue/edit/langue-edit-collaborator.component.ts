...
@Component({
  selector: 'app-langue-edit-collaborator',
  templateUrl: './langue-edit-collaborator.component.html'
})
export class LangueEditCollaboratorComponent implements OnInit {
