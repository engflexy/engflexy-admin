...
import {EtudiantReviewCollaboratorService} from 'src/app/shared/service/collaborator/inscriptionref/EtudiantReviewCollaborator.service';
...
@Component({
  selector: 'app-etudiant-review-list-collaborator',
  templateUrl: './etudiant-review-list-collaborator.component.html'
})
export class EtudiantReviewListCollaboratorComponent implements OnInit {

    protected fileName = 'EtudiantReview';
    ...
    constructor( private service: EtudiantReviewCollaboratorService  , private etudiantService: EtudiantCollaboratorService, private coursService: CoursCollaboratorService, private profService: ProfCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EtudiantReviewDto>();
    ...
    public async edit(dto: EtudiantReviewDto) {
    ...
    public async view(dto: EtudiantReviewDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EtudiantReviewDto) {
    ...
    public async duplicate(dto: EtudiantReviewDto) {
    ...
    public exportPdf(dto: EtudiantReviewDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<EtudiantReviewDto> {
        return this.service.selections;
    }

    set selections(value: Array<EtudiantReviewDto>) {
