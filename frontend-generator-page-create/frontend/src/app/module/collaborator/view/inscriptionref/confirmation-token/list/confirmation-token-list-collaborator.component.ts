...
@Component({
  selector: 'app-confirmation-token-list-collaborator',
  templateUrl: './confirmation-token-list-collaborator.component.html'
})
export class ConfirmationTokenListCollaboratorComponent implements OnInit {

    protected fileName = 'ConfirmationToken';
    ...
    constructor( private service: ConfirmationTokenCollaboratorService  , private etudiantService: EtudiantCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ConfirmationTokenDto>();
    ...
    public async edit(dto: ConfirmationTokenDto) {
    ...
    public async view(dto: ConfirmationTokenDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ConfirmationTokenDto) {
    ...
    public async duplicate(dto: ConfirmationTokenDto) {
    ...
    public exportPdf(dto: ConfirmationTokenDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ConfirmationTokenDto> {
        return this.service.selections;
    }

    set selections(value: Array<ConfirmationTokenDto>) {
