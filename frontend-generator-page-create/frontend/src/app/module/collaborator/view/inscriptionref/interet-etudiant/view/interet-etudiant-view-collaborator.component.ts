...
@Component({
  selector: 'app-interet-etudiant-view-collaborator',
  templateUrl: './interet-etudiant-view-collaborator.component.html'
})
export class InteretEtudiantViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: InteretEtudiantCollaboratorService){
