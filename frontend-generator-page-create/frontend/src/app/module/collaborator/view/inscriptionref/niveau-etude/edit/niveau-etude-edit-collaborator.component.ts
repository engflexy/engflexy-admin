...
@Component({
  selector: 'app-niveau-etude-edit-collaborator',
  templateUrl: './niveau-etude-edit-collaborator.component.html'
})
export class NiveauEtudeEditCollaboratorComponent implements OnInit {
