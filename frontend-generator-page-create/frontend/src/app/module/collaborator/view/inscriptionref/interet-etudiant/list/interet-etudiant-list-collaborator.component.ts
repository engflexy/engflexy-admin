...
@Component({
  selector: 'app-interet-etudiant-list-collaborator',
  templateUrl: './interet-etudiant-list-collaborator.component.html'
})
export class InteretEtudiantListCollaboratorComponent implements OnInit {

    protected fileName = 'InteretEtudiant';
    ...
    constructor( private service: InteretEtudiantCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<InteretEtudiantDto>();
    ...
    public async edit(dto: InteretEtudiantDto) {
    ...
    public async view(dto: InteretEtudiantDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: InteretEtudiantDto) {
    ...
    public async duplicate(dto: InteretEtudiantDto) {
    ...
    public exportPdf(dto: InteretEtudiantDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<InteretEtudiantDto> {
        return this.service.selections;
    }

    set selections(value: Array<InteretEtudiantDto>) {
