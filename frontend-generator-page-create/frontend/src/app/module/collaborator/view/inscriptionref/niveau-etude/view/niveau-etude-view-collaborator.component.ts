...
@Component({
  selector: 'app-niveau-etude-view-collaborator',
  templateUrl: './niveau-etude-view-collaborator.component.html'
})
export class NiveauEtudeViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: NiveauEtudeCollaboratorService){
