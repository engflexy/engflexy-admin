...
@Component({
  selector: 'app-skill-list-collaborator',
  templateUrl: './skill-list-collaborator.component.html'
})
export class SkillListCollaboratorComponent implements OnInit {

    protected fileName = 'Skill';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SkillDto>();
    ...
    public async edit(dto: SkillDto) {
    ...
    public async view(dto: SkillDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SkillDto) {
    ...
    public async duplicate(dto: SkillDto) {
    ...
    public exportPdf(dto: SkillDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<SkillDto> {
        return this.service.selections;
    }

    set selections(value: Array<SkillDto>) {
