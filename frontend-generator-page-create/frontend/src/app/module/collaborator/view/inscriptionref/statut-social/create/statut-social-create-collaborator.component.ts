...
import {StatutSocialCriteria} from '../../../../shared/criteria/inscriptionref/StatutSocialCriteria.model';

@Component({
  selector: 'app-statut-social-create-collaborator',
  templateUrl: './statut-social-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class StatutSocialCreateCollaboratorComponent  implements OnInit {
   ...
   private _validStatutSocialLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: StatutSocialCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
