...
@Component({
  selector: 'app-fonction-view-collaborator',
  templateUrl: './fonction-view-collaborator.component.html'
})
export class FonctionViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: FonctionCollaboratorService){
