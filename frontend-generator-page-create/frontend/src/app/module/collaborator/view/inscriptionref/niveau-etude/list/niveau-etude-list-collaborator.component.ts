...
@Component({
  selector: 'app-niveau-etude-list-collaborator',
  templateUrl: './niveau-etude-list-collaborator.component.html'
})
export class NiveauEtudeListCollaboratorComponent implements OnInit {

    protected fileName = 'NiveauEtude';
    ...
    constructor( private service: NiveauEtudeCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<NiveauEtudeDto>();
    ...
    public async edit(dto: NiveauEtudeDto) {
    ...
    public async view(dto: NiveauEtudeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: NiveauEtudeDto) {
    ...
    public async duplicate(dto: NiveauEtudeDto) {
    ...
    public exportPdf(dto: NiveauEtudeDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<NiveauEtudeDto> {
        return this.service.selections;
    }

    set selections(value: Array<NiveauEtudeDto>) {
