...
@Component({
  selector: 'app-etat-inscription-list-collaborator',
  templateUrl: './etat-inscription-list-collaborator.component.html'
})
export class EtatInscriptionListCollaboratorComponent implements OnInit {
