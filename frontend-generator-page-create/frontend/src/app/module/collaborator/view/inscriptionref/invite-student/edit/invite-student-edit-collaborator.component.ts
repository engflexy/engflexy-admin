...
@Component({
  selector: 'app-invite-student-edit-collaborator',
  templateUrl: './invite-student-edit-collaborator.component.html'
})
export class InviteStudentEditCollaboratorComponent implements OnInit {
