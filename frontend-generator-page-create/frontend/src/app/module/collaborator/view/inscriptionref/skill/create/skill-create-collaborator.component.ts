...
import {SkillCriteria} from '../../../../shared/criteria/inscriptionref/SkillCriteria.model';

@Component({
  selector: 'app-skill-create-collaborator',
  templateUrl: './skill-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class SkillCreateCollaboratorComponent  implements OnInit {
   ...
   private _validSkillLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: SkillCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
