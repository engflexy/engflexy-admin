...
@Component({
  selector: 'app-langue-view-collaborator',
  templateUrl: './langue-view-collaborator.component.html'
})
export class LangueViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: LangueCollaboratorService){
