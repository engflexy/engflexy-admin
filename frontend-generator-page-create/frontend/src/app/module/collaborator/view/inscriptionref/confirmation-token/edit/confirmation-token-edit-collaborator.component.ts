...
@Component({
  selector: 'app-confirmation-token-edit-collaborator',
  templateUrl: './confirmation-token-edit-collaborator.component.html'
})
export class ConfirmationTokenEditCollaboratorComponent implements OnInit {
    ...
    public prepareEdit() {
        this.item.expiresAt = this.service.format(this.item.expiresAt);
        this.item.createdAt = this.service.format(this.item.createdAt);
        this.item.confirmedAt = this.service.format(this.item.confirmedAt);
    }
