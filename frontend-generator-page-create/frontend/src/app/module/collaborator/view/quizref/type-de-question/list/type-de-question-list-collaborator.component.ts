...
@Component({
  selector: 'app-type-de-question-list-collaborator',
  templateUrl: './type-de-question-list-collaborator.component.html'
})
export class TypeDeQuestionListCollaboratorComponent implements OnInit {

    protected fileName = 'TypeDeQuestion';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypeDeQuestionDto>();
    ...
    public async edit(dto: TypeDeQuestionDto) {
    ...
    public async view(dto: TypeDeQuestionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypeDeQuestionDto) {
    ...
    public async duplicate(dto: TypeDeQuestionDto) {
    ...
    public exportPdf(dto: TypeDeQuestionDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TypeDeQuestionDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypeDeQuestionDto>) {
