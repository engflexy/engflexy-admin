...
import {TypeDeQuestionCriteria} from '../../../../shared/criteria/quizref/TypeDeQuestionCriteria.model';

@Component({
  selector: 'app-type-de-question-create-collaborator',
  templateUrl: './type-de-question-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class TypeDeQuestionCreateCollaboratorComponent  implements OnInit {
   ...
   private _validTypeDeQuestionLib = true;
	...
	constructor(private alert: FuseAlertService, private service: TypeDeQuestionCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
