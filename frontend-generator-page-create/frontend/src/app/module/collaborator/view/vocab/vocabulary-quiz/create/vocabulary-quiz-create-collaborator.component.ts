...
import {VocabularyQuizCollaboratorService} from '../../../../shared/service/collaborator/vocab/VocabularyQuizCollaborator.service';
...
import {VocabularyCollaboratorService} from '../../../../shared/service/collaborator/vocab/VocabularyCollaborator.service';
...
@Component({
  selector: 'app-vocabulary-quiz-create-collaborator',
  templateUrl: './vocabulary-quiz-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class VocabularyQuizCreateCollaboratorComponent  implements OnInit {
  ...
  _sectionsFilter:  SectionDto[];
   ...
   private _validVocabularyQuizLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: VocabularyQuizCollaboratorService , private vocabularyService: VocabularyCollaboratorService, private sectionService: SectionCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
