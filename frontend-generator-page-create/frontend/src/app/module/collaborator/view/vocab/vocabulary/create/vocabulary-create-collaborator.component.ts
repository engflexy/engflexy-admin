...
@Component({
  selector: 'app-vocabulary-create-collaborator',
  templateUrl: './vocabulary-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class VocabularyCreateCollaboratorComponent  implements OnInit {
  ...
  _vocabularyQuizsFilter:  VocabularyQuizDto[];
	...
	constructor(private alert: FuseAlertService, private service: VocabularyCollaboratorService , private vocabularyQuizService: VocabularyQuizCollaboratorService, private sectionService: SectionCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
