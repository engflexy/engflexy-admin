...
export class CollaboratorCreateCollaboratorComponent  implements OnInit {
	...
	constructor(private alert: FuseAlertService, private service: CollaboratorCollaboratorService , private parcoursService: ParcoursCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
