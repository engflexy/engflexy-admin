...
@Component({
  selector: 'app-vocabulary-quiz-view-collaborator',
  templateUrl: './vocabulary-quiz-view-collaborator.component.html'
})
export class VocabularyQuizViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: VocabularyQuizCollaboratorService, private vocabularyService: VocabularyCollaboratorService, private sectionService: SectionCollaboratorService){
