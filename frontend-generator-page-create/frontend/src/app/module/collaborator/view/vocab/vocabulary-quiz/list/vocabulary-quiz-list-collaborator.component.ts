...
@Component({
  selector: 'app-vocabulary-quiz-list-collaborator',
  templateUrl: './vocabulary-quiz-list-collaborator.component.html'
})
export class VocabularyQuizListCollaboratorComponent implements OnInit {
