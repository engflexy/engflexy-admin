...
export class CollaboratorListCollaboratorComponent implements OnInit {
    ...
    constructor( private service: CollaboratorCollaboratorService  , private parcoursService: ParcoursCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
...
// add
	...
	public initDuplicate(res: CollaboratorDto) {
        if (res.parcourss != null) {
             res.parcourss.forEach(d => { d.collaborator = null; d.id = null; });
        }
	}
