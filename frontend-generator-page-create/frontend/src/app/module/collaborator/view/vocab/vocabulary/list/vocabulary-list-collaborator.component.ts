...
@Component({
  selector: 'app-vocabulary-list-collaborator',
  templateUrl: './vocabulary-list-collaborator.component.html'
})
export class VocabularyListCollaboratorComponent implements OnInit {

    protected fileName = 'Vocabulary';
    ...
    constructor( private service: VocabularyCollaboratorService  , private vocabularyQuizService: VocabularyQuizCollaboratorService, private sectionService: SectionCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<VocabularyDto>();
    ...
    public async edit(dto: VocabularyDto) {
    ...
    public async view(dto: VocabularyDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: VocabularyDto) {
    ...
    public async duplicate(dto: VocabularyDto) {
    ...
    public exportPdf(dto: VocabularyDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<VocabularyDto> {
        return this.service.selections;
    }

    set selections(value: Array<VocabularyDto>) {
