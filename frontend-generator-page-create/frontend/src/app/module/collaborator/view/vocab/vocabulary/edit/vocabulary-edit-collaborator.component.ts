...
@Component({
  selector: 'app-vocabulary-edit-collaborator',
  templateUrl: './vocabulary-edit-collaborator.component.html'
})
export class VocabularyEditCollaboratorComponent implements OnInit {
