...
@Component({
  selector: 'app-salary-view-collaborator',
  templateUrl: './salary-view-collaborator.component.html'
})
export class SalaryViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: SalaryCollaboratorService, private profService: ProfCollaboratorService){
