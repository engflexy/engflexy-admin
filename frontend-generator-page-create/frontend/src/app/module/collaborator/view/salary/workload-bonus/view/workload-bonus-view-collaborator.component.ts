...
@Component({
  selector: 'app-workload-bonus-view-collaborator',
  templateUrl: './workload-bonus-view-collaborator.component.html'
})
export class WorkloadBonusViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: WorkloadBonusCollaboratorService){
