...
@Component({
  selector: 'app-workload-bonus-prof-list-collaborator',
  templateUrl: './workload-bonus-prof-list-collaborator.component.html'
})
export class WorkloadBonusProfListCollaboratorComponent implements OnInit {

    protected fileName = 'WorkloadBonusProf';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<WorkloadBonusProfDto>();
    ...
    public async edit(dto: WorkloadBonusProfDto) {
    ...
    public async view(dto: WorkloadBonusProfDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: WorkloadBonusProfDto) {
    ...
    public async duplicate(dto: WorkloadBonusProfDto) {
    ...
    public exportPdf(dto: WorkloadBonusProfDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<WorkloadBonusProfDto> {
        return this.service.selections;
    }

    set selections(value: Array<WorkloadBonusProfDto>) {
