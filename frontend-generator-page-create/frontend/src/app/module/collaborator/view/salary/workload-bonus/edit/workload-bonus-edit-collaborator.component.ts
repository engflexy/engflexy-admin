...
@Component({
  selector: 'app-workload-bonus-edit-collaborator',
  templateUrl: './workload-bonus-edit-collaborator.component.html'
})
export class WorkloadBonusEditCollaboratorComponent implements OnInit {
