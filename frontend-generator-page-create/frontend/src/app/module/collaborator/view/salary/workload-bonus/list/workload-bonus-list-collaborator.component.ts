...
@Component({
  selector: 'app-workload-bonus-list-collaborator',
  templateUrl: './workload-bonus-list-collaborator.component.html'
})
export class WorkloadBonusListCollaboratorComponent implements OnInit {

    protected fileName = 'WorkloadBonus';
    ...
    constructor( private service: WorkloadBonusCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<WorkloadBonusDto>();
    ...
    public async edit(dto: WorkloadBonusDto) {
    ...
    public async view(dto: WorkloadBonusDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: WorkloadBonusDto) {
    ...
    public async duplicate(dto: WorkloadBonusDto) {
    ...
    public exportPdf(dto: WorkloadBonusDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<WorkloadBonusDto> {
        return this.service.selections;
    }

    set selections(value: Array<WorkloadBonusDto>) {
