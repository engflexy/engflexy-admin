...
@Component({
  selector: 'app-reponse-etudiant-create-collaborator',
  templateUrl: './reponse-etudiant-create-collaborator.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class ReponseEtudiantCreateCollaboratorComponent  implements OnInit {
  ...
  _questionsFilter:  QuestionDto[];
   ...
   private _validReponseEtudiantRef = true;
	...
	constructor(private alert: FuseAlertService, private service: ReponseEtudiantCollaboratorService , private quizEtudiantService: QuizEtudiantCollaboratorService, private questionService: QuestionCollaboratorService, private reponseService: ReponseCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
