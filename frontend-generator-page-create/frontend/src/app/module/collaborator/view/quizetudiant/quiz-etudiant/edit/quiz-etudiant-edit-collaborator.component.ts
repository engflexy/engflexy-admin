...
@Component({
  selector: 'app-quiz-etudiant-edit-collaborator',
  templateUrl: './quiz-etudiant-edit-collaborator.component.html'
})
export class QuizEtudiantEditCollaboratorComponent implements OnInit {
