...
@Component({
  selector: 'app-quiz-etudiant-list-collaborator',
  templateUrl: './quiz-etudiant-list-collaborator.component.html'
})
export class QuizEtudiantListCollaboratorComponent implements OnInit {

    protected fileName = 'QuizEtudiant';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<QuizEtudiantDto>();
    ...
    public async edit(dto: QuizEtudiantDto) {
    ...
    public async view(dto: QuizEtudiantDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: QuizEtudiantDto) {
    ...
    public async duplicate(dto: QuizEtudiantDto) {
    ...
    public exportPdf(dto: QuizEtudiantDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<QuizEtudiantDto> {
        return this.service.selections;
    }

    set selections(value: Array<QuizEtudiantDto>) {
