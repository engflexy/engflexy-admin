...
@Component({
  selector: 'app-reponse-etudiant-list-collaborator',
  templateUrl: './reponse-etudiant-list-collaborator.component.html'
})
export class ReponseEtudiantListCollaboratorComponent implements OnInit {
