...
export class GroupeTypeCreateAdminComponent  implements OnInit {
   ...
   private _validGroupeTypeLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: GroupeTypeAdminService , @Inject(PLATFORM_ID) private platformId? ) {
