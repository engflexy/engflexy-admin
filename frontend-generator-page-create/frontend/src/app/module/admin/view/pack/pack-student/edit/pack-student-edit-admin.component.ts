...
export class PackStudentEditAdminComponent implements OnInit {
    ...
    constructor(private service: PackStudentAdminService , private parcoursService: ParcoursAdminService, private priceService: PriceAdminService, @Inject(PLATFORM_ID) private platformId?) {
