...
import {ProfReviewAdminService} from '../../../../shared/service/admin/review/ProfReviewAdmin.service';
...
export class ProfReviewCreateAdminComponent  implements OnInit {
  ...
  _courssFilter:  CoursDto[];
	...
	constructor(private alert: FuseAlertService, private service: ProfReviewAdminService , private etudiantService: EtudiantAdminService, private coursService: CoursAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId? ) {
