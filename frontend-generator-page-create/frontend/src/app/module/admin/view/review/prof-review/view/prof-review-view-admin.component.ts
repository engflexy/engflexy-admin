...
export class ProfReviewViewAdminComponent implements OnInit {
    ...
    constructor(private service: ProfReviewAdminService, private etudiantService: EtudiantAdminService, private coursService: CoursAdminService, private profService: ProfAdminService){
