...
export class ProfReviewListAdminComponent implements OnInit {
    ...
    constructor( private service: ProfReviewAdminService  , private etudiantService: EtudiantAdminService, private coursService: CoursAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
