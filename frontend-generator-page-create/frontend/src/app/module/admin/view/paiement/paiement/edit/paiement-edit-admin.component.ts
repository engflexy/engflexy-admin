...
export class PaiementEditAdminComponent implements OnInit {
    ...
    constructor(private service: PaiementAdminService , private groupeEtudiantService: GroupeEtudiantAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
