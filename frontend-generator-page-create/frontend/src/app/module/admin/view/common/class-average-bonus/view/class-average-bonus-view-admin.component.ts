...
export class ClassAverageBonusViewAdminComponent implements OnInit {
    ...
    constructor(private service: ClassAverageBonusAdminService, private collaboratorService: CollaboratorAdminService){
