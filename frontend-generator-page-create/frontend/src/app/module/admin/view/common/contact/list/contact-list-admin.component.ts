...
export class ContactListAdminComponent implements OnInit {

    protected fileName = 'Contact';
    ...
    constructor( private service: ContactAdminService  , private collaboratorService: CollaboratorAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ContactDto>();
    ...
    public async edit(dto: ContactDto) {
    ...
    public async view(dto: ContactDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ContactDto) {
    ...
    public async duplicate(dto: ContactDto) {
    ...
    public exportPdf(dto: ContactDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ContactDto> {
        return this.service.selections;
    }

    set selections(value: Array<ContactDto>) {
