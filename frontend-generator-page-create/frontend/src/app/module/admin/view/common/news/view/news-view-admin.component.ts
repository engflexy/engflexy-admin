...
export class NewsViewAdminComponent implements OnInit {
    ...
    constructor(private service: NewsAdminService, private collaboratorService: CollaboratorAdminService){
