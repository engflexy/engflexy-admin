...
import {NewsAdminService} from '../../../../shared/service/admin/common/NewsAdmin.service';
...
export class NewsCreateAdminComponent  implements OnInit {
  ...
  _collaboratorsFilter:  CollaboratorDto[];
   ...
   private _validNewsRef = true;
	...
	constructor(private alert: FuseAlertService, private service: NewsAdminService , private collaboratorService: CollaboratorAdminService, @Inject(PLATFORM_ID) private platformId? ) {
