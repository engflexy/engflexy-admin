...
import {ContactAdminService} from '../../../../shared/service/admin/common/ContactAdmin.service';
import {ContactDto} from '../../../../shared/model/common/Contact.model';
import {ContactCriteria} from '../../../../shared/criteria/common/ContactCriteria.model';
...
export class ContactCreateAdminComponent  implements OnInit {
  ...
  _collaboratorsFilter:  CollaboratorDto[];
	...
	constructor(private alert: FuseAlertService, private service: ContactAdminService , private collaboratorService: CollaboratorAdminService, @Inject(PLATFORM_ID) private platformId? ) {
