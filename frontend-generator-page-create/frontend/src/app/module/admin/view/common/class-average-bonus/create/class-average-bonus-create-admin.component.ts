...
import {ClassAverageBonusAdminService} from '../../../../shared/service/admin/common/ClassAverageBonusAdmin.service';
...
export class ClassAverageBonusCreateAdminComponent  implements OnInit {
  ...
  _collaboratorsFilter:  CollaboratorDto[];
   ...
   private _validClassAverageBonusCode = true;
	...
	constructor(private alert: FuseAlertService, private service: ClassAverageBonusAdminService , private collaboratorService: CollaboratorAdminService, @Inject(PLATFORM_ID) private platformId? ) {
