...
export class ReponseEtudiantHomeWorkEditAdminComponent implements OnInit {
    ...
    constructor(private service: ReponseEtudiantHomeWorkAdminService , private howeWorkQSTReponseService: HoweWorkQSTReponseAdminService, private homeWorkEtudiantService: HomeWorkEtudiantAdminService, private homeWorkQuestionService: HomeWorkQuestionAdminService, @Inject(PLATFORM_ID) private platformId?) {
