...
export class ReponseEtudiantHomeWorkViewAdminComponent implements OnInit {
    ...
    constructor(private service: ReponseEtudiantHomeWorkAdminService, private howeWorkQSTReponseService: HoweWorkQSTReponseAdminService, private homeWorkEtudiantService: HomeWorkEtudiantAdminService, private homeWorkQuestionService: HomeWorkQuestionAdminService){
