...
export class HomeWorkEtudiantCreateAdminComponent  implements OnInit {
  ...
  _homeWorksFilter:  HomeWorkDto[];
	...
	constructor(private alert: FuseAlertService, private service: HomeWorkEtudiantAdminService , private howeWorkQSTReponseService: HoweWorkQSTReponseAdminService, private etudiantService: EtudiantAdminService, private reponseEtudiantHomeWorkService: ReponseEtudiantHomeWorkAdminService, private homeWorkQuestionService: HomeWorkQuestionAdminService, private homeWorkService: HomeWorkAdminService, @Inject(PLATFORM_ID) private platformId? ) {
