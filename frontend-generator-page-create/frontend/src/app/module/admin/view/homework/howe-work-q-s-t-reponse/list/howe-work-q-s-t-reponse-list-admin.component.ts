...
export class HoweWorkQSTReponseListAdminComponent implements OnInit {
    ...
    constructor( private service: HoweWorkQSTReponseAdminService  , private homeWorkQuestionService: HomeWorkQuestionAdminService, @Inject(PLATFORM_ID) private platformId?) {
