...
export class HoweWorkQSTReponseCreateAdminComponent  implements OnInit {
  ...
  _homeWorkQuestionsFilter:  HomeWorkQuestionDto[];
   ...
   private _validHoweWorkQSTReponseLib = true;
	...
	constructor(private alert: FuseAlertService, private service: HoweWorkQSTReponseAdminService , private homeWorkQuestionService: HomeWorkQuestionAdminService, @Inject(PLATFORM_ID) private platformId? ) {
