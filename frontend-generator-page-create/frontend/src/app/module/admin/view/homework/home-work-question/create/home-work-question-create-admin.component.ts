...
export class HomeWorkQuestionCreateAdminComponent  implements OnInit {
  ...
  _homeWorksFilter:  HomeWorkDto[];
   ...
   private _validHomeWorkQuestionLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: HomeWorkQuestionAdminService , private howeWorkQSTReponseService: HoweWorkQSTReponseAdminService, private typeDeQuestionService: TypeDeQuestionAdminService, private homeWorkService: HomeWorkAdminService, @Inject(PLATFORM_ID) private platformId? ) {
