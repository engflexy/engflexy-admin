...
export class HomeWorkCreateAdminComponent  implements OnInit {
  ...
  _typeHomeWorksFilter:  TypeHomeWorkDto[];
   ...
   private _validHomeWorkLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: HomeWorkAdminService , private typeDeQuestionService: TypeDeQuestionAdminService, private homeWorkEtudiantService: HomeWorkEtudiantAdminService, private etudiantService: EtudiantAdminService, private homeWorkQuestionService: HomeWorkQuestionAdminService, private typeHomeWorkService: TypeHomeWorkAdminService, private coursService: CoursAdminService, @Inject(PLATFORM_ID) private platformId? ) {
