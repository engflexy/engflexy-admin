...
export class SectionCreateAdminComponent  implements OnInit {
   ...
   private _validSectionLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: SectionAdminService , private quizService: QuizAdminService, private contentTypeService: ContentTypeAdminService, private exerciceService: ExerciceAdminService, @Inject(PLATFORM_ID) private platformId? ) {
