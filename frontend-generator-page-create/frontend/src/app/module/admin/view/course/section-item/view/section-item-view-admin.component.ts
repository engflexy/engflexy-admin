...
export class SectionItemViewAdminComponent implements OnInit {
    ...
    constructor(private service: SectionItemAdminService, private sectionService: SectionAdminService){
