...
export class CoursCreateAdminComponent  implements OnInit {
  ...
  _parcourssFilter:  ParcoursDto[];
   ...
   private _validCoursLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: CoursAdminService , private parcoursService: ParcoursAdminService, private etatCoursService: EtatCoursAdminService, private sectionService: SectionAdminService, private typeHomeWorkService: TypeHomeWorkAdminService, private homeWorkService: HomeWorkAdminService, @Inject(PLATFORM_ID) private platformId? ) {
