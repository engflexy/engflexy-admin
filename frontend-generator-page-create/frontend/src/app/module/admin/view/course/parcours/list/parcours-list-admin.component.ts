...
export class ParcoursListAdminComponent implements OnInit {

    protected fileName = 'Parcours';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ParcoursDto>();
    ...
    public async edit(dto: ParcoursDto) {
    ...
    public async view(dto: ParcoursDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ParcoursDto) {
    ...
    public async duplicate(dto: ParcoursDto) {
    ...
    public exportPdf(dto: ParcoursDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ParcoursDto> {
        return this.service.selections;
    }

    set selections(value: Array<ParcoursDto>) {
