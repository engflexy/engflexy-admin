...
@Component({
  selector: 'app-exercice-create-admin',
  templateUrl: './exercice-create-admin.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class ExerciceCreateAdminComponent  implements OnInit {
  ...
  _sectionsFilter:  SectionDto[];
   ...
   private _validExerciceLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: ExerciceAdminService , private contentTypeService: ContentTypeAdminService, private sectionService: SectionAdminService, @Inject(PLATFORM_ID) private platformId? ) {
