...
@Component({
  selector: 'app-exercice-list-admin',
  templateUrl: './exercice-list-admin.component.html'
})
export class ExerciceListAdminComponent implements OnInit {

    protected fileName = 'Exercice';
    ...
    constructor( private service: ExerciceAdminService  , private contentTypeService: ContentTypeAdminService, private sectionService: SectionAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ExerciceDto>();
    ...
    public async edit(dto: ExerciceDto) {
    ...
    public async view(dto: ExerciceDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ExerciceDto) {
    ...
    public async duplicate(dto: ExerciceDto) {
    ...
    public exportPdf(dto: ExerciceDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'contentType?.libelle', header: 'Content type'},
            {field: 'section?.libelle', header: 'Section'},
        ];
    }


    public async loadContentType(){
        this.contentTypeService.findAllOptimized().subscribe(contentTypes => this.contentTypes = contentTypes, error => console.log(error))
    }
	...
	public initDuplicate(res: ExerciceDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Content type': e.contentType?.libelle ,
                'Section': e.section?.libelle ,
            }
        });
        ...
        //'Content type': this.criteria.contentType?.libelle ? this.criteria.contentType?.libelle : environment.emptyForExport ,
        //'Section': this.criteria.section?.libelle ? this.criteria.section?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<ExerciceDto> {
        return this.service.selections;
    }

    set selections(value: Array<ExerciceDto>) {
