...
@Component({
  selector: 'app-exercice-view-admin',
  templateUrl: './exercice-view-admin.component.html'
})
export class ExerciceViewAdminComponent implements OnInit {
    ...
    constructor(private service: ExerciceAdminService, private contentTypeService: ContentTypeAdminService, private sectionService: SectionAdminService){
