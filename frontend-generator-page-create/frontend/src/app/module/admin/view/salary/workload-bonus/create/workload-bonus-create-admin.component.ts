...
export class WorkloadBonusCreateAdminComponent  implements OnInit {
   ...
   private _validWorkloadBonusCode = true;
	...
	constructor(private alert: FuseAlertService, private service: WorkloadBonusAdminService , @Inject(PLATFORM_ID) private platformId? ) {
