...
export class WorkloadBonusProfEditAdminComponent implements OnInit {
    ...
    constructor(private service: WorkloadBonusProfAdminService , private salaryService: SalaryAdminService, private workloadBonusService: WorkloadBonusAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
