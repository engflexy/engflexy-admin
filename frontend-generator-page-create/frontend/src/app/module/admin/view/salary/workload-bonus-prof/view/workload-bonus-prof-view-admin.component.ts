...
export class WorkloadBonusProfViewAdminComponent implements OnInit {
    ...
    constructor(private service: WorkloadBonusProfAdminService, private salaryService: SalaryAdminService, private workloadBonusService: WorkloadBonusAdminService, private profService: ProfAdminService){
