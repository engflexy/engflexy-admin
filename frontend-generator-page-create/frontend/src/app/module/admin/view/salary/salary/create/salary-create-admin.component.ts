...
export class SalaryCreateAdminComponent  implements OnInit {
  ...
  _profsFilter:  ProfDto[];
   ...
   private _validSalaryCode = true;
	...
	constructor(private alert: FuseAlertService, private service: SalaryAdminService , private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId? ) {
