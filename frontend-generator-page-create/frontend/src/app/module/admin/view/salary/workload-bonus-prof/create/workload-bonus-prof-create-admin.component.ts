...
import {WorkloadBonusProfAdminService} from '../../../../shared/service/admin/salary/WorkloadBonusProfAdmin.service';
...
import {WorkloadBonusAdminService} from '../../../../shared/service/admin/salary/WorkloadBonusAdmin.service';
...
export class WorkloadBonusProfCreateAdminComponent  implements OnInit {
  ...
  _salarysFilter:  SalaryDto[];
	...
	constructor(private alert: FuseAlertService, private service: WorkloadBonusProfAdminService , private salaryService: SalaryAdminService, private workloadBonusService: WorkloadBonusAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId? ) {
