...
export class SalaryEditAdminComponent implements OnInit {
    ...
    constructor(private service: SalaryAdminService , private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
