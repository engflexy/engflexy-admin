...
export class VocabularyViewAdminComponent implements OnInit {
    ...
    constructor(private service: VocabularyAdminService, private vocabularyQuizService: VocabularyQuizAdminService, private sectionService: SectionAdminService){
