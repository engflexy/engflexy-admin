...
export class VocabularyQuizListAdminComponent implements OnInit {

    protected fileName = 'VocabularyQuiz';
    ...
    constructor( private service: VocabularyQuizAdminService  , private vocabularyService: VocabularyAdminService, private sectionService: SectionAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<VocabularyQuizDto>();
    ...
    public async edit(dto: VocabularyQuizDto) {
    ...
    public async view(dto: VocabularyQuizDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: VocabularyQuizDto) {
    ...
    public async duplicate(dto: VocabularyQuizDto) {
    ...
    public exportPdf(dto: VocabularyQuizDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<VocabularyQuizDto> {
        return this.service.selections;
    }

    set selections(value: Array<VocabularyQuizDto>) {
