...
export class EtudiantReviewViewAdminComponent implements OnInit {
    ...
    constructor(private service: EtudiantReviewAdminService, private etudiantService: EtudiantAdminService, private coursService: CoursAdminService, private profService: ProfAdminService){
