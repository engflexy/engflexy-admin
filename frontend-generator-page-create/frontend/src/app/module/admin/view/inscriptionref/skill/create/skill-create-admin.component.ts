...
export class SkillCreateAdminComponent  implements OnInit {
   ...
   private _validSkillLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: SkillAdminService , @Inject(PLATFORM_ID) private platformId? ) {
