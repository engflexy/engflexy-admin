...
export class StatutSocialCreateAdminComponent  implements OnInit {
   ...
   private _validStatutSocialLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: StatutSocialAdminService , @Inject(PLATFORM_ID) private platformId? ) {
