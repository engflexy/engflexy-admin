...
export class ConfirmationTokenViewAdminComponent implements OnInit {
    ...
    constructor(private service: ConfirmationTokenAdminService, private etudiantService: EtudiantAdminService){
