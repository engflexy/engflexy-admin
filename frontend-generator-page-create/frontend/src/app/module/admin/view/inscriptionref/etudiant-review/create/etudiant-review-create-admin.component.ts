...
import {EtudiantReviewAdminService} from '../../../../shared/service/admin/inscriptionref/EtudiantReviewAdmin.service';
...
export class EtudiantReviewCreateAdminComponent  implements OnInit {
  ...
  _courssFilter:  CoursDto[];
	...
	constructor(private alert: FuseAlertService, private service: EtudiantReviewAdminService , private etudiantService: EtudiantAdminService, private coursService: CoursAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId? ) {
