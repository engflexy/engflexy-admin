...
export class EtudiantReviewListAdminComponent implements OnInit {
    ...
    constructor( private service: EtudiantReviewAdminService  , private etudiantService: EtudiantAdminService, private coursService: CoursAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
