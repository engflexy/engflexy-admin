...
export class ConfirmationTokenListAdminComponent implements OnInit {
    ...
    constructor( private service: ConfirmationTokenAdminService  , private etudiantService: EtudiantAdminService, @Inject(PLATFORM_ID) private platformId?) {
