...
export class TeacherLocalityListAdminComponent implements OnInit {
    ...
    constructor( private service: TeacherLocalityAdminService  , @Inject(PLATFORM_ID) private platformId?) {
