...
import {ConfirmationTokenAdminService} from '../../../../shared/service/admin/inscriptionref/ConfirmationTokenAdmin.service';
...
export class ConfirmationTokenCreateAdminComponent  implements OnInit {
  ...
  _etudiantsFilter:  EtudiantDto[];
	...
	constructor(private alert: FuseAlertService, private service: ConfirmationTokenAdminService , private etudiantService: EtudiantAdminService, @Inject(PLATFORM_ID) private platformId? ) {
