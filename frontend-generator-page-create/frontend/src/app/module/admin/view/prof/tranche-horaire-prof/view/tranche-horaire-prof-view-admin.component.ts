...
export class TrancheHoraireProfViewAdminComponent implements OnInit {
    ...
    constructor(private service: TrancheHoraireProfAdminService, private profService: ProfAdminService){
