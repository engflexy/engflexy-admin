...
export class ScheduleProfViewAdminComponent implements OnInit {
    ...
    constructor(private service: ScheduleProfAdminService, private groupeEtudiantService: GroupeEtudiantAdminService, private coursService: CoursAdminService, private profService: ProfAdminService){
