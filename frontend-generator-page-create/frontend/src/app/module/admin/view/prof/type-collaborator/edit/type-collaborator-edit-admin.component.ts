...
@Component({
  selector: 'app-type-collaborator-edit-admin',
  templateUrl: './type-collaborator-edit-admin.component.html'
})
export class TypeCollaboratorEditAdminComponent implements OnInit {
