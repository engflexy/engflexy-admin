...
export class ClassAverageBonusProfEditAdminComponent implements OnInit {
    ...
    constructor(private service: ClassAverageBonusProfAdminService , private salaryService: SalaryAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
