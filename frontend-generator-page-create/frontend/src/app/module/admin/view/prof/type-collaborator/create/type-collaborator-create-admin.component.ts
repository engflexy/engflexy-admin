...
@Component({
  selector: 'app-type-collaborator-create-admin',
  templateUrl: './type-collaborator-create-admin.component.html',
  imports: [
        MatButtonModule,
        MatDialogModule,
        MatFormFieldModule,
...
export class TypeCollaboratorCreateAdminComponent  implements OnInit {
   ...
   private _validTypeCollaboratorCode = true;
	...
	constructor(private alert: FuseAlertService, private service: TypeCollaboratorAdminService , @Inject(PLATFORM_ID) private platformId? ) {
