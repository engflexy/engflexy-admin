...
export class ClassAverageBonusProfViewAdminComponent implements OnInit {
    ...
    constructor(private service: ClassAverageBonusProfAdminService, private salaryService: SalaryAdminService, private profService: ProfAdminService){
