...
export class CategorieProfCreateAdminComponent  implements OnInit {
   ...
   private _validCategorieProfCode = true;
	...
	constructor(private alert: FuseAlertService, private service: CategorieProfAdminService , private collaboratorService: CollaboratorAdminService, private parcoursService: ParcoursAdminService, private typeTeacherService: TypeTeacherAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId? ) {
