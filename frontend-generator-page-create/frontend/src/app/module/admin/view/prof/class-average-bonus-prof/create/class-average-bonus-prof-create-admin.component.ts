...
import {ClassAverageBonusProfAdminService} from '../../../../shared/service/admin/prof/ClassAverageBonusProfAdmin.service';
...
export class ClassAverageBonusProfCreateAdminComponent  implements OnInit {
  ...
  _salarysFilter:  SalaryDto[];
	...
	constructor(private alert: FuseAlertService, private service: ClassAverageBonusProfAdminService , private salaryService: SalaryAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId? ) {
