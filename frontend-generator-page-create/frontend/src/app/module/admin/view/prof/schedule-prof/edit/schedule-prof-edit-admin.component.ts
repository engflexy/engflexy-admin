...
export class ScheduleProfEditAdminComponent implements OnInit {
    ...
    constructor(private service: ScheduleProfAdminService , private groupeEtudiantService: GroupeEtudiantAdminService, private coursService: CoursAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
