...
export class ScheduleProfListAdminComponent implements OnInit {
    ...
    constructor( private service: ScheduleProfAdminService  , private changeDetectorRef: ChangeDetectorRef  , private groupeEtudiantService: GroupeEtudiantAdminService, private coursService: CoursAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
