...
export class TypeTeacherCreateAdminComponent  implements OnInit {
   ...
   private _validTypeTeacherCode = true;
	...
	constructor(private alert: FuseAlertService, private service: TypeTeacherAdminService , @Inject(PLATFORM_ID) private platformId? ) {
