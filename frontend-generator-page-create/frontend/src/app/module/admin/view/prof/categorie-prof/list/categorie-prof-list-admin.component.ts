...
export class CategorieProfListAdminComponent implements OnInit {

    protected fileName = 'CategorieProf';
    ...
    constructor( private service: CategorieProfAdminService  , private collaboratorService: CollaboratorAdminService, private parcoursService: ParcoursAdminService, private typeTeacherService: TypeTeacherAdminService, private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CategorieProfDto>();
    ...
    public async edit(dto: CategorieProfDto) {
    ...
    public async view(dto: CategorieProfDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CategorieProfDto) {
    ...
    public async duplicate(dto: CategorieProfDto) {
    ...
    public exportPdf(dto: CategorieProfDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CategorieProfDto> {
        return this.service.selections;
    }

    set selections(value: Array<CategorieProfDto>) {
