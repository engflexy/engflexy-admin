...
export class TrancheHoraireProfListAdminComponent implements OnInit {

    protected fileName = 'TrancheHoraireProf';
    ...
    constructor( private service: TrancheHoraireProfAdminService  , private profService: ProfAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TrancheHoraireProfDto>();
    ...
    public async edit(dto: TrancheHoraireProfDto) {
    ...
    public async view(dto: TrancheHoraireProfDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TrancheHoraireProfDto) {
    ...
    public async duplicate(dto: TrancheHoraireProfDto) {
    ...
    public exportPdf(dto: TrancheHoraireProfDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TrancheHoraireProfDto> {
        return this.service.selections;
    }

    set selections(value: Array<TrancheHoraireProfDto>) {
