...
import {DictionaryAdminService} from '../../../../shared/service/admin/inscription/DictionaryAdmin.service';
...
export class DictionaryCreateAdminComponent  implements OnInit {
  ...
  _etudiantsFilter:  EtudiantDto[];
	...
	constructor(private alert: FuseAlertService, private service: DictionaryAdminService , private etudiantService: EtudiantAdminService, @Inject(PLATFORM_ID) private platformId? ) {
