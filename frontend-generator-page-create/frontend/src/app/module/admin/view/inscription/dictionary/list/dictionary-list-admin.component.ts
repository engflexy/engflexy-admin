...
export class DictionaryListAdminComponent implements OnInit {
    ...
    constructor( private service: DictionaryAdminService  , private etudiantService: EtudiantAdminService, @Inject(PLATFORM_ID) private platformId?) {
