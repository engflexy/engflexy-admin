...
export class DictionaryViewAdminComponent implements OnInit {
    ...
    constructor(private service: DictionaryAdminService, private etudiantService: EtudiantAdminService){
