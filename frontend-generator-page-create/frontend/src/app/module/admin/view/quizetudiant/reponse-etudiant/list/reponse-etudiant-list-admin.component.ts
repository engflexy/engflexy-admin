...
export class ReponseEtudiantListAdminComponent implements OnInit {

    protected fileName = 'ReponseEtudiant';
    ...
    constructor( private service: ReponseEtudiantAdminService  , private quizEtudiantService: QuizEtudiantAdminService, private questionService: QuestionAdminService, private reponseService: ReponseAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ReponseEtudiantDto>();
    ...
    public async edit(dto: ReponseEtudiantDto) {
    ...
    public async view(dto: ReponseEtudiantDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ReponseEtudiantDto) {
    ...
    public async duplicate(dto: ReponseEtudiantDto) {
    ...
    public exportPdf(dto: ReponseEtudiantDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ReponseEtudiantDto> {
        return this.service.selections;
    }

    set selections(value: Array<ReponseEtudiantDto>) {
