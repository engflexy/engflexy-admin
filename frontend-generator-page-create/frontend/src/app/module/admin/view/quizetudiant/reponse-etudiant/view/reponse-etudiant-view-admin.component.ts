...
export class ReponseEtudiantViewAdminComponent implements OnInit {
    ...
    constructor(private service: ReponseEtudiantAdminService, private quizEtudiantService: QuizEtudiantAdminService, private questionService: QuestionAdminService, private reponseService: ReponseAdminService){
