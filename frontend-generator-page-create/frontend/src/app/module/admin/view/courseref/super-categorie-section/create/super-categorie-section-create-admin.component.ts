...
export class SuperCategorieSectionCreateAdminComponent  implements OnInit {
   ...
   private _validSuperCategorieSectionLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: SuperCategorieSectionAdminService , private categorieSectionService: CategorieSectionAdminService, @Inject(PLATFORM_ID) private platformId? ) {
