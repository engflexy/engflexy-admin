...
export class LevelTestConfigurationEditAdminComponent implements OnInit {
    ...
    constructor(private service: LevelTestConfigurationAdminService , private parcoursService: ParcoursAdminService, @Inject(PLATFORM_ID) private platformId?) {
