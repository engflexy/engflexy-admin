...
import {LevelTestConfigurationAdminService} from '../../../../shared/service/admin/courseref/LevelTestConfigurationAdmin.service';
import {LevelTestConfigurationDto} from '../../../../shared/model/courseref/LevelTestConfiguration.model';
import {LevelTestConfigurationCriteria} from '../../../../shared/criteria/courseref/LevelTestConfigurationCriteria.model';
...
export class LevelTestConfigurationCreateAdminComponent  implements OnInit {
  ...
  _parcourssFilter:  ParcoursDto[];
	...
	constructor(private alert: FuseAlertService, private service: LevelTestConfigurationAdminService , private parcoursService: ParcoursAdminService, @Inject(PLATFORM_ID) private platformId? ) {
