...
@Component({
  selector: 'app-content-type-view-admin',
  templateUrl: './content-type-view-admin.component.html'
})
export class ContentTypeViewAdminComponent implements OnInit {
    ...
    constructor(private service: ContentTypeAdminService){
