...
export class CategorieSectionViewAdminComponent implements OnInit {
    ...
    constructor(private service: CategorieSectionAdminService, private sectionService: SectionAdminService, private superCategorieSectionService: SuperCategorieSectionAdminService){
