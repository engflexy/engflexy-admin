...
import {CategorieSectionAdminService} from '../../../../shared/service/admin/courseref/CategorieSectionAdmin.service';
...
import {ExerciceAdminService} from '../../../../shared/service/admin/course/ExerciceAdmin.service';
import {SuperCategorieSectionDto} from '../../../../shared/model/courseref/SuperCategorieSection.model';
import {SuperCategorieSectionAdminService} from '../../../../shared/service/admin/courseref/SuperCategorieSectionAdmin.service';
...
export class CategorieSectionCreateAdminComponent  implements OnInit {
  ...
  _superCategorieSectionsFilter:  SuperCategorieSectionDto[];
   ...
   private _validCategorieSectionCode = true;
	...
	constructor(private alert: FuseAlertService, private service: CategorieSectionAdminService , private sectionService: SectionAdminService, private superCategorieSectionService: SuperCategorieSectionAdminService, @Inject(PLATFORM_ID) private platformId? ) {
