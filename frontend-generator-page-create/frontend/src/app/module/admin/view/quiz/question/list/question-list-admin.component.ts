...
export class QuestionListAdminComponent implements OnInit {
    ...
    constructor( private service: QuestionAdminService  , private quizService: QuizAdminService, private typeDeQuestionService: TypeDeQuestionAdminService, private reponseService: ReponseAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<QuestionDto>();
    ...
    public async edit(dto: QuestionDto) {
    ...
    public async view(dto: QuestionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: QuestionDto) {
    ...
    public async duplicate(dto: QuestionDto) {
    ...
    public exportPdf(dto: QuestionDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<QuestionDto> {
        return this.service.selections;
    }

    set selections(value: Array<QuestionDto>) {
