...
export class ReponseListAdminComponent implements OnInit {

    protected fileName = 'Reponse';
    ...
    constructor( private service: ReponseAdminService  , private questionService: QuestionAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ReponseDto>();
    ...
    public async edit(dto: ReponseDto) {
    ...
    public async view(dto: ReponseDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ReponseDto) {
    ...
    public async duplicate(dto: ReponseDto) {
    ...
    public exportPdf(dto: ReponseDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ReponseDto> {
        return this.service.selections;
    }

    set selections(value: Array<ReponseDto>) {
