...
export class ReponseCreateAdminComponent  implements OnInit {
  ...
  _questionsFilter:  QuestionDto[];
   ...
   private _validReponseLib = true;
	...
	constructor(private alert: FuseAlertService, private service: ReponseAdminService , private questionService: QuestionAdminService, @Inject(PLATFORM_ID) private platformId? ) {
