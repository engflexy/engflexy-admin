...
export class PriceViewAdminComponent implements OnInit {
    ...
    constructor(private service: PriceAdminService, private collaboratorService: CollaboratorAdminService){
