...
export class PriceEditAdminComponent implements OnInit {
    ...
    constructor(private service: PriceAdminService , private collaboratorService: CollaboratorAdminService, @Inject(PLATFORM_ID) private platformId?) {
