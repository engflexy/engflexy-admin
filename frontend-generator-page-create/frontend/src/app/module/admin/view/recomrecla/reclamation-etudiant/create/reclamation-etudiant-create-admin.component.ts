...
import {ReclamationEtudiantAdminService} from '../../../../shared/service/admin/recomrecla/ReclamationEtudiantAdmin.service';
...
export class ReclamationEtudiantCreateAdminComponent  implements OnInit {
  ...
  _typeReclamationEtudiantsFilter:  TypeReclamationEtudiantDto[];
   ...
   private _validReclamationEtudiantReference = true;
	...
	constructor(private alert: FuseAlertService, private service: ReclamationEtudiantAdminService , private typeReclamationEtudiantService: TypeReclamationEtudiantAdminService, @Inject(PLATFORM_ID) private platformId? ) {
