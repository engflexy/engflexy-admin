...
export class TypeReclamationProfListAdminComponent implements OnInit {
    ...
    constructor( private service: TypeReclamationProfAdminService  , @Inject(PLATFORM_ID) private platformId?) {
