...
export class ReclamationEtudiantListAdminComponent implements OnInit {

    protected fileName = 'ReclamationEtudiant';
    ...
    constructor( private service: ReclamationEtudiantAdminService  , private typeReclamationEtudiantService: TypeReclamationEtudiantAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ReclamationEtudiantDto>();
    ...
    public async edit(dto: ReclamationEtudiantDto) {
    ...
    public async view(dto: ReclamationEtudiantDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ReclamationEtudiantDto) {
    ...
    public async duplicate(dto: ReclamationEtudiantDto) {
    ...
    public exportPdf(dto: ReclamationEtudiantDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ReclamationEtudiantDto> {
        return this.service.selections;
    }

    set selections(value: Array<ReclamationEtudiantDto>) {
