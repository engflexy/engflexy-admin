...
export class ReclamationProfViewAdminComponent implements OnInit {
    ...
    constructor(private service: ReclamationProfAdminService, private typeReclamationProfService: TypeReclamationProfAdminService, private profService: ProfAdminService){
