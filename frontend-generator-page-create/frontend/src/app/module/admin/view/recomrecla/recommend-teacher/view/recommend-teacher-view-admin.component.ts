...
export class RecommendTeacherViewAdminComponent implements OnInit {
    ...
    constructor(private service: RecommendTeacherAdminService, private profService: ProfAdminService){
