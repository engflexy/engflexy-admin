...
export class TypeDeQuestionListAdminComponent implements OnInit {
    ...
    constructor( private service: TypeDeQuestionAdminService  , @Inject(PLATFORM_ID) private platformId?) {
