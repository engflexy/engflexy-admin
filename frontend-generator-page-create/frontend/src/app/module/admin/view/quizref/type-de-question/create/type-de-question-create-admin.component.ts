...
export class TypeDeQuestionCreateAdminComponent  implements OnInit {
   ...
   private _validTypeDeQuestionLib = true;
	...
	constructor(private alert: FuseAlertService, private service: TypeDeQuestionAdminService , @Inject(PLATFORM_ID) private platformId? ) {
