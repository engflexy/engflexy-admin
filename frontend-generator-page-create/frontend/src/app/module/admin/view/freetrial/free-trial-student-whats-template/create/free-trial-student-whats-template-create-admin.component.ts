...
import {FreeTrialStudentWhatsTemplateCriteria} from '../../../../shared/criteria/freetrial/FreeTrialStudentWhatsTemplateCriteria.model';
...
export class FreeTrialStudentWhatsTemplateCreateAdminComponent  implements OnInit {
	...
	constructor(private alert: FuseAlertService, private service: FreeTrialStudentWhatsTemplateAdminService , @Inject(PLATFORM_ID) private platformId? ) {
