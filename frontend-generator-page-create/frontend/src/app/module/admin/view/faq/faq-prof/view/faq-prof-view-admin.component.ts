...
export class FaqProfViewAdminComponent implements OnInit {
    ...
    constructor(private service: FaqProfAdminService, private faqTypeService: FaqTypeAdminService, private profService: ProfAdminService){
