...
import {FaqTypeCriteria} from '../../../../shared/criteria/faq/FaqTypeCriteria.model';
...
export class FaqTypeCreateAdminComponent  implements OnInit {
   ...
   private _validFaqTypeLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: FaqTypeAdminService , @Inject(PLATFORM_ID) private platformId? ) {
