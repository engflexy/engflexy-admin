...
import {FaqEtudiantAdminService} from '../../../../shared/service/admin/faq/FaqEtudiantAdmin.service';
...
export class FaqEtudiantCreateAdminComponent  implements OnInit {
  ...
  _faqTypesFilter:  FaqTypeDto[];
   ...
   private _validFaqEtudiantLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: FaqEtudiantAdminService , private faqTypeService: FaqTypeAdminService, private etudiantService: EtudiantAdminService, @Inject(PLATFORM_ID) private platformId? ) {
