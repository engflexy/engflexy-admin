...
export class FaqCreateAdminComponent  implements OnInit {
  ...
  _faqTypesFilter:  FaqTypeDto[];
   ...
   private _validFaqLibelle = true;
	...
	constructor(private alert: FuseAlertService, private service: FaqAdminService , private faqTypeService: FaqTypeAdminService, @Inject(PLATFORM_ID) private platformId? ) {
