package  ma.zs.zyn.dao.criteria.core.learning;
...
public class SessionCoursCriteria extends  BaseCriteria  {
    ...
    private String nreKeySectionFinished;
    private String nreKeySectionFinishedMin;
    private String nreKeySectionFinishedMax;
    private String nreAddSectionFinished;
    private String nreAddSectionFinishedMin;
    private String nreAddSectionFinishedMax;
    private String totalKeySection;
    private String totalKeySectionMin;
    private String totalKeySectionMax;
    private String totalAddSection;
    private String totalAddSectionMin;
    private String totalAddSectionMax;
    private String nreWords;
    private String nreWordsMin;
    private String nreWordsMax;
    ...
    public String getNreKeySectionFinished(){
        return this.nreKeySectionFinished;
    }
    public void setNreKeySectionFinished(String nreKeySectionFinished){
        this.nreKeySectionFinished = nreKeySectionFinished;
    }   
    public String getNreKeySectionFinishedMin(){
        return this.nreKeySectionFinishedMin;
    }
    public void setNreKeySectionFinishedMin(String nreKeySectionFinishedMin){
        this.nreKeySectionFinishedMin = nreKeySectionFinishedMin;
    }
    public String getNreKeySectionFinishedMax(){
        return this.nreKeySectionFinishedMax;
    }
    public void setNreKeySectionFinishedMax(String nreKeySectionFinishedMax){
        this.nreKeySectionFinishedMax = nreKeySectionFinishedMax;
    }
      
    public String getNreAddSectionFinished(){
        return this.nreAddSectionFinished;
    }
    public void setNreAddSectionFinished(String nreAddSectionFinished){
        this.nreAddSectionFinished = nreAddSectionFinished;
    }   
    public String getNreAddSectionFinishedMin(){
        return this.nreAddSectionFinishedMin;
    }
    public void setNreAddSectionFinishedMin(String nreAddSectionFinishedMin){
        this.nreAddSectionFinishedMin = nreAddSectionFinishedMin;
    }
    public String getNreAddSectionFinishedMax(){
        return this.nreAddSectionFinishedMax;
    }
    public void setNreAddSectionFinishedMax(String nreAddSectionFinishedMax){
        this.nreAddSectionFinishedMax = nreAddSectionFinishedMax;
    }
      
    public String getTotalKeySection(){
        return this.totalKeySection;
    }
    public void setTotalKeySection(String totalKeySection){
        this.totalKeySection = totalKeySection;
    }   
    public String getTotalKeySectionMin(){
        return this.totalKeySectionMin;
    }
    public void setTotalKeySectionMin(String totalKeySectionMin){
        this.totalKeySectionMin = totalKeySectionMin;
    }
    public String getTotalKeySectionMax(){
        return this.totalKeySectionMax;
    }
    public void setTotalKeySectionMax(String totalKeySectionMax){
        this.totalKeySectionMax = totalKeySectionMax;
    }
      
    public String getTotalAddSection(){
        return this.totalAddSection;
    }
    public void setTotalAddSection(String totalAddSection){
        this.totalAddSection = totalAddSection;
    }   
    public String getTotalAddSectionMin(){
        return this.totalAddSectionMin;
    }
    public void setTotalAddSectionMin(String totalAddSectionMin){
        this.totalAddSectionMin = totalAddSectionMin;
    }
    public String getTotalAddSectionMax(){
        return this.totalAddSectionMax;
    }
    public void setTotalAddSectionMax(String totalAddSectionMax){
        this.totalAddSectionMax = totalAddSectionMax;
    }
      
    public String getNreWords(){
        return this.nreWords;
    }
    public void setNreWords(String nreWords){
        this.nreWords = nreWords;
    }   
    public String getNreWordsMin(){
        return this.nreWordsMin;
    }
    public void setNreWordsMin(String nreWordsMin){
        this.nreWordsMin = nreWordsMin;
    }
    public String getNreWordsMax(){
        return this.nreWordsMax;
    }
    public void setNreWordsMax(String nreWordsMax){
        this.nreWordsMax = nreWordsMax;
    }
