...
import ma.zs.alc.service.impl.collaborator.inscriptionref.LangueCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.LangueRestCollaborator;
...
public class LangueRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private LangueCollaboratorServiceImpl service;
    @Mock
    private LangueConverter converter;

    @InjectMocks
    private LangueRestCollaborator controller;
