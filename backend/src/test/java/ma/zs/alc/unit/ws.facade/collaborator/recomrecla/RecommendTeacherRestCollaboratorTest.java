...
import ma.zs.alc.service.impl.collaborator.recomrecla.RecommendTeacherCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.recomrecla.RecommendTeacherRestCollaborator;
...
public class RecommendTeacherRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private RecommendTeacherCollaboratorServiceImpl service;
    @Mock
    private RecommendTeacherConverter converter;

    @InjectMocks
    private RecommendTeacherRestCollaborator controller;
