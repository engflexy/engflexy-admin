...
import ma.zs.alc.service.impl.collaborator.quiz.QuizCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.quiz.QuizRestCollaborator;
...
public class QuizRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private QuizCollaboratorServiceImpl service;
    @Mock
    private QuizConverter converter;

    @InjectMocks
    private QuizRestCollaborator controller;
