...
import ma.zs.alc.service.impl.collaborator.freetrial.FreeTrialformuleCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.freetrial.FreeTrialformuleRestCollaborator;
...
public class FreeTrialformuleRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private FreeTrialformuleCollaboratorServiceImpl service;
    @Mock
    private FreeTrialformuleConverter converter;

    @InjectMocks
    private FreeTrialformuleRestCollaborator controller;
