...
import ma.zs.alc.service.impl.collaborator.inscriptionref.NiveauEtudeCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.NiveauEtudeRestCollaborator;
...
public class NiveauEtudeRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private NiveauEtudeCollaboratorServiceImpl service;
    @Mock
    private NiveauEtudeConverter converter;

    @InjectMocks
    private NiveauEtudeRestCollaborator controller;
