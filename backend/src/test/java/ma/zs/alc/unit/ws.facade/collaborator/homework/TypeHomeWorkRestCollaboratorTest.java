...
import ma.zs.alc.service.impl.collaborator.homework.TypeHomeWorkCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.homework.TypeHomeWorkRestCollaborator;
...
public class TypeHomeWorkRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private TypeHomeWorkCollaboratorServiceImpl service;
    @Mock
    private TypeHomeWorkConverter converter;

    @InjectMocks
    private TypeHomeWorkRestCollaborator controller;
