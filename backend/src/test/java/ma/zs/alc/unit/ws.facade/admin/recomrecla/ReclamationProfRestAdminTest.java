...
import ma.zs.alc.ws.facade.admin.recomrecla.ReclamationProfRestAdmin;
...
public class ReclamationProfRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ReclamationProfAdminServiceImpl service;
    @Mock
    private ReclamationProfConverter converter;

    @InjectMocks
    private ReclamationProfRestAdmin controller;
