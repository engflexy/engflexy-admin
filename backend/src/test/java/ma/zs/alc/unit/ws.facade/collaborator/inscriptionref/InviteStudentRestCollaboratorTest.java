...
import ma.zs.alc.service.impl.collaborator.inscriptionref.InviteStudentCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.InviteStudentRestCollaborator;
...
public class InviteStudentRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private InviteStudentCollaboratorServiceImpl service;
    @Mock
    private InviteStudentConverter converter;

    @InjectMocks
    private InviteStudentRestCollaborator controller;
