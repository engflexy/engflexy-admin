package ma.zs.alc.unit.ws.facade.collaborator.quiz;

import ma.zs.alc.bean.core.quiz.Question;
import ma.zs.alc.service.impl.collaborator.quiz.QuestionCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.quiz.QuestionRestCollaborator;
...
public class QuestionRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private QuestionCollaboratorServiceImpl service;
    @Mock
    private QuestionConverter converter;

    @InjectMocks
    private QuestionRestCollaborator controller;
