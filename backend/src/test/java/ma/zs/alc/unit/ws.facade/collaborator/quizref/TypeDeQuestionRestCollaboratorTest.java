package ma.zs.alc.unit.ws.facade.collaborator.quizref;

import ma.zs.alc.bean.core.quizref.TypeDeQuestion;
import ma.zs.alc.service.impl.collaborator.quizref.TypeDeQuestionCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.quizref.TypeDeQuestionRestCollaborator;
...
public class TypeDeQuestionRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private TypeDeQuestionCollaboratorServiceImpl service;
    @Mock
    private TypeDeQuestionConverter converter;

    @InjectMocks
    private TypeDeQuestionRestCollaborator controller;
