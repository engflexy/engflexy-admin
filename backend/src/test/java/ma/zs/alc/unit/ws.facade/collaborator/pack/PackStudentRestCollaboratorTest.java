package ma.zs.alc.unit.ws.facade.collaborator.pack;

import ma.zs.alc.bean.core.pack.PackStudent;
import ma.zs.alc.service.impl.collaborator.pack.PackStudentCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.pack.PackStudentRestCollaborator;
...
public class PackStudentRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private PackStudentCollaboratorServiceImpl service;
    @Mock
    private PackStudentConverter converter;

    @InjectMocks
    private PackStudentRestCollaborator controller;
