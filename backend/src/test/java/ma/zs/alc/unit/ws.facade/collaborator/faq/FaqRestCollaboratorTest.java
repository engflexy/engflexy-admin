...
import ma.zs.alc.ws.facade.collaborator.faq.FaqRestCollaborator;
...
public class FaqRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private FaqCollaboratorServiceImpl service;
    @Mock
    private FaqConverter converter;

    @InjectMocks
    private FaqRestCollaborator controller;
