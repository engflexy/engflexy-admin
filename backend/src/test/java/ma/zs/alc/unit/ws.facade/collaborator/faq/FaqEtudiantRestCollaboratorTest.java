...
import ma.zs.alc.service.impl.collaborator.faq.FaqEtudiantCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.faq.FaqEtudiantRestCollaborator;
...
public class FaqEtudiantRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private FaqEtudiantCollaboratorServiceImpl service;
    @Mock
    private FaqEtudiantConverter converter;

    @InjectMocks
    private FaqEtudiantRestCollaborator controller;
