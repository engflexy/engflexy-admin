...
import ma.zs.alc.service.impl.collaborator.quizetudiant.QuizEtudiantCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.quizetudiant.QuizEtudiantRestCollaborator;
...
public class QuizEtudiantRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private QuizEtudiantCollaboratorServiceImpl service;
    @Mock
    private QuizEtudiantConverter converter;

    @InjectMocks
    private QuizEtudiantRestCollaborator controller;
