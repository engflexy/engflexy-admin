...
import ma.zs.alc.service.impl.collaborator.grpe.GroupeEtudiantDetailCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.grpe.GroupeEtudiantDetailRestCollaborator;
...
public class GroupeEtudiantDetailRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private GroupeEtudiantDetailCollaboratorServiceImpl service;
    @Mock
    private GroupeEtudiantDetailConverter converter;

    @InjectMocks
    private GroupeEtudiantDetailRestCollaborator controller;
