...
import ma.zs.alc.service.impl.collaborator.faq.FaqProfCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.faq.FaqProfRestCollaborator;
...
public class FaqProfRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private FaqProfCollaboratorServiceImpl service;
    @Mock
    private FaqProfConverter converter;

    @InjectMocks
    private FaqProfRestCollaborator controller;
