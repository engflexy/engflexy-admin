...
import ma.zs.alc.service.impl.collaborator.recomrecla.ReclamationEtudiantCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.recomrecla.ReclamationEtudiantRestCollaborator;
...
public class ReclamationEtudiantRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ReclamationEtudiantCollaboratorServiceImpl service;
    @Mock
    private ReclamationEtudiantConverter converter;

    @InjectMocks
    private ReclamationEtudiantRestCollaborator controller;
