...
import ma.zs.alc.service.impl.collaborator.prof.CategorieProfCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.prof.CategorieProfRestCollaborator;
...
public class CategorieProfRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private CategorieProfCollaboratorServiceImpl service;
    @Mock
    private CategorieProfConverter converter;

    @InjectMocks
    private CategorieProfRestCollaborator controller;
