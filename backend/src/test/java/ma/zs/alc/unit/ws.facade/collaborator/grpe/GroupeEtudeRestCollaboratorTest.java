...
import ma.zs.alc.service.impl.collaborator.grpe.GroupeEtudeCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.grpe.GroupeEtudeRestCollaborator;
...
public class GroupeEtudeRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private GroupeEtudeCollaboratorServiceImpl service;
    @Mock
    private GroupeEtudeConverter converter;

    @InjectMocks
    private GroupeEtudeRestCollaborator controller;
