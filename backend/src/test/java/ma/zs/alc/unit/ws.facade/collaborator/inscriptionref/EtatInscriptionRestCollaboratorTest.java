...
import ma.zs.alc.service.impl.collaborator.inscriptionref.EtatInscriptionCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.EtatInscriptionRestCollaborator;
...
public class EtatInscriptionRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private EtatInscriptionCollaboratorServiceImpl service;
    @Mock
    private EtatInscriptionConverter converter;

    @InjectMocks
    private EtatInscriptionRestCollaborator controller;
