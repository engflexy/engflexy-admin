...
import ma.zs.alc.service.impl.collaborator.inscriptionref.StatutSocialCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.StatutSocialRestCollaborator;
...
public class StatutSocialRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private StatutSocialCollaboratorServiceImpl service;
    @Mock
    private StatutSocialConverter converter;

    @InjectMocks
    private StatutSocialRestCollaborator controller;
