...
import ma.zs.alc.service.impl.collaborator.prof.ClassAverageBonusProfCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.prof.ClassAverageBonusProfRestCollaborator;
...
public class ClassAverageBonusProfRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ClassAverageBonusProfCollaboratorServiceImpl service;
    @Mock
    private ClassAverageBonusProfConverter converter;

    @InjectMocks
    private ClassAverageBonusProfRestCollaborator controller;
