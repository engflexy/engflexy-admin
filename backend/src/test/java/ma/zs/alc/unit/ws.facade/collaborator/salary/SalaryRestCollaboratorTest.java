...
import ma.zs.alc.service.impl.collaborator.salary.SalaryCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.salary.SalaryRestCollaborator;
...
public class SalaryRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private SalaryCollaboratorServiceImpl service;
    @Mock
    private SalaryConverter converter;

    @InjectMocks
    private SalaryRestCollaborator controller;
