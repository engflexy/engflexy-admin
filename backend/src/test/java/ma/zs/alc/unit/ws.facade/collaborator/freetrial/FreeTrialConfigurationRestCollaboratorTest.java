...
import ma.zs.alc.service.impl.collaborator.freetrial.FreeTrialConfigurationCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.freetrial.FreeTrialConfigurationRestCollaborator;
...
public class FreeTrialConfigurationRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private FreeTrialConfigurationCollaboratorServiceImpl service;
    @Mock
    private FreeTrialConfigurationConverter converter;

    @InjectMocks
    private FreeTrialConfigurationRestCollaborator controller;
