...
import ma.zs.alc.service.impl.collaborator.homework.HoweWorkQSTReponseCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.homework.HoweWorkQSTReponseRestCollaborator;
...
public class HoweWorkQSTReponseRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private HoweWorkQSTReponseCollaboratorServiceImpl service;
    @Mock
    private HoweWorkQSTReponseConverter converter;

    @InjectMocks
    private HoweWorkQSTReponseRestCollaborator controller;
