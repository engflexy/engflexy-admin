...
import ma.zs.alc.service.impl.collaborator.inscription.EtudiantCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscription.EtudiantRestCollaborator;
...
public class EtudiantRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private EtudiantCollaboratorServiceImpl service;
    @Mock
    private EtudiantConverter converter;

    @InjectMocks
    private EtudiantRestCollaborator controller;
    ...
    public void itShouldSaveEtudiantTest() throws Exception {
        ...
        assertEquals(savedDto.getSubscribe(), responseBody.getSubscribe());
