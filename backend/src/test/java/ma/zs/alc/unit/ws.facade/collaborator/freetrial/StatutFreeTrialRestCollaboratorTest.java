...
import ma.zs.alc.service.impl.collaborator.freetrial.StatutFreeTrialCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.freetrial.StatutFreeTrialRestCollaborator;
...
public class StatutFreeTrialRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private StatutFreeTrialCollaboratorServiceImpl service;
    @Mock
    private StatutFreeTrialConverter converter;

    @InjectMocks
    private StatutFreeTrialRestCollaborator controller;
