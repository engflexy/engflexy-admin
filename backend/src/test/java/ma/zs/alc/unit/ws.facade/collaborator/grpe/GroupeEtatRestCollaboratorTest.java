...
import ma.zs.alc.service.impl.collaborator.grpe.GroupeEtatCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.grpe.GroupeEtatRestCollaborator;
...
public class GroupeEtatRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private GroupeEtatCollaboratorServiceImpl service;
    @Mock
    private GroupeEtatConverter converter;

    @InjectMocks
    private GroupeEtatRestCollaborator controller;
