...
import ma.zs.alc.service.impl.collaborator.inscriptionref.SkillCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.SkillRestCollaborator;
...
public class SkillRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private SkillCollaboratorServiceImpl service;
    @Mock
    private SkillConverter converter;

    @InjectMocks
    private SkillRestCollaborator controller;
