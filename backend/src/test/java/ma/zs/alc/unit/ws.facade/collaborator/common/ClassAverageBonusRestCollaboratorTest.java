package ma.zs.alc.unit.ws.facade.collaborator.common;

import ma.zs.alc.bean.core.common.ClassAverageBonus;
import ma.zs.alc.service.impl.collaborator.common.ClassAverageBonusCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.common.ClassAverageBonusRestCollaborator;
...
public class ClassAverageBonusRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ClassAverageBonusCollaboratorServiceImpl service;
    @Mock
    private ClassAverageBonusConverter converter;

    @InjectMocks
    private ClassAverageBonusRestCollaborator controller;
