...
import ma.zs.alc.service.impl.collaborator.inscriptionref.EtudiantReviewCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.EtudiantReviewRestCollaborator;
...
public class EtudiantReviewRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private EtudiantReviewCollaboratorServiceImpl service;
    @Mock
    private EtudiantReviewConverter converter;

    @InjectMocks
    private EtudiantReviewRestCollaborator controller;
