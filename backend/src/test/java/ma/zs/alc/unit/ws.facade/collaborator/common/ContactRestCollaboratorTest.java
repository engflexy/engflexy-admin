...
import ma.zs.alc.service.impl.collaborator.common.ContactCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.common.ContactRestCollaborator;
...
public class ContactRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ContactCollaboratorServiceImpl service;
    @Mock
    private ContactConverter converter;

    @InjectMocks
    private ContactRestCollaborator controller;
