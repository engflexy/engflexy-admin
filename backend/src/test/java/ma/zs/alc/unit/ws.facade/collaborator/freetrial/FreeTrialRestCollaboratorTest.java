...
import ma.zs.alc.service.impl.collaborator.freetrial.FreeTrialCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.freetrial.FreeTrialRestCollaborator;
...
public class FreeTrialRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private FreeTrialCollaboratorServiceImpl service;
    @Mock
    private FreeTrialConverter converter;

    @InjectMocks
    private FreeTrialRestCollaborator controller;
