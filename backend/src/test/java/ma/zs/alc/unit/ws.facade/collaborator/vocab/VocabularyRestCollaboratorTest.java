package ma.zs.alc.unit.ws.facade.collaborator.vocab;

import ma.zs.alc.bean.core.vocab.Vocabulary;
import ma.zs.alc.service.impl.collaborator.vocab.VocabularyCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.vocab.VocabularyRestCollaborator;
...
public class VocabularyRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private VocabularyCollaboratorServiceImpl service;
    @Mock
    private VocabularyConverter converter;

    @InjectMocks
    private VocabularyRestCollaborator controller;
