...
import ma.zs.alc.service.impl.collaborator.course.SectionItemCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.course.SectionItemRestCollaborator;
...
public class SectionItemRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private SectionItemCollaboratorServiceImpl service;
    @Mock
    private SectionItemConverter converter;

    @InjectMocks
    private SectionItemRestCollaborator controller;
