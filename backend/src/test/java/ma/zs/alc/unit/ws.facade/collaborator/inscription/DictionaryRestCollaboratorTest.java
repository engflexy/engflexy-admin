package ma.zs.alc.unit.ws.facade.collaborator.inscription;

import ma.zs.alc.bean.core.inscription.Dictionary;
import ma.zs.alc.service.impl.collaborator.inscription.DictionaryCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscription.DictionaryRestCollaborator;
...
public class DictionaryRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private DictionaryCollaboratorServiceImpl service;
    @Mock
    private DictionaryConverter converter;

    @InjectMocks
    private DictionaryRestCollaborator controller;
    ...
    public void itShouldSaveDictionaryTest() throws Exception {
        ...
        assertEquals(savedDto.getLearned(), responseBody.getLearned());
        assertEquals(savedDto.getCreatedOn(), responseBody.getCreatedOn());
    }
