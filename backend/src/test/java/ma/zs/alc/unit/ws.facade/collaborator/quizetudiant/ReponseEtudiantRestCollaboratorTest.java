package ma.zs.alc.unit.ws.facade.collaborator.quizetudiant;

import ma.zs.alc.bean.core.quizetudiant.ReponseEtudiant;
import ma.zs.alc.service.impl.collaborator.quizetudiant.ReponseEtudiantCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.quizetudiant.ReponseEtudiantRestCollaborator;
...
public class ReponseEtudiantRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ReponseEtudiantCollaboratorServiceImpl service;
    @Mock
    private ReponseEtudiantConverter converter;

    @InjectMocks
    private ReponseEtudiantRestCollaborator controller;
