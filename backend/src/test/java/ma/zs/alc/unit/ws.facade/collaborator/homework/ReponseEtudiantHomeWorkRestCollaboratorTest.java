...
import ma.zs.alc.service.impl.collaborator.homework.ReponseEtudiantHomeWorkCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.homework.ReponseEtudiantHomeWorkRestCollaborator;
...
public class ReponseEtudiantHomeWorkRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ReponseEtudiantHomeWorkCollaboratorServiceImpl service;
    @Mock
    private ReponseEtudiantHomeWorkConverter converter;

    @InjectMocks
    private ReponseEtudiantHomeWorkRestCollaborator controller;
