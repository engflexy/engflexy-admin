...
import ma.zs.alc.service.impl.collaborator.salary.WorkloadBonusCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.salary.WorkloadBonusRestCollaborator;
...
public class WorkloadBonusRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private WorkloadBonusCollaboratorServiceImpl service;
    @Mock
    private WorkloadBonusConverter converter;

    @InjectMocks
    private WorkloadBonusRestCollaborator controller;
