...
import ma.zs.alc.service.impl.collaborator.course.ExerciceCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.course.ExerciceRestCollaborator;
...
public class ExerciceRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ExerciceCollaboratorServiceImpl service;
    @Mock
    private ExerciceConverter converter;

    @InjectMocks
    private ExerciceRestCollaborator controller;
