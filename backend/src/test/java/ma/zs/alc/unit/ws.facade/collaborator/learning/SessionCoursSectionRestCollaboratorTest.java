...
import ma.zs.alc.service.impl.collaborator.learning.SessionCoursSectionCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.learning.SessionCoursSectionRestCollaborator;
...
public class SessionCoursSectionRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private SessionCoursSectionCollaboratorServiceImpl service;
    @Mock
    private SessionCoursSectionConverter converter;

    @InjectMocks
    private SessionCoursSectionRestCollaborator controller;
