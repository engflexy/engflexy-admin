package ma.zs.alc.unit.ws.facade.collaborator.courseref;

import ma.zs.alc.bean.core.courseref.LevelTestConfiguration;
import ma.zs.alc.service.impl.collaborator.courseref.LevelTestConfigurationCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.courseref.LevelTestConfigurationRestCollaborator;
...
public class LevelTestConfigurationRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private LevelTestConfigurationCollaboratorServiceImpl service;
    @Mock
    private LevelTestConfigurationConverter converter;

    @InjectMocks
    private LevelTestConfigurationRestCollaborator controller;
