...
import ma.zs.alc.service.impl.collaborator.homework.HomeWorkCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.homework.HomeWorkRestCollaborator;
...
public class HomeWorkRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private HomeWorkCollaboratorServiceImpl service;
    @Mock
    private HomeWorkConverter converter;

    @InjectMocks
    private HomeWorkRestCollaborator controller;
