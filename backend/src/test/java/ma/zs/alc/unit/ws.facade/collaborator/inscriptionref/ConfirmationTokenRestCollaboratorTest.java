...
import ma.zs.alc.service.impl.collaborator.inscriptionref.ConfirmationTokenCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.ConfirmationTokenRestCollaborator;
...
public class ConfirmationTokenRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ConfirmationTokenCollaboratorServiceImpl service;
    @Mock
    private ConfirmationTokenConverter converter;

    @InjectMocks
    private ConfirmationTokenRestCollaborator controller;
