package ma.zs.alc.unit.ws.facade.collaborator.price;

import ma.zs.alc.bean.core.price.Price;
import ma.zs.alc.service.impl.collaborator.price.PriceCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.price.PriceRestCollaborator;
...
public class PriceRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private PriceCollaboratorServiceImpl service;
    @Mock
    private PriceConverter converter;

    @InjectMocks
    private PriceRestCollaborator controller;
