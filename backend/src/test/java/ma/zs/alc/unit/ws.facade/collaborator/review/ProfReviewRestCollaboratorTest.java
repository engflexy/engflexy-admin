package ma.zs.alc.unit.ws.facade.collaborator.review;

import ma.zs.alc.bean.core.review.ProfReview;
import ma.zs.alc.service.impl.collaborator.review.ProfReviewCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.review.ProfReviewRestCollaborator;
...
public class ProfReviewRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ProfReviewCollaboratorServiceImpl service;
    @Mock
    private ProfReviewConverter converter;

    @InjectMocks
    private ProfReviewRestCollaborator controller;
