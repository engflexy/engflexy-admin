package ma.zs.alc.unit.ws.facade.collaborator.salary;

import ma.zs.alc.bean.core.salary.WorkloadBonusProf;
import ma.zs.alc.service.impl.collaborator.salary.WorkloadBonusProfCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.salary.WorkloadBonusProfRestCollaborator;
...
public class WorkloadBonusProfRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private WorkloadBonusProfCollaboratorServiceImpl service;
    @Mock
    private WorkloadBonusProfConverter converter;

    @InjectMocks
    private WorkloadBonusProfRestCollaborator controller;
