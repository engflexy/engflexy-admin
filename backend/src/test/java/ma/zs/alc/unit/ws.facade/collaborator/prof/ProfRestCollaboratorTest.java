...
import ma.zs.alc.service.impl.collaborator.prof.ProfCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.prof.ProfRestCollaborator;
...
public class ProfRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ProfCollaboratorServiceImpl service;
    @Mock
    private ProfConverter converter;

    @InjectMocks
    private ProfRestCollaborator controller;
