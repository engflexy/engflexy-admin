...
import ma.zs.alc.service.impl.collaborator.course.CoursCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.course.CoursRestCollaborator;
...
public class CoursRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private CoursCollaboratorServiceImpl service;
    @Mock
    private CoursConverter converter;

    @InjectMocks
    private CoursRestCollaborator controller;
