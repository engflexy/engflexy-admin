...
import ma.zs.alc.service.impl.collaborator.recomrecla.TypeReclamationEtudiantCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.recomrecla.TypeReclamationEtudiantRestCollaborator;
...
public class TypeReclamationEtudiantRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private TypeReclamationEtudiantCollaboratorServiceImpl service;
    @Mock
    private TypeReclamationEtudiantConverter converter;

    @InjectMocks
    private TypeReclamationEtudiantRestCollaborator controller;
