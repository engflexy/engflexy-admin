...
import ma.zs.alc.service.impl.collaborator.course.ParcoursCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.course.ParcoursRestCollaborator;
...
public class ParcoursRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ParcoursCollaboratorServiceImpl service;
    @Mock
    private ParcoursConverter converter;

    @InjectMocks
    private ParcoursRestCollaborator controller;
