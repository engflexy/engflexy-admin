...
import ma.zs.alc.service.impl.collaborator.homework.HomeWorkEtudiantCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.homework.HomeWorkEtudiantRestCollaborator;
...
public class HomeWorkEtudiantRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private HomeWorkEtudiantCollaboratorServiceImpl service;
    @Mock
    private HomeWorkEtudiantConverter converter;

    @InjectMocks
    private HomeWorkEtudiantRestCollaborator controller;
