...
import ma.zs.alc.service.impl.collaborator.inscriptionref.TeacherLocalityCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.TeacherLocalityRestCollaborator;
...
public class TeacherLocalityRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private TeacherLocalityCollaboratorServiceImpl service;
    @Mock
    private TeacherLocalityConverter converter;

    @InjectMocks
    private TeacherLocalityRestCollaborator controller;
