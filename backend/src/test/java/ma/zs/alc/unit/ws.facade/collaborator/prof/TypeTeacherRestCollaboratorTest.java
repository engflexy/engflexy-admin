...
import ma.zs.alc.service.impl.collaborator.prof.TypeTeacherCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.prof.TypeTeacherRestCollaborator;
...
public class TypeTeacherRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private TypeTeacherCollaboratorServiceImpl service;
    @Mock
    private TypeTeacherConverter converter;

    @InjectMocks
    private TypeTeacherRestCollaborator controller;
