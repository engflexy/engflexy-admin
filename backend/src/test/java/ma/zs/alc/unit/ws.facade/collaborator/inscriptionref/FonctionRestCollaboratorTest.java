...
import ma.zs.alc.service.impl.collaborator.inscriptionref.FonctionCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.inscriptionref.FonctionRestCollaborator;
...
public class FonctionRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private FonctionCollaboratorServiceImpl service;
    @Mock
    private FonctionConverter converter;

    @InjectMocks
    private FonctionRestCollaborator controller;
