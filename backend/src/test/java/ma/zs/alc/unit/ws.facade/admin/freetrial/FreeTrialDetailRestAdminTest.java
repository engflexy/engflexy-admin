...
import ma.zs.alc.ws.facade.admin.freetrial.FreeTrialDetailRestAdmin;
...
public class FreeTrialDetailRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private FreeTrialDetailAdminServiceImpl service;
    @Mock
    private FreeTrialDetailConverter converter;

    @InjectMocks
    private FreeTrialDetailRestAdmin controller;
