...
import ma.zs.alc.service.impl.collaborator.courseref.ContentTypeCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.courseref.ContentTypeRestCollaborator;
...
public class ContentTypeRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ContentTypeCollaboratorServiceImpl service;
    @Mock
    private ContentTypeConverter converter;

    @InjectMocks
    private ContentTypeRestCollaborator controller;
