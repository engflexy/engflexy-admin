...
import ma.zs.alc.service.impl.collaborator.quiz.ReponseCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.quiz.ReponseRestCollaborator;
...
public class ReponseRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ReponseCollaboratorServiceImpl service;
    @Mock
    private ReponseConverter converter;

    @InjectMocks
    private ReponseRestCollaborator controller;
