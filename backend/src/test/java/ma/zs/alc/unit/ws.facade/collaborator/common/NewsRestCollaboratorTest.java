...
import ma.zs.alc.service.impl.collaborator.common.NewsCollaboratorServiceImpl;
import ma.zs.alc.ws.facade.collaborator.common.NewsRestCollaborator;
...
public class NewsRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private NewsCollaboratorServiceImpl service;
    @Mock
    private NewsConverter converter;

    @InjectMocks
    private NewsRestCollaborator controller;
