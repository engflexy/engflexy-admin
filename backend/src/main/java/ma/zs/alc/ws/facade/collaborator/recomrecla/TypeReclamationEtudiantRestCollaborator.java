...
@RestController
@RequestMapping("/api/collaborator/typeReclamationEtudiant/")
public class TypeReclamationEtudiantRestCollaborator  extends AbstractController<TypeReclamationEtudiant, TypeReclamationEtudiantDto, TypeReclamationEtudiantCriteria, TypeReclamationEtudiantCollaboratorService, TypeReclamationEtudiantConverter> {
    ...
    public TypeReclamationEtudiantRestCollaborator (TypeReclamationEtudiantCollaboratorService service, TypeReclamationEtudiantConverter converter) {
