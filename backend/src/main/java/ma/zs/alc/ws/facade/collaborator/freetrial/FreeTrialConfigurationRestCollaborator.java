...
@RestController
@RequestMapping("/api/collaborator/freeTrialConfiguration/")
public class FreeTrialConfigurationRestCollaborator  extends AbstractController<FreeTrialConfiguration, FreeTrialConfigurationDto, FreeTrialConfigurationCriteria, FreeTrialConfigurationCollaboratorService, FreeTrialConfigurationConverter> {
    ...
    public FreeTrialConfigurationRestCollaborator (FreeTrialConfigurationCollaboratorService service, FreeTrialConfigurationConverter converter) {
