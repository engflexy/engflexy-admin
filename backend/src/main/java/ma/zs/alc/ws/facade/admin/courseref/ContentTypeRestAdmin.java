...
@RestController
@RequestMapping("/api/admin/contentType/")
public class ContentTypeRestAdmin  extends AbstractController<ContentType, ContentTypeDto, ContentTypeCriteria, ContentTypeAdminService, ContentTypeConverter> {
    ...
    public ContentTypeRestAdmin (ContentTypeAdminService service, ContentTypeConverter converter) {
