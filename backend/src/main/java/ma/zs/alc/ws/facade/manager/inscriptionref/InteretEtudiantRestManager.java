...
@RestController
@RequestMapping("/api/manager/interetEtudiant/")
public class InteretEtudiantRestManager  extends AbstractController<InteretEtudiant, InteretEtudiantDto, InteretEtudiantCriteria, InteretEtudiantManagerService, InteretEtudiantConverter> {
    ...
    public InteretEtudiantRestManager (InteretEtudiantManagerService service, InteretEtudiantConverter converter) {
