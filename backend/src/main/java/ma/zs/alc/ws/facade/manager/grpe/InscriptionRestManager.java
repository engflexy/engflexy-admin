...
public class InscriptionRestManager  extends AbstractController<Inscription, InscriptionDto, InscriptionCriteria, InscriptionManagerService, InscriptionConverter> {
