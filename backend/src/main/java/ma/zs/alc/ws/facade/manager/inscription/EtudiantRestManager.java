...
@RestController
@RequestMapping("/api/manager/etudiant/")
public class EtudiantRestManager extends AbstractController<Etudiant, EtudiantDto, EtudiantCriteria, EtudiantManagerService, EtudiantConverter> {
    ...
    public EtudiantRestManager(EtudiantManagerService service, EtudiantConverter converter) {
