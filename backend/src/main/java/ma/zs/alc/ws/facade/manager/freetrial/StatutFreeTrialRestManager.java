...
@RestController
@RequestMapping("/api/manager/statutFreeTrial/")
public class StatutFreeTrialRestManager  extends AbstractController<StatutFreeTrial, StatutFreeTrialDto, StatutFreeTrialCriteria, StatutFreeTrialManagerService, StatutFreeTrialConverter> {
    ...
    public StatutFreeTrialRestManager (StatutFreeTrialManagerService service, StatutFreeTrialConverter converter) {
