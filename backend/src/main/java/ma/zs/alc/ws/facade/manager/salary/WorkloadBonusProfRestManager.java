...
@RestController
@RequestMapping("/api/manager/workloadBonusProf/")
public class WorkloadBonusProfRestManager  extends AbstractController<WorkloadBonusProf, WorkloadBonusProfDto, WorkloadBonusProfCriteria, WorkloadBonusProfManagerService, WorkloadBonusProfConverter> {
    ...
    public WorkloadBonusProfRestManager (WorkloadBonusProfManagerService service, WorkloadBonusProfConverter converter) {
