...
@RestController
@RequestMapping("/api/collaborator/levelTestConfiguration/")
public class LevelTestConfigurationRestCollaborator  extends AbstractController<LevelTestConfiguration, LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationCollaboratorService, LevelTestConfigurationConverter> {
    ...
    public LevelTestConfigurationRestCollaborator (LevelTestConfigurationCollaboratorService service, LevelTestConfigurationConverter converter) {
