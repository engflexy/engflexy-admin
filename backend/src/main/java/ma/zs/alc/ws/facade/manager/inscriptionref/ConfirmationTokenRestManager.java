...
@RestController
@RequestMapping("/api/manager/confirmationToken/")
public class ConfirmationTokenRestManager  extends AbstractController<ConfirmationToken, ConfirmationTokenDto, ConfirmationTokenCriteria, ConfirmationTokenManagerService, ConfirmationTokenConverter> {
    ...
    public ConfirmationTokenRestManager (ConfirmationTokenManagerService service, ConfirmationTokenConverter converter) {
