...
@RestController
@RequestMapping("/api/collaborator/reclamationEtudiant/")
public class ReclamationEtudiantRestCollaborator  extends AbstractController<ReclamationEtudiant, ReclamationEtudiantDto, ReclamationEtudiantCriteria, ReclamationEtudiantCollaboratorService, ReclamationEtudiantConverter> {
    ...
    public ReclamationEtudiantRestCollaborator (ReclamationEtudiantCollaboratorService service, ReclamationEtudiantConverter converter) {
