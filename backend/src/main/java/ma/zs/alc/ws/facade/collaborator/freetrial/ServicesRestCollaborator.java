...
@RestController
@RequestMapping("/api/collaborator/services/")
public class ServicesRestCollaborator  extends AbstractController<Services, ServicesDto, ServicesCriteria, ServicesCollaboratorService, ServicesConverter> {
    ...
    public ServicesRestCollaborator (ServicesCollaboratorService service, ServicesConverter converter) {
