package ma.zs.alc.ws.facade.manager.inscription;
...
@RestController
@RequestMapping("/api/manager/dictionary/")
public class DictionaryRestManager  extends AbstractController<Dictionary, DictionaryDto, DictionaryCriteria, DictionaryManagerService, DictionaryConverter> {
    ...
    public DictionaryRestManager (DictionaryManagerService service, DictionaryConverter converter) {
