...
@RestController
@RequestMapping("/api/collaborator/salary/")
public class SalaryRestCollaborator  extends AbstractController<Salary, SalaryDto, SalaryCriteria, SalaryCollaboratorService, SalaryConverter> {
    ...
    public SalaryRestCollaborator (SalaryCollaboratorService service, SalaryConverter converter) {
