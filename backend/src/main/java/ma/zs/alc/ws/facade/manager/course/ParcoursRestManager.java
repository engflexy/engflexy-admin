...
@RestController
@RequestMapping("/api/manager/parcours/")
public class ParcoursRestManager  extends AbstractController<Parcours, ParcoursDto, ParcoursCriteria, ParcoursManagerService, ParcoursConverter> {
    ...
    public ParcoursRestManager (ParcoursManagerService service, ParcoursConverter converter) {
