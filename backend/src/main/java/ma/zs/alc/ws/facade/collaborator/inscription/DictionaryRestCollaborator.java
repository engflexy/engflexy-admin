...
@RestController
@RequestMapping("/api/collaborator/dictionary/")
public class DictionaryRestCollaborator  extends AbstractController<Dictionary, DictionaryDto, DictionaryCriteria, DictionaryCollaboratorService, DictionaryConverter> {
    ...
    public DictionaryRestCollaborator (DictionaryCollaboratorService service, DictionaryConverter converter) {
