...
@RestController
@RequestMapping("/api/collaborator/reponseEtudiantHomeWork/")
public class ReponseEtudiantHomeWorkRestCollaborator  extends AbstractController<ReponseEtudiantHomeWork, ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkCollaboratorService, ReponseEtudiantHomeWorkConverter> {
    ...
    public ReponseEtudiantHomeWorkRestCollaborator (ReponseEtudiantHomeWorkCollaboratorService service, ReponseEtudiantHomeWorkConverter converter) {
