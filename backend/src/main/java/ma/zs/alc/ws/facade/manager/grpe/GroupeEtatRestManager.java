...
@RestController
@RequestMapping("/api/manager/groupeEtat/")
public class GroupeEtatRestManager  extends AbstractController<GroupeEtat, GroupeEtatDto, GroupeEtatCriteria, GroupeEtatManagerService, GroupeEtatConverter> {
    ...
    public GroupeEtatRestManager (GroupeEtatManagerService service, GroupeEtatConverter converter) {
