...
@RestController
@RequestMapping("/api/manager/salary/")
public class SalaryRestManager  extends AbstractController<Salary, SalaryDto, SalaryCriteria, SalaryManagerService, SalaryConverter> {
    ...
    public SalaryRestManager (SalaryManagerService service, SalaryConverter converter) {
