...
@RestController
@RequestMapping("/api/manager/sessionCours/")
public class SessionCoursRestManager  extends AbstractController<SessionCours, SessionCoursDto, SessionCoursCriteria, SessionCoursManagerService, SessionCoursConverter> {
    ...
    public SessionCoursRestManager (SessionCoursManagerService service, SessionCoursConverter converter) {
