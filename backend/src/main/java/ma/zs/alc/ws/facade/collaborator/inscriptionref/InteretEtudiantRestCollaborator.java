...
@RestController
@RequestMapping("/api/collaborator/interetEtudiant/")
public class InteretEtudiantRestCollaborator  extends AbstractController<InteretEtudiant, InteretEtudiantDto, InteretEtudiantCriteria, InteretEtudiantCollaboratorService, InteretEtudiantConverter> {
    ...
    public InteretEtudiantRestCollaborator (InteretEtudiantCollaboratorService service, InteretEtudiantConverter converter) {
