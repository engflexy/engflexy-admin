package  ma.zs.alc.ws.facade.collaborator.pack;
...
@RestController
@RequestMapping("/api/collaborator/packStudent/")
public class PackStudentRestCollaborator  extends AbstractController<PackStudent, PackStudentDto, PackStudentCriteria, PackStudentCollaboratorService, PackStudentConverter> {
    ...
    public PackStudentRestCollaborator (PackStudentCollaboratorService service, PackStudentConverter converter) {
