package ma.zs.alc.ws.facade.collaborator.notif;
...
@RestController
@RequestMapping("/api/collaborator/notificationActeur/")
public class NotificationActeurRestCollaborator {
   ...
   public NotificationActeurRestCollaborator(NotificationActeurCollaboratorService service, NotificationActeurConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final NotificationActeurCollaboratorService service;
