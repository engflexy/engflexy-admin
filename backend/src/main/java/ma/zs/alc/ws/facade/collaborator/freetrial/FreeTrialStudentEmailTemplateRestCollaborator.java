package  ma.zs.alc.ws.facade.collaborator.freetrial;
...
@RestController
@RequestMapping("/api/collaborator/freeTrialStudentEmailTemplate/")
public class FreeTrialStudentEmailTemplateRestCollaborator  extends AbstractController<FreeTrialStudentEmailTemplate, FreeTrialStudentEmailTemplateDto, FreeTrialStudentEmailTemplateCriteria, FreeTrialStudentEmailTemplateCollaboratorService, FreeTrialStudentEmailTemplateConverter> {
    ...
    public FreeTrialStudentEmailTemplateRestCollaborator (FreeTrialStudentEmailTemplateCollaboratorService service, FreeTrialStudentEmailTemplateConverter converter) {
