...
@RestController
@RequestMapping("/api/manager/faqType/")
public class FaqTypeRestManager  extends AbstractController<FaqType, FaqTypeDto, FaqTypeCriteria, FaqTypeManagerService, FaqTypeConverter> {
    ...
    public FaqTypeRestManager (FaqTypeManagerService service, FaqTypeConverter converter) {
