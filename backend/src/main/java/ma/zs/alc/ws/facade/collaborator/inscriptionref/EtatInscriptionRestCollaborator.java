...
@RestController
@RequestMapping("/api/collaborator/etatInscription/")
public class EtatInscriptionRestCollaborator  extends AbstractController<EtatInscription, EtatInscriptionDto, EtatInscriptionCriteria, EtatInscriptionCollaboratorService, EtatInscriptionConverter> {
    ...
    public EtatInscriptionRestCollaborator (EtatInscriptionCollaboratorService service, EtatInscriptionConverter converter) {
