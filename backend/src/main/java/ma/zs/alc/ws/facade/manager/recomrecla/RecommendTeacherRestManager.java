...
@RestController
@RequestMapping("/api/manager/recommendTeacher/")
public class RecommendTeacherRestManager  extends AbstractController<RecommendTeacher, RecommendTeacherDto, RecommendTeacherCriteria, RecommendTeacherManagerService, RecommendTeacherConverter> {
    ...
    public RecommendTeacherRestManager (RecommendTeacherManagerService service, RecommendTeacherConverter converter) {
