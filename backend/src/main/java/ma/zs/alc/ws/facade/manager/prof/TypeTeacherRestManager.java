...
@RestController
@RequestMapping("/api/manager/typeTeacher/")
public class TypeTeacherRestManager  extends AbstractController<TypeTeacher, TypeTeacherDto, TypeTeacherCriteria, TypeTeacherManagerService, TypeTeacherConverter> {
    ...
    public TypeTeacherRestManager (TypeTeacherManagerService service, TypeTeacherConverter converter) {
