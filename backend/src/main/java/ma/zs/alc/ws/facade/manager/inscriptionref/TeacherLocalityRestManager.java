...
@RestController
@RequestMapping("/api/manager/teacherLocality/")
public class TeacherLocalityRestManager  extends AbstractController<TeacherLocality, TeacherLocalityDto, TeacherLocalityCriteria, TeacherLocalityManagerService, TeacherLocalityConverter> {
    ...
    public TeacherLocalityRestManager (TeacherLocalityManagerService service, TeacherLocalityConverter converter) {
