...
@RestController
@RequestMapping("/api/manager/reponse/")
public class ReponseRestManager  extends AbstractController<Reponse, ReponseDto, ReponseCriteria, ReponseManagerService, ReponseConverter> {
    ...
    public ReponseRestManager (ReponseManagerService service, ReponseConverter converter) {
