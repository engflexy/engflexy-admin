...
@RestController
@RequestMapping("/api/collaborator/freeTrialStudentWhatsTemplate/")
public class FreeTrialStudentWhatsTemplateRestCollaborator  extends AbstractController<FreeTrialStudentWhatsTemplate, FreeTrialStudentWhatsTemplateDto, FreeTrialStudentWhatsTemplateCriteria, FreeTrialStudentWhatsTemplateCollaboratorService, FreeTrialStudentWhatsTemplateConverter> {
    ...
    public FreeTrialStudentWhatsTemplateRestCollaborator (FreeTrialStudentWhatsTemplateCollaboratorService service, FreeTrialStudentWhatsTemplateConverter converter) {
