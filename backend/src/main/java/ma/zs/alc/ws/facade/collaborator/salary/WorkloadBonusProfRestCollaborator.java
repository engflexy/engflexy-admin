package  ma.zs.alc.ws.facade.collaborator.salary;
...
@RestController
@RequestMapping("/api/collaborator/workloadBonusProf/")
public class WorkloadBonusProfRestCollaborator  extends AbstractController<WorkloadBonusProf, WorkloadBonusProfDto, WorkloadBonusProfCriteria, WorkloadBonusProfCollaboratorService, WorkloadBonusProfConverter> {
    ...
    public WorkloadBonusProfRestCollaborator (WorkloadBonusProfCollaboratorService service, WorkloadBonusProfConverter converter) {
