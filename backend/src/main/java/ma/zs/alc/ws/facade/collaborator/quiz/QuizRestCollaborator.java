...
@RestController
@RequestMapping("/api/collaborator/quiz/")
public class QuizRestCollaborator  extends AbstractController<Quiz, QuizDto, QuizCriteria, QuizCollaboratorService, QuizConverter> {
    ...
    public QuizRestCollaborator (QuizCollaboratorService service, QuizConverter converter) {
