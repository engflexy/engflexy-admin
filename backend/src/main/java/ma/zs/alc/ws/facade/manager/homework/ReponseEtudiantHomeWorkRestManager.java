...
@RestController
@RequestMapping("/api/manager/reponseEtudiantHomeWork/")
public class ReponseEtudiantHomeWorkRestManager  extends AbstractController<ReponseEtudiantHomeWork, ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkManagerService, ReponseEtudiantHomeWorkConverter> {
    ...
    public ReponseEtudiantHomeWorkRestManager (ReponseEtudiantHomeWorkManagerService service, ReponseEtudiantHomeWorkConverter converter) {
