...
@RestController
@RequestMapping("/api/collaborator/groupeEtat/")
public class GroupeEtatRestCollaborator  extends AbstractController<GroupeEtat, GroupeEtatDto, GroupeEtatCriteria, GroupeEtatCollaboratorService, GroupeEtatConverter> {
    ...
    public GroupeEtatRestCollaborator (GroupeEtatCollaboratorService service, GroupeEtatConverter converter) {
