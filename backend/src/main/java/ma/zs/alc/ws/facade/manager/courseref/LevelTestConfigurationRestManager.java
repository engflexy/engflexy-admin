...
@RestController
@RequestMapping("/api/manager/levelTestConfiguration/")
public class LevelTestConfigurationRestManager  extends AbstractController<LevelTestConfiguration, LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationManagerService, LevelTestConfigurationConverter> {
    ...
    public LevelTestConfigurationRestManager (LevelTestConfigurationManagerService service, LevelTestConfigurationConverter converter) {
