package  ma.zs.alc.ws.facade.collaborator.inscriptionref;
...
@RestController
@RequestMapping("/api/collaborator/confirmationToken/")
public class ConfirmationTokenRestCollaborator  extends AbstractController<ConfirmationToken, ConfirmationTokenDto, ConfirmationTokenCriteria, ConfirmationTokenCollaboratorService, ConfirmationTokenConverter> {
    ...
    public ConfirmationTokenRestCollaborator (ConfirmationTokenCollaboratorService service, ConfirmationTokenConverter converter) {
