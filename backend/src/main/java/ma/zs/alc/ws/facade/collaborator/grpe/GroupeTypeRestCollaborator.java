...
@RestController
@RequestMapping("/api/collaborator/groupeType/")
public class GroupeTypeRestCollaborator  extends AbstractController<GroupeType, GroupeTypeDto, GroupeTypeCriteria, GroupeTypeCollaboratorService, GroupeTypeConverter> {
    ...
    public GroupeTypeRestCollaborator (GroupeTypeCollaboratorService service, GroupeTypeConverter converter) {
