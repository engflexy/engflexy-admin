...
@RestController
@RequestMapping("/api/manager/niveauEtude/")
public class NiveauEtudeRestManager  extends AbstractController<NiveauEtude, NiveauEtudeDto, NiveauEtudeCriteria, NiveauEtudeManagerService, NiveauEtudeConverter> {
    ...
    public NiveauEtudeRestManager (NiveauEtudeManagerService service, NiveauEtudeConverter converter) {
