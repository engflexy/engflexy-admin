package  ma.zs.alc.ws.facade.collaborator.paiement;
...
@RestController
@RequestMapping("/api/collaborator/paiement/")
public class PaiementRestCollaborator  extends AbstractController<Paiement, PaiementDto, PaiementCriteria, PaiementCollaboratorService, PaiementConverter> {
    ...
    public PaiementRestCollaborator (PaiementCollaboratorService service, PaiementConverter converter) {
