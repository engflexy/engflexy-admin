package  ma.zs.alc.ws.facade.collaborator.quizref;
...
@RestController
@RequestMapping("/api/collaborator/typeDeQuestion/")
public class TypeDeQuestionRestCollaborator  extends AbstractController<TypeDeQuestion, TypeDeQuestionDto, TypeDeQuestionCriteria, TypeDeQuestionCollaboratorService, TypeDeQuestionConverter> {
    ...
    public TypeDeQuestionRestCollaborator (TypeDeQuestionCollaboratorService service, TypeDeQuestionConverter converter) {
