...
@RestController
@RequestMapping("/api/manager/groupeEtudiantDetail/")
public class GroupeEtudiantDetailRestManager  extends AbstractController<GroupeEtudiantDetail, GroupeEtudiantDetailDto, GroupeEtudiantDetailCriteria, GroupeEtudiantDetailManagerService, GroupeEtudiantDetailConverter> {
    ...
    public GroupeEtudiantDetailRestManager (GroupeEtudiantDetailManagerService service, GroupeEtudiantDetailConverter converter) {
