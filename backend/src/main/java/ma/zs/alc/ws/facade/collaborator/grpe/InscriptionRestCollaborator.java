...
public class InscriptionRestCollaborator  extends AbstractController<Inscription, InscriptionDto, InscriptionCriteria, InscriptionCollaboratorService, InscriptionConverter> {
    ...
    public InscriptionRestCollaborator (InscriptionCollaboratorService service, InscriptionConverter converter) {
