...
@RestController
@RequestMapping("/api/collaborator/trancheHoraireProf/")
public class TrancheHoraireProfRestCollaborator  extends AbstractController<TrancheHoraireProf, TrancheHoraireProfDto, TrancheHoraireProfCriteria, TrancheHoraireProfCollaboratorService, TrancheHoraireProfConverter> {
    ...
    public TrancheHoraireProfRestCollaborator (TrancheHoraireProfCollaboratorService service, TrancheHoraireProfConverter converter) {
