...
@RestController
@RequestMapping("/api/admin/paiementInscriptionCollaborator/")
public class PaiementInscriptionCollaboratorRestAdmin  extends AbstractController<PaiementInscriptionCollaborator, PaiementInscriptionCollaboratorDto, PaiementInscriptionCollaboratorCriteria, PaiementInscriptionCollaboratorAdminService, PaiementInscriptionCollaboratorConverter> {
    ...
    public PaiementInscriptionCollaboratorRestAdmin (PaiementInscriptionCollaboratorAdminService service, PaiementInscriptionCollaboratorConverter converter) {
