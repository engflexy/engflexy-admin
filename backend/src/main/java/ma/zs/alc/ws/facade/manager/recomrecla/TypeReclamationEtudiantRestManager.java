...
@RestController
@RequestMapping("/api/manager/typeReclamationEtudiant/")
public class TypeReclamationEtudiantRestManager  extends AbstractController<TypeReclamationEtudiant, TypeReclamationEtudiantDto, TypeReclamationEtudiantCriteria, TypeReclamationEtudiantManagerService, TypeReclamationEtudiantConverter> {
    ...
    public TypeReclamationEtudiantRestManager (TypeReclamationEtudiantManagerService service, TypeReclamationEtudiantConverter converter) {
