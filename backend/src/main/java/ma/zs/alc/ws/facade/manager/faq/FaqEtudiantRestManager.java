package ma.zs.alc.ws.facade.manager.faq;
...
@RestController
@RequestMapping("/api/manager/faqEtudiant/")
public class FaqEtudiantRestManager  extends AbstractController<FaqEtudiant, FaqEtudiantDto, FaqEtudiantCriteria, FaqEtudiantManagerService, FaqEtudiantConverter> {
    ...
    public FaqEtudiantRestManager (FaqEtudiantManagerService service, FaqEtudiantConverter converter) {
