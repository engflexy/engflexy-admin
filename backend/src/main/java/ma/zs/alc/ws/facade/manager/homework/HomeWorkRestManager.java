...
@RestController
@RequestMapping("/api/manager/homeWork/")
public class HomeWorkRestManager  extends AbstractController<HomeWork, HomeWorkDto, HomeWorkCriteria, HomeWorkManagerService, HomeWorkConverter> {
    ...
    public HomeWorkRestManager (HomeWorkManagerService service, HomeWorkConverter converter) {
