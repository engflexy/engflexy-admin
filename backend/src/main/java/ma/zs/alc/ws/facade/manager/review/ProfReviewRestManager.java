package ma.zs.alc.ws.facade.manager.review;
...
@RestController
@RequestMapping("/api/manager/profReview/")
public class ProfReviewRestManager  extends AbstractController<ProfReview, ProfReviewDto, ProfReviewCriteria, ProfReviewManagerService, ProfReviewConverter> {
    ...
    public ProfReviewRestManager (ProfReviewManagerService service, ProfReviewConverter converter) {
