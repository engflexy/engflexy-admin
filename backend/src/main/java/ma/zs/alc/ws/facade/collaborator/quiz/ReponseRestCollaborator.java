...
@RestController
@RequestMapping("/api/collaborator/reponse/")
public class ReponseRestCollaborator  extends AbstractController<Reponse, ReponseDto, ReponseCriteria, ReponseCollaboratorService, ReponseConverter> {
    ...
    public ReponseRestCollaborator (ReponseCollaboratorService service, ReponseConverter converter) {
