...
@RestController
@RequestMapping("/api/manager/inviteStudent/")
public class InviteStudentRestManager  extends AbstractController<InviteStudent, InviteStudentDto, InviteStudentCriteria, InviteStudentManagerService, InviteStudentConverter> {
    ...
    public InviteStudentRestManager (InviteStudentManagerService service, InviteStudentConverter converter) {
