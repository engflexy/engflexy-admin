...
@RestController
@RequestMapping("/api/manager/etatInscription/")
public class EtatInscriptionRestManager  extends AbstractController<EtatInscription, EtatInscriptionDto, EtatInscriptionCriteria, EtatInscriptionManagerService, EtatInscriptionConverter> {
    ...
    public EtatInscriptionRestManager (EtatInscriptionManagerService service, EtatInscriptionConverter converter) {
