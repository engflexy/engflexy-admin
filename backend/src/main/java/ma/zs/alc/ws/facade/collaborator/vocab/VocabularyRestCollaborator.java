...
@RestController
@RequestMapping("/api/collaborator/vocabulary/")
public class VocabularyRestCollaborator  extends AbstractController<Vocabulary, VocabularyDto, VocabularyCriteria, VocabularyCollaboratorService, VocabularyConverter> {
    ...
    public VocabularyRestCollaborator (VocabularyCollaboratorService service, VocabularyConverter converter) {
