...
@RestController
@RequestMapping("/api/collaborator/sectionItem/")
public class SectionItemRestCollaborator  extends AbstractController<SectionItem, SectionItemDto, SectionItemCriteria, SectionItemCollaboratorService, SectionItemConverter> {
    ...
    public SectionItemRestCollaborator (SectionItemCollaboratorService service, SectionItemConverter converter) {
