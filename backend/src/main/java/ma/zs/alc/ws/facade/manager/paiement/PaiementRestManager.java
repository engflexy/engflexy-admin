package ma.zs.alc.ws.facade.manager.paiement;
...
public class PaiementRestManager  extends AbstractController<Paiement, PaiementDto, PaiementCriteria, PaiementManagerService, PaiementConverter> {
