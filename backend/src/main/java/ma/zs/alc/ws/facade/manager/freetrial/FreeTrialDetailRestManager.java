...
@RestController
@RequestMapping("/api/manager/freeTrialDetail/")
public class FreeTrialDetailRestManager  extends AbstractController<FreeTrialDetail, FreeTrialDetailDto, FreeTrialDetailCriteria, FreeTrialDetailManagerService, FreeTrialDetailConverter> {
    ...
    public FreeTrialDetailRestManager (FreeTrialDetailManagerService service, FreeTrialDetailConverter converter) {
