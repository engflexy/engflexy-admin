...
@RestController
@RequestMapping("/api/manager/etudiantReview/")
public class EtudiantReviewRestManager  extends AbstractController<EtudiantReview, EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewManagerService, EtudiantReviewConverter> {
    ...
    public EtudiantReviewRestManager (EtudiantReviewManagerService service, EtudiantReviewConverter converter) {
