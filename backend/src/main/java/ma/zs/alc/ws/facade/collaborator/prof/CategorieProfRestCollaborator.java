...
@RestController
@RequestMapping("/api/collaborator/categorieProf/")
public class CategorieProfRestCollaborator  extends AbstractController<CategorieProf, CategorieProfDto, CategorieProfCriteria, CategorieProfCollaboratorService, CategorieProfConverter> {
    ...
    public CategorieProfRestCollaborator (CategorieProfCollaboratorService service, CategorieProfConverter converter) {
