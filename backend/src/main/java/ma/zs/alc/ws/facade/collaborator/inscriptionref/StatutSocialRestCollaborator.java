...
@RestController
@RequestMapping("/api/collaborator/statutSocial/")
public class StatutSocialRestCollaborator  extends AbstractController<StatutSocial, StatutSocialDto, StatutSocialCriteria, StatutSocialCollaboratorService, StatutSocialConverter> {
    ...
    public StatutSocialRestCollaborator (StatutSocialCollaboratorService service, StatutSocialConverter converter) {
