...
@RestController
@RequestMapping("/api/collaborator/freeTrialDetail/")
public class FreeTrialDetailRestCollaborator  extends AbstractController<FreeTrialDetail, FreeTrialDetailDto, FreeTrialDetailCriteria, FreeTrialDetailCollaboratorService, FreeTrialDetailConverter> {
    ...
    public FreeTrialDetailRestCollaborator (FreeTrialDetailCollaboratorService service, FreeTrialDetailConverter converter) {
