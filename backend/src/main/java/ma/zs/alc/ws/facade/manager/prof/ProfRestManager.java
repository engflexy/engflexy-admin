...
@RestController
@RequestMapping("/api/manager/prof/")
public class ProfRestManager  extends AbstractController<Prof, ProfDto, ProfCriteria, ProfManagerService, ProfConverter> {
    ...
    public ProfRestManager (ProfManagerService service, ProfConverter converter) {
