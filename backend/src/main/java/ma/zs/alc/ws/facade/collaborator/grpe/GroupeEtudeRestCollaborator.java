...
@RestController
@RequestMapping("/api/collaborator/groupeEtude/")
public class GroupeEtudeRestCollaborator  extends AbstractController<GroupeEtude, GroupeEtudeDto, GroupeEtudeCriteria, GroupeEtudeCollaboratorService, GroupeEtudeConverter> {
    ...
    public GroupeEtudeRestCollaborator (GroupeEtudeCollaboratorService service, GroupeEtudeConverter converter) {
