...
@RestController
@RequestMapping("/api/collaborator/inviteStudent/")
public class InviteStudentRestCollaborator  extends AbstractController<InviteStudent, InviteStudentDto, InviteStudentCriteria, InviteStudentCollaboratorService, InviteStudentConverter> {
    ...
    public InviteStudentRestCollaborator (InviteStudentCollaboratorService service, InviteStudentConverter converter) {
