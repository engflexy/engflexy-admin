...
@RestController
@RequestMapping("/api/collaborator/freeTrialTeacherEmailTemplate/")
public class FreeTrialTeacherEmailTemplateRestCollaborator  extends AbstractController<FreeTrialTeacherEmailTemplate, FreeTrialTeacherEmailTemplateDto, FreeTrialTeacherEmailTemplateCriteria, FreeTrialTeacherEmailTemplateCollaboratorService, FreeTrialTeacherEmailTemplateConverter> {
    ...
    public FreeTrialTeacherEmailTemplateRestCollaborator (FreeTrialTeacherEmailTemplateCollaboratorService service, FreeTrialTeacherEmailTemplateConverter converter) {
