package  ma.zs.alc.ws.facade.collaborator.quiz;
...
@RestController
@RequestMapping("/api/collaborator/question/")
public class QuestionRestCollaborator  extends AbstractController<Question, QuestionDto, QuestionCriteria, QuestionCollaboratorService, QuestionConverter> {
    ...
    public QuestionRestCollaborator (QuestionCollaboratorService service, QuestionConverter converter) {
