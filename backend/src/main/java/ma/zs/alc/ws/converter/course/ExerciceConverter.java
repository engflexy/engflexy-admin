...
public class ExerciceConverter extends AbstractConverter<Exercice, ExerciceDto> {
    ...
    public Exercice toItem(ExerciceDto dto) {
        if (dto == null) {
            ...
            if (StringUtil.isNotEmpty(dto.getContent())) item.setContent(dto.getContent());
    ...
    public ExerciceDto toDto(Exercice item) {
        if (item == null) {
            ...
            if (StringUtil.isNotEmpty(item.getContent())) dto.setContent(item.getContent());
    ...
    public void copy(ExerciceDto dto, Exercice t) {
        super.copy(dto, t);
        if (dto.getContentType() != null) contentTypeConverter.copy(dto.getContentType(), t.getContentType());
        if (dto.getSection() != null) sectionConverter.copy(dto.getSection(), t.getSection());
    }
