...
@RestController
@RequestMapping("/api/manager/trancheHoraireProf/")
public class TrancheHoraireProfRestManager  extends AbstractController<TrancheHoraireProf, TrancheHoraireProfDto, TrancheHoraireProfCriteria, TrancheHoraireProfManagerService, TrancheHoraireProfConverter> {
    ...
    public TrancheHoraireProfRestManager (TrancheHoraireProfManagerService service, TrancheHoraireProfConverter converter) {
