...
@RestController
@RequestMapping("/api/collaborator/homeWorkEtudiant/")
public class HomeWorkEtudiantRestCollaborator  extends AbstractController<HomeWorkEtudiant, HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantCollaboratorService, HomeWorkEtudiantConverter> {
    ...
    public HomeWorkEtudiantRestCollaborator (HomeWorkEtudiantCollaboratorService service, HomeWorkEtudiantConverter converter) {
