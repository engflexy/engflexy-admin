...
@RestController
@RequestMapping("/api/manager/reclamationProf/")
public class ReclamationProfRestManager  extends AbstractController<ReclamationProf, ReclamationProfDto, ReclamationProfCriteria, ReclamationProfManagerService, ReclamationProfConverter> {
    ...
    public ReclamationProfRestManager (ReclamationProfManagerService service, ReclamationProfConverter converter) {
