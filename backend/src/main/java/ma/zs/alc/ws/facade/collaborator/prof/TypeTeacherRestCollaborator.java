...
@RestController
@RequestMapping("/api/collaborator/typeTeacher/")
public class TypeTeacherRestCollaborator  extends AbstractController<TypeTeacher, TypeTeacherDto, TypeTeacherCriteria, TypeTeacherCollaboratorService, TypeTeacherConverter> {
    ...
    public TypeTeacherRestCollaborator (TypeTeacherCollaboratorService service, TypeTeacherConverter converter) {
