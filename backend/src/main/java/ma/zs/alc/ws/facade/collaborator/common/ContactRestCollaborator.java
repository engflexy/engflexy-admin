...
@RestController
@RequestMapping("/api/collaborator/contact/")
public class ContactRestCollaborator  extends AbstractController<Contact, ContactDto, ContactCriteria, ContactCollaboratorService, ContactConverter> {
    ...
    public ContactRestCollaborator (ContactCollaboratorService service, ContactConverter converter) {
