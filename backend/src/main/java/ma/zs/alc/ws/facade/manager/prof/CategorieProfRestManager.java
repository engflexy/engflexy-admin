...
@RestController
@RequestMapping("/api/manager/categorieProf/")
public class CategorieProfRestManager  extends AbstractController<CategorieProf, CategorieProfDto, CategorieProfCriteria, CategorieProfManagerService, CategorieProfConverter> {
    ...
    public CategorieProfRestManager (CategorieProfManagerService service, CategorieProfConverter converter) {
