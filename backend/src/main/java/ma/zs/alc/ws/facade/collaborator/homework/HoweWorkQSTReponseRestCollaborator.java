...
@RestController
@RequestMapping("/api/collaborator/howeWorkQSTReponse/")
public class HoweWorkQSTReponseRestCollaborator  extends AbstractController<HoweWorkQSTReponse, HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseCollaboratorService, HoweWorkQSTReponseConverter> {
    ...
    public HoweWorkQSTReponseRestCollaborator (HoweWorkQSTReponseCollaboratorService service, HoweWorkQSTReponseConverter converter) {
