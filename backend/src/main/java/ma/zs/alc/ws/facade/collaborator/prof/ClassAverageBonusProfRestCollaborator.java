...
@RestController
@RequestMapping("/api/collaborator/classAverageBonusProf/")
public class ClassAverageBonusProfRestCollaborator  extends AbstractController<ClassAverageBonusProf, ClassAverageBonusProfDto, ClassAverageBonusProfCriteria, ClassAverageBonusProfCollaboratorService, ClassAverageBonusProfConverter> {
    ...
    public ClassAverageBonusProfRestCollaborator (ClassAverageBonusProfCollaboratorService service, ClassAverageBonusProfConverter converter) {
