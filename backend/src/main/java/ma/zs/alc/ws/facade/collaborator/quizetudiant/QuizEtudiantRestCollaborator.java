...
@RestController
@RequestMapping("/api/collaborator/quizEtudiant/")
public class QuizEtudiantRestCollaborator  extends AbstractController<QuizEtudiant, QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantCollaboratorService, QuizEtudiantConverter> {
    ...
    public QuizEtudiantRestCollaborator (QuizEtudiantCollaboratorService service, QuizEtudiantConverter converter) {
