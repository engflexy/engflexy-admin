...
@RestController
@RequestMapping("/api/collaborator/exercice/")
public class ExerciceRestCollaborator  extends AbstractController<Exercice, ExerciceDto, ExerciceCriteria, ExerciceCollaboratorService, ExerciceConverter> {
    ...
    public ExerciceRestCollaborator (ExerciceCollaboratorService service, ExerciceConverter converter) {
