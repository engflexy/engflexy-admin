...
@RestController
@RequestMapping("/api/collaborator/fonction/")
public class FonctionRestCollaborator  extends AbstractController<Fonction, FonctionDto, FonctionCriteria, FonctionCollaboratorService, FonctionConverter> {
    ...
    public FonctionRestCollaborator (FonctionCollaboratorService service, FonctionConverter converter) {
