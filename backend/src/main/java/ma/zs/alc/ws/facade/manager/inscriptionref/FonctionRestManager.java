...
@RestController
@RequestMapping("/api/manager/fonction/")
public class FonctionRestManager  extends AbstractController<Fonction, FonctionDto, FonctionCriteria, FonctionManagerService, FonctionConverter> {
    ...
    public FonctionRestManager (FonctionManagerService service, FonctionConverter converter) {
