...
@RestController
@RequestMapping("/api/manager/paiementInscriptionCollaborator/")
public class PaiementInscriptionCollaboratorRestManager  extends AbstractController<PaiementInscriptionCollaborator, PaiementInscriptionCollaboratorDto, PaiementInscriptionCollaboratorCriteria, PaiementInscriptionCollaboratorManagerService, PaiementInscriptionCollaboratorConverter> {
    ...
    public PaiementInscriptionCollaboratorRestManager (PaiementInscriptionCollaboratorManagerService service, PaiementInscriptionCollaboratorConverter converter) {
