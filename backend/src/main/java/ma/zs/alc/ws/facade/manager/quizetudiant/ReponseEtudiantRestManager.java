package ma.zs.alc.ws.facade.manager.quizetudiant;
...
@RestController
@RequestMapping("/api/manager/reponseEtudiant/")
public class ReponseEtudiantRestManager  extends AbstractController<ReponseEtudiant, ReponseEtudiantDto, ReponseEtudiantCriteria, ReponseEtudiantManagerService, ReponseEtudiantConverter> {
    ...
    public ReponseEtudiantRestManager (ReponseEtudiantManagerService service, ReponseEtudiantConverter converter) {
