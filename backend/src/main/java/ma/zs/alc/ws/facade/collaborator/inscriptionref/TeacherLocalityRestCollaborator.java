...
@RestController
@RequestMapping("/api/collaborator/teacherLocality/")
public class TeacherLocalityRestCollaborator  extends AbstractController<TeacherLocality, TeacherLocalityDto, TeacherLocalityCriteria, TeacherLocalityCollaboratorService, TeacherLocalityConverter> {
    ...
    public TeacherLocalityRestCollaborator (TeacherLocalityCollaboratorService service, TeacherLocalityConverter converter) {
