...
@RestController
@RequestMapping("/api/manager/statutSocial/")
public class StatutSocialRestManager  extends AbstractController<StatutSocial, StatutSocialDto, StatutSocialCriteria, StatutSocialManagerService, StatutSocialConverter> {
    ...
    public StatutSocialRestManager (StatutSocialManagerService service, StatutSocialConverter converter) {
