...
@RestController
@RequestMapping("/api/manager/homeWorkEtudiant/")
public class HomeWorkEtudiantRestManager  extends AbstractController<HomeWorkEtudiant, HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantManagerService, HomeWorkEtudiantConverter> {
    ...
    public HomeWorkEtudiantRestManager (HomeWorkEtudiantManagerService service, HomeWorkEtudiantConverter converter) {
