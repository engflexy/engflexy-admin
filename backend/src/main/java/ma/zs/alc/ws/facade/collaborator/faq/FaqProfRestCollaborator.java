...
@RestController
@RequestMapping("/api/collaborator/faqProf/")
public class FaqProfRestCollaborator  extends AbstractController<FaqProf, FaqProfDto, FaqProfCriteria, FaqProfCollaboratorService, FaqProfConverter> {
    ...
    public FaqProfRestCollaborator (FaqProfCollaboratorService service, FaqProfConverter converter) {
