...
@RestController
@RequestMapping("/api/manager/sectionItem/")
public class SectionItemRestManager  extends AbstractController<SectionItem, SectionItemDto, SectionItemCriteria, SectionItemManagerService, SectionItemConverter> {
    ...
    public SectionItemRestManager (SectionItemManagerService service, SectionItemConverter converter) {
