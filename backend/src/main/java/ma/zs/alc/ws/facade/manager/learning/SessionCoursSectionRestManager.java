package ma.zs.alc.ws.facade.manager.learning;
...
@RestController
@RequestMapping("/api/manager/sessionCoursSection/")
public class SessionCoursSectionRestManager  extends AbstractController<SessionCoursSection, SessionCoursSectionDto, SessionCoursSectionCriteria, SessionCoursSectionManagerService, SessionCoursSectionConverter> {
    ...
    public SessionCoursSectionRestManager (SessionCoursSectionManagerService service, SessionCoursSectionConverter converter) {
