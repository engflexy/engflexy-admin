...
@RestController
@RequestMapping("/api/manager/skill/")
public class SkillRestManager  extends AbstractController<Skill, SkillDto, SkillCriteria, SkillManagerService, SkillConverter> {
    ...
    public SkillRestManager (SkillManagerService service, SkillConverter converter) {
