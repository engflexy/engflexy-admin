...
@RestController
@RequestMapping("/api/manager/howeWorkQSTReponse/")
public class HoweWorkQSTReponseRestManager  extends AbstractController<HoweWorkQSTReponse, HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseManagerService, HoweWorkQSTReponseConverter> {
    ...
    public HoweWorkQSTReponseRestManager (HoweWorkQSTReponseManagerService service, HoweWorkQSTReponseConverter converter) {
