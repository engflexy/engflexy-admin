package  ma.zs.alc.ws.facade.collaborator.learning;
...
@RestController
@RequestMapping("/api/collaborator/sessionCoursSection/")
public class SessionCoursSectionRestCollaborator  extends AbstractController<SessionCoursSection, SessionCoursSectionDto, SessionCoursSectionCriteria, SessionCoursSectionCollaboratorService, SessionCoursSectionConverter> {
    ...
    public SessionCoursSectionRestCollaborator (SessionCoursSectionCollaboratorService service, SessionCoursSectionConverter converter) {
