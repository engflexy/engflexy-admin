...
@RestController
@RequestMapping("/api/manager/freeTrial/")
public class FreeTrialRestManager  extends AbstractController<FreeTrial, FreeTrialDto, FreeTrialCriteria, FreeTrialManagerService, FreeTrialConverter> {
    ...
    public FreeTrialRestManager (FreeTrialManagerService service, FreeTrialConverter converter) {
