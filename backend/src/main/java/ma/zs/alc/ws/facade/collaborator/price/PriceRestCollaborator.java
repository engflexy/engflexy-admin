package  ma.zs.alc.ws.facade.collaborator.price;
...
@RestController
@RequestMapping("/api/collaborator/price/")
public class PriceRestCollaborator  extends AbstractController<Price, PriceDto, PriceCriteria, PriceCollaboratorService, PriceConverter> {
    ...
    public PriceRestCollaborator (PriceCollaboratorService service, PriceConverter converter) {
