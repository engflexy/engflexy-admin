...
@RestController
@RequestMapping("/api/collaborator/classAverageBonus/")
public class ClassAverageBonusRestCollaborator  extends AbstractController<ClassAverageBonus, ClassAverageBonusDto, ClassAverageBonusCriteria, ClassAverageBonusCollaboratorService, ClassAverageBonusConverter> {
    ...
    public ClassAverageBonusRestCollaborator (ClassAverageBonusCollaboratorService service, ClassAverageBonusConverter converter) {
