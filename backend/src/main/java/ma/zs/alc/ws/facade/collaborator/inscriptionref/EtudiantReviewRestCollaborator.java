...
@RestController
@RequestMapping("/api/collaborator/etudiantReview/")
public class EtudiantReviewRestCollaborator  extends AbstractController<EtudiantReview, EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewCollaboratorService, EtudiantReviewConverter> {
    ...
    public EtudiantReviewRestCollaborator (EtudiantReviewCollaboratorService service, EtudiantReviewConverter converter) {
