...
@RestController
@RequestMapping("/api/collaborator/freeTrial/")
public class FreeTrialRestCollaborator  extends AbstractController<FreeTrial, FreeTrialDto, FreeTrialCriteria, FreeTrialCollaboratorService, FreeTrialConverter> {
    ...
    public FreeTrialRestCollaborator (FreeTrialCollaboratorService service, FreeTrialConverter converter) {
