...
@RestController
@RequestMapping("/api/collaborator/workloadBonus/")
public class WorkloadBonusRestCollaborator  extends AbstractController<WorkloadBonus, WorkloadBonusDto, WorkloadBonusCriteria, WorkloadBonusCollaboratorService, WorkloadBonusConverter> {
    ...
    public WorkloadBonusRestCollaborator (WorkloadBonusCollaboratorService service, WorkloadBonusConverter converter) {
