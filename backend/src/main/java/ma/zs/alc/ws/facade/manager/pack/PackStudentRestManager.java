package ma.zs.alc.ws.facade.manager.pack;
...
@RestController
@RequestMapping("/api/manager/packStudent/")
public class PackStudentRestManager  extends AbstractController<PackStudent, PackStudentDto, PackStudentCriteria, PackStudentManagerService, PackStudentConverter> {
    ...
    public PackStudentRestManager (PackStudentManagerService service, PackStudentConverter converter) {
