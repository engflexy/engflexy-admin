...
@RestController
@RequestMapping("/api/collaborator/skill/")
public class SkillRestCollaborator  extends AbstractController<Skill, SkillDto, SkillCriteria, SkillCollaboratorService, SkillConverter> {
    ...
    public SkillRestCollaborator (SkillCollaboratorService service, SkillConverter converter) {
