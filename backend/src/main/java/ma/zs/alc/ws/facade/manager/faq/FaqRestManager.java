...
@RestController
@RequestMapping("/api/manager/faq/")
public class FaqRestManager  extends AbstractController<Faq, FaqDto, FaqCriteria, FaqManagerService, FaqConverter> {
    ...
    public FaqRestManager (FaqManagerService service, FaqConverter converter) {
