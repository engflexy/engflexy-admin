...
@RestController
@RequestMapping("/api/manager/freeTrialformule/")
public class FreeTrialformuleRestManager  extends AbstractController<FreeTrialformule, FreeTrialformuleDto, FreeTrialformuleCriteria, FreeTrialformuleManagerService, FreeTrialformuleConverter> {
    ...
    public FreeTrialformuleRestManager (FreeTrialformuleManagerService service, FreeTrialformuleConverter converter) {
