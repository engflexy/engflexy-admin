...
@RestController
@RequestMapping("/api/collaborator/niveauEtude/")
public class NiveauEtudeRestCollaborator  extends AbstractController<NiveauEtude, NiveauEtudeDto, NiveauEtudeCriteria, NiveauEtudeCollaboratorService, NiveauEtudeConverter> {
    ...
    public NiveauEtudeRestCollaborator (NiveauEtudeCollaboratorService service, NiveauEtudeConverter converter) {
