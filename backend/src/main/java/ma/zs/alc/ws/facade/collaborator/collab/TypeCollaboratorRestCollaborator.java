...
import ma.zs.alc.ws.converter.collab.TypeCollaboratorConverter;
...
@RestController
@RequestMapping("/api/collaborator/typeCollaborator/")
public class TypeCollaboratorRestCollaborator  extends AbstractController<TypeCollaborator, TypeCollaboratorDto, TypeCollaboratorCriteria, TypeCollaboratorCollaboratorService, TypeCollaboratorConverter> {
    ...
    public TypeCollaboratorRestCollaborator (TypeCollaboratorCollaboratorService service, TypeCollaboratorConverter converter) {
