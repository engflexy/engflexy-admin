...
@RestController
@RequestMapping("/api/collaborator/typeReclamationProf/")
public class TypeReclamationProfRestCollaborator  extends AbstractController<TypeReclamationProf, TypeReclamationProfDto, TypeReclamationProfCriteria, TypeReclamationProfCollaboratorService, TypeReclamationProfConverter> {
    ...
    public TypeReclamationProfRestCollaborator (TypeReclamationProfCollaboratorService service, TypeReclamationProfConverter converter) {
