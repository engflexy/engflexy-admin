...
@RestController
@RequestMapping("/api/collaborator/recommendTeacher/")
public class RecommendTeacherRestCollaborator  extends AbstractController<RecommendTeacher, RecommendTeacherDto, RecommendTeacherCriteria, RecommendTeacherCollaboratorService, RecommendTeacherConverter> {
    ...
    public RecommendTeacherRestCollaborator (RecommendTeacherCollaboratorService service, RecommendTeacherConverter converter) {
