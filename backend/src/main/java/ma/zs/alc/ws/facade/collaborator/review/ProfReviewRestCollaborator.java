package  ma.zs.alc.ws.facade.collaborator.review;
...
@RestController
@RequestMapping("/api/collaborator/profReview/")
public class ProfReviewRestCollaborator  extends AbstractController<ProfReview, ProfReviewDto, ProfReviewCriteria, ProfReviewCollaboratorService, ProfReviewConverter> {
    ...
    public ProfReviewRestCollaborator (ProfReviewCollaboratorService service, ProfReviewConverter converter) {
