...
@RestController
@RequestMapping("/api/manager/quizEtudiant/")
public class QuizEtudiantRestManager  extends AbstractController<QuizEtudiant, QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantManagerService, QuizEtudiantConverter> {
    ...
    public QuizEtudiantRestManager (QuizEtudiantManagerService service, QuizEtudiantConverter converter) {
