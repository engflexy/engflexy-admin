...
@RestController
@RequestMapping("/api/manager/groupeType/")
public class GroupeTypeRestManager  extends AbstractController<GroupeType, GroupeTypeDto, GroupeTypeCriteria, GroupeTypeManagerService, GroupeTypeConverter> {
    ...
    public GroupeTypeRestManager (GroupeTypeManagerService service, GroupeTypeConverter converter) {
