...
@RestController
@RequestMapping("/api/manager/faqProf/")
public class FaqProfRestManager  extends AbstractController<FaqProf, FaqProfDto, FaqProfCriteria, FaqProfManagerService, FaqProfConverter> {
    ...
    public FaqProfRestManager (FaqProfManagerService service, FaqProfConverter converter) {
