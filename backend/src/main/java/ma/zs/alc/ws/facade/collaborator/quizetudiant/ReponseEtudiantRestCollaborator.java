package  ma.zs.alc.ws.facade.collaborator.quizetudiant;
...
@RestController
@RequestMapping("/api/collaborator/reponseEtudiant/")
public class ReponseEtudiantRestCollaborator  extends AbstractController<ReponseEtudiant, ReponseEtudiantDto, ReponseEtudiantCriteria, ReponseEtudiantCollaboratorService, ReponseEtudiantConverter> {
    ...
    public ReponseEtudiantRestCollaborator (ReponseEtudiantCollaboratorService service, ReponseEtudiantConverter converter) {
