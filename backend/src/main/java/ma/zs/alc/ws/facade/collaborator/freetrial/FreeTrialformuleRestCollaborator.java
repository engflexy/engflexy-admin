...
@RestController
@RequestMapping("/api/collaborator/freeTrialformule/")
public class FreeTrialformuleRestCollaborator  extends AbstractController<FreeTrialformule, FreeTrialformuleDto, FreeTrialformuleCriteria, FreeTrialformuleCollaboratorService, FreeTrialformuleConverter> {
    ...
    public FreeTrialformuleRestCollaborator (FreeTrialformuleCollaboratorService service, FreeTrialformuleConverter converter) {
