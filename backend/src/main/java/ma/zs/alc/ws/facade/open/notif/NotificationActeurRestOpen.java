package ma.zs.alc.ws.facade.open.notif;
...
import ma.zs.alc.service.facade.open.notif.NotificationActeurOpenService;
...
@RestController
@RequestMapping("/api/open/notificationActeur/")
public class NotificationActeurRestOpen {
   ...
   public NotificationActeurRestOpen(NotificationActeurOpenService service, NotificationActeurConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final NotificationActeurOpenService service;
