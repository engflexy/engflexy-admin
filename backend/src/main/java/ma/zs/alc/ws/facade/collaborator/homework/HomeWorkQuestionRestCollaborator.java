...
@RestController
@RequestMapping("/api/collaborator/homeWorkQuestion/")
public class HomeWorkQuestionRestCollaborator  extends AbstractController<HomeWorkQuestion, HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionCollaboratorService, HomeWorkQuestionConverter> {
    ...
    public HomeWorkQuestionRestCollaborator (HomeWorkQuestionCollaboratorService service, HomeWorkQuestionConverter converter) {
