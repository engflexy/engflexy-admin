...
@RestController
@RequestMapping("/api/collaborator/typeHomeWork/")
public class TypeHomeWorkRestCollaborator  extends AbstractController<TypeHomeWork, TypeHomeWorkDto, TypeHomeWorkCriteria, TypeHomeWorkCollaboratorService, TypeHomeWorkConverter> {
    ...
    public TypeHomeWorkRestCollaborator (TypeHomeWorkCollaboratorService service, TypeHomeWorkConverter converter) {
