...
@RestController
@RequestMapping("/api/collaborator/statutFreeTrial/")
public class StatutFreeTrialRestCollaborator  extends AbstractController<StatutFreeTrial, StatutFreeTrialDto, StatutFreeTrialCriteria, StatutFreeTrialCollaboratorService, StatutFreeTrialConverter> {
    ...
    public StatutFreeTrialRestCollaborator (StatutFreeTrialCollaboratorService service, StatutFreeTrialConverter converter) {
