...
@RestController
@RequestMapping("/api/collaborator/freeTrialTeacherWhatsTemplate/")
public class FreeTrialTeacherWhatsTemplateRestCollaborator  extends AbstractController<FreeTrialTeacherWhatsTemplate, FreeTrialTeacherWhatsTemplateDto, FreeTrialTeacherWhatsTemplateCriteria, FreeTrialTeacherWhatsTemplateCollaboratorService, FreeTrialTeacherWhatsTemplateConverter> {
    ...
    public FreeTrialTeacherWhatsTemplateRestCollaborator (FreeTrialTeacherWhatsTemplateCollaboratorService service, FreeTrialTeacherWhatsTemplateConverter converter) {
