...
@RestController
@RequestMapping("/api/collaborator/langue/")
public class LangueRestCollaborator  extends AbstractController<Langue, LangueDto, LangueCriteria, LangueCollaboratorService, LangueConverter> {
    ...
    public LangueRestCollaborator (LangueCollaboratorService service, LangueConverter converter) {
