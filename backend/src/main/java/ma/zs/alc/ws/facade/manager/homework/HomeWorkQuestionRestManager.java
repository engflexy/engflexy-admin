...
@RestController
@RequestMapping("/api/manager/homeWorkQuestion/")
public class HomeWorkQuestionRestManager  extends AbstractController<HomeWorkQuestion, HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionManagerService, HomeWorkQuestionConverter> {
    ...
    public HomeWorkQuestionRestManager (HomeWorkQuestionManagerService service, HomeWorkQuestionConverter converter) {
