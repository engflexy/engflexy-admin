...
@RestController
@RequestMapping("/api/collaborator/sessionCours/")
public class SessionCoursRestCollaborator  extends AbstractController<SessionCours, SessionCoursDto, SessionCoursCriteria, SessionCoursCollaboratorService, SessionCoursConverter> {
    ...
    public SessionCoursRestCollaborator (SessionCoursCollaboratorService service, SessionCoursConverter converter) {
