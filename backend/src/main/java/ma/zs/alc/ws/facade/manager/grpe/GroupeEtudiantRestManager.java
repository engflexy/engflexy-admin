...
@RestController
@RequestMapping("/api/manager/groupeEtudiant/")
public class GroupeEtudiantRestManager  extends AbstractController<GroupeEtudiant, GroupeEtudiantDto, GroupeEtudiantCriteria, GroupeEtudiantManagerService, GroupeEtudiantConverter> {
    ...
    public GroupeEtudiantRestManager (GroupeEtudiantManagerService service, GroupeEtudiantConverter converter) {
