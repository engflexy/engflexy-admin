package ma.zs.alc.service.impl.admin.notif;
...
@Service
public class NotificationActeurAdminServiceImpl implements NotificationActeurAdminService {
    ...
    public NotificationActeurAdminServiceImpl(NotificationActeurDao dao) {
        this.dao = dao;
    }
