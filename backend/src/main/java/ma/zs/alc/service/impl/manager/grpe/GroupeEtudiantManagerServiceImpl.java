...
import ma.zs.alc.service.facade.manager.grpe.*;
...
@Service
public class GroupeEtudiantManagerServiceImpl extends AbstractServiceImpl<GroupeEtudiant, GroupeEtudiantCriteria, GroupeEtudiantDao> implements GroupeEtudiantManagerService {
    ...
    if(groupeEtudiant !=null && groupeEtudiant.getId() != null){
            ...
            emptyIfNull(resultGroupeEtudiantDetails.get(0)).forEach(e -> e.setGroupeEtudiant(groupeEtudiant));
    ...
    @Autowired
    private GroupeEtatManagerService groupeEtatService ;
    @Autowired
    ...
    public GroupeEtudiantManagerServiceImpl(GroupeEtudiantDao dao) {
        super(dao);
    }
