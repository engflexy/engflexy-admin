...
import java.util.List;
@Service
public class FreeTrialCollaboratorServiceImpl extends AbstractServiceImpl<FreeTrial, FreeTrialCriteria, FreeTrialDao> implements FreeTrialCollaboratorService {
    ...
    @Autowired
    private FreeTrialTeacherEmailTemplateCollaboratorService freeTrialTeacherEmailTemplateService ;
    @Autowired
    private FreeTrialTeacherWhatsTemplateCollaboratorService freeTrialTeacherWhatsTemplateService ;
    @Autowired
    private StatutFreeTrialCollaboratorService statutFreeTrialService ;
    @Autowired
    private FreeTrialConfigurationCollaboratorService freeTrialConfigurationService ;
    @Autowired
    private FreeTrialStudentEmailTemplateCollaboratorService freeTrialStudentEmailTemplateService ;
    @Autowired
    private FreeTrialDetailCollaboratorService freeTrialDetailService ;
    @Autowired
    private ProfCollaboratorService profService ;
    @Autowired
    private NiveauEtudeCollaboratorService niveauEtudeService ;
    @Autowired
    private FreeTrialStudentWhatsTemplateCollaboratorService freeTrialStudentWhatsTemplateService ;

    public FreeTrialCollaboratorServiceImpl(FreeTrialDao dao) {
        super(dao);
    }
