...
import java.util.List;
@Service
public class FaqTypeCollaboratorServiceImpl extends AbstractServiceImpl<FaqType, FaqTypeCriteria, FaqTypeDao> implements FaqTypeCollaboratorService {
    ...
    public FaqTypeCollaboratorServiceImpl(FaqTypeDao dao) {
        super(dao);
    }
