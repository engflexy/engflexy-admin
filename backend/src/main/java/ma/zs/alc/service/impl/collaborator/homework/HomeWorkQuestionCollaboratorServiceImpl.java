...
import java.util.List;
@Service
public class HomeWorkQuestionCollaboratorServiceImpl extends AbstractServiceImpl<HomeWorkQuestion, HomeWorkQuestionCriteria, HomeWorkQuestionDao> implements HomeWorkQuestionCollaboratorService {
    ...
    public HomeWorkQuestionCollaboratorServiceImpl(HomeWorkQuestionDao dao) {
        super(dao);
    }
