...
@Service
public class SalaryManagerServiceImpl extends AbstractServiceImpl<Salary, SalaryCriteria, SalaryDao> implements SalaryManagerService {
    ...
    public SalaryManagerServiceImpl(SalaryDao dao) {
        super(dao);
    }
