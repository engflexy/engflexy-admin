package ma.zs.alc.service.impl.open.notif;
...
@Service
public class NotificationActeurOpenServiceImpl implements NotificationActeurOpenService {
    ...
    public NotificationActeurOpenServiceImpl(NotificationActeurDao dao) {
        this.dao = dao;
    }
