...
import java.util.List;
@Service
public class NewsCollaboratorServiceImpl extends AbstractServiceImpl<News, NewsCriteria, NewsDao> implements NewsCollaboratorService {
    ...
    public NewsCollaboratorServiceImpl(NewsDao dao) {
        super(dao);
    }
