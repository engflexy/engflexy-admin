...
import java.util.List;
@Service
public class QuizEtudiantCollaboratorServiceImpl extends AbstractServiceImpl<QuizEtudiant, QuizEtudiantCriteria, QuizEtudiantDao> implements QuizEtudiantCollaboratorService {
    ...
    @Autowired
    private ReponseEtudiantCollaboratorService reponseEtudiantService ;

    public QuizEtudiantCollaboratorServiceImpl(QuizEtudiantDao dao) {
        super(dao);
    }
