...
import ma.zs.alc.service.facade.admin.collab.ManagerAdminService;
...
@Service
public class ManagerAdminServiceImpl extends AbstractServiceImpl<Manager, ManagerCriteria, ManagerDao> implements ManagerAdminService {
