package ma.zs.alc.service.facade.collaborator.quizetudiant;
...
public interface ReponseEtudiantCollaboratorService extends  IService<ReponseEtudiant,ReponseEtudiantCriteria>  {
