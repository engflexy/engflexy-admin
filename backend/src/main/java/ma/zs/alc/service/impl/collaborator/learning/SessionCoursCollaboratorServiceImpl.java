...
import java.util.List;
@Service
public class SessionCoursCollaboratorServiceImpl extends AbstractServiceImpl<SessionCours, SessionCoursCriteria, SessionCoursDao> implements SessionCoursCollaboratorService {
    ...
    @Autowired
    private SessionCoursSectionCollaboratorService sessionCoursSectionService ;
    @Autowired
    private CoursCollaboratorService coursService ;
    @Autowired
    private ProfCollaboratorService profService ;

    public SessionCoursCollaboratorServiceImpl(SessionCoursDao dao) {
        super(dao);
    }
