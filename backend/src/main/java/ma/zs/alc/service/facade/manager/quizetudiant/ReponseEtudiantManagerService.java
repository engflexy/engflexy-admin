package ma.zs.alc.service.facade.manager.quizetudiant;
...
public interface ReponseEtudiantManagerService extends  IService<ReponseEtudiant,ReponseEtudiantCriteria>  {
